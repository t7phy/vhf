...
for module, func_name in modules.items():
    module_ordered = import_module(f"dev.sidis_reorder_code.step1_pol.ordered.python.{module}")
    module_original = import_module(f"dev.sidis_reorder_code.step1_pol.original.python.{module}")
