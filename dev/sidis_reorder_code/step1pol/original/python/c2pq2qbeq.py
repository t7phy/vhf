...
def C2Pq2qbEq_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    ...
    if cx == "D" and cz == "R":
        ...
        res = (
            ...
            + 2 * zeta3 * CF
            + 2 * zeta3 * z * CF
            - 1.0 / 12.0 * pow(pi, 2) * CF * pow(NC, -1)
            - 2.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * rln2 * pow(opz, -1)
            + 1.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * rln2
            - 1.0 / 6.0 * pow(pi, 2) * CF
            - 1.0 / 3.0 * pow(pi, 2) * LMUA * CF * pow(NC, -1) * pow(opz, -1)
            + 1.0 / 6.0 * pow(pi, 2) * LMUA * CF * pow(NC, -1)
            - 1.0 / 6.0 * pow(pi, 2) * LMUA * CF
            - 1.0 / 12.0 * pow(pi, 2) * z * CF * pow(NC, -1)
            - 1.0 / 3.0 * pow(pi, 2) * z * CF * pow(NC, -1) * rln2
            - 1.0 / 4.0 * pow(pi, 2) * z * CF
            - 1.0 / 6.0 * pow(pi, 2) * z * LMUA * CF * pow(NC, -1)
            - 1.0 / 6.0 * pow(pi, 2) * z * LMUA * CF
            - 2 * ln(1 + z) * CF * pow(NC, -1) * pow(rln2, 2) * pow(opz, -1)
            + ln(1 + z) * CF * pow(NC, -1) * pow(rln2, 2)
            - ln(1 + z) * z * CF * pow(NC, -1) * pow(rln2, 2)
            + 1.0 / 3.0 * ln(1 + z) * pow(pi, 2) * CF * pow(NC, -1) * pow(opz, -1)
            - 1.0 / 6.0 * ln(1 + z) * pow(pi, 2) * CF * pow(NC, -1)
            + 1.0 / 6.0 * ln(1 + z) * pow(pi, 2) * z * CF * pow(NC, -1)
            - 7.0 / 18.0 * ln(z) * pow(z, -1) * CF
            - 2.0 / 3.0 * ln(z) * pow(z, -1) * LMUA * CF
            - 7.0 / 4.0 * ln(z) * CF * pow(NC, -1)
            - 5 * ln(z) * CF
        ...
        res += (
            ...
            - 1.0 / 6.0 * ln(omz) * pow(pi, 2) * CF * pow(NC, -1)
            ...
            - 2 * ln(omz) * ln(1 + z) * CF * pow(NC, -1) * rln2
            + 2 * ln(omz) * ln(1 + z) * z * CF * pow(NC, -1) * rln2
            - 2 * ln(omz) * pow(ln(1 + z), 2) * CF * pow(NC, -1) * pow(opz, -1)
            + ln(omz) * pow(ln(1 + z), 2) * CF * pow(NC, -1)
            - ln(omz) * pow(ln(1 + z), 2) * z * CF * pow(NC, -1)
        ...
        res += (
            ...
            - 2 * Li3(1 / (1 + z)) * CF * pow(NC, -1)
            + 2 * Li3(1 / (1 + z)) * z * CF * pow(NC, -1)
            - 4 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * CF * pow(NC, -1) * pow(opz, -1)
            + 2 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * CF * pow(NC, -1)
            - 2 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * z * CF * pow(NC, -1)
            + 2 * Li3(z) * CF * pow(NC, -1) * pow(opz, -1)
            - Li3(z) * CF * pow(NC, -1)
            - 2 * Li3(z) * CF
            + Li3(z) * z * CF * pow(NC, -1)
            - 2 * Li3(z) * z * CF
            + Li2(-z) * CF * pow(NC, -1)
            - 4 * Li2(-z) * LMUA * CF * pow(NC, -1) * pow(opz, -1)
            + 2 * Li2(-z) * LMUA * CF * pow(NC, -1)
            + Li2(-z) * z * CF * pow(NC, -1)
            - 2 * Li2(-z) * z * LMUA * CF * pow(NC, -1)
    ...
    if cx == "0" and cz == "R":
        ...
        res = (
            ...
            - 2 * ln(z) * ln(1 + z) * CF * pow(NC, -1)
            + 2 * ln(z) * ln(1 + z) * z * CF * pow(NC, -1)
            - pow(ln(z), 2) * CF * pow(NC, -1) * pow(opz, -1)
    ...
    if cx == "R" and cz == "D":
        ...
        res = (
            -13.0 / 4.0 * CF * pow(NC, -1)
            - 4.0 / 3.0 * CF * pow(NC, -1) * pow(rln2, 3) * pow(opx, -1)
            + 2.0 / 3.0 * CF * pow(NC, -1) * pow(rln2, 3)
            + 9 * CF
            - 2 * LMUF * CF * pow(NC, -1)
            + 3 * LMUF * CF
            ...
            - 2.0 / 3.0 * x * CF * pow(NC, -1) * pow(rln2, 3)
            - 9 * x * CF
            + 2 * x * LMUF * CF * pow(NC, -1)
            - 3 * x * LMUF * CF
            - 5.0 / 4.0 * x * pow(LMUF, 2) * CF
            - 2 * zeta3 * CF * pow(NC, -1) * pow(opx, -1)
            + zeta3 * CF * pow(NC, -1)
            - zeta3 * x * CF * pow(NC, -1)
        ...
        res += (
            ...
            - 1.0 / 3.0 * ln(omx) * pow(pi, 2) * CF * pow(NC, -1) * pow(opx, -1)
            + 1.0 / 6.0 * ln(omx) * pow(pi, 2) * CF * pow(NC, -1)
            + 1.0 / 3.0 * ln(omx) * pow(pi, 2) * CF
            - 1.0 / 6.0 * ln(omx) * pow(pi, 2) * x * CF * pow(NC, -1)
            + 1.0 / 3.0 * ln(omx) * pow(pi, 2) * x * CF
            - 4 * ln(omx) * ln(1 + x) * CF * pow(NC, -1) * rln2 * pow(opx, -1)
            + 2 * ln(omx) * ln(1 + x) * CF * pow(NC, -1) * rln2
            - 2 * ln(omx) * ln(1 + x) * x * CF * pow(NC, -1) * rln2
            + 2 * ln(omx) * pow(ln(1 + x), 2) * CF * pow(NC, -1) * pow(opx, -1)
            - ln(omx) * pow(ln(1 + x), 2) * CF * pow(NC, -1)
            + ln(omx) * pow(ln(1 + x), 2) * x * CF * pow(NC, -1)
            + 5.0 / 4.0 * pow(ln(omx), 2) * CF
            - 5.0 / 4.0 * pow(ln(omx), 2) * x * CF
            - ln(omx) * Li2(1 - x) * CF
            - ln(omx) * Li2(1 - x) * x * CF
            - 4 * ln(omx) * Li2(-x) * CF * pow(NC, -1) * pow(opx, -1)
            + 2 * ln(omx) * Li2(-x) * CF * pow(NC, -1)
            - 2 * ln(omx) * Li2(-x) * x * CF * pow(NC, -1)
            - 2 * ln(omx) * Li2(x) * CF
            - 2 * ln(omx) * Li2(x) * x * CF
            - ln(opx) * pow(pi, 2) * CF * pow(NC, -1) * pow(opx, -1)
            + 1.0 / 2.0 * ln(opx) * pow(pi, 2) * CF * pow(NC, -1)
            - 1.0 / 2.0 * ln(opx) * pow(pi, 2) * x * CF * pow(NC, -1)
            + 4 * Li3(1.0 / 2.0 - 1.0 / 2.0 * x) * CF * pow(NC, -1) * pow(opx, -1)
            - 2 * Li3(1.0 / 2.0 - 1.0 / 2.0 * x) * CF * pow(NC, -1)
        ...
        res += (
            -2 * Li3(1.0 / 2.0 + 1.0 / 2.0 * x) * CF * pow(NC, -1)
            + 2 * Li3(1.0 / 2.0 + 1.0 / 2.0 * x) * x * CF * pow(NC, -1)
            - 4 * Li3(1 - x) * CF * pow(NC, -1) * pow(opx, -1)
            + 2 * Li3(1 - x) * CF * pow(NC, -1)
            - Li3(1 - x) * CF
            - 2 * Li3(1 - x) * x * CF * pow(NC, -1)
            - Li3(1 - x) * x * CF
            + 4 * Li3(1 / (1 + x) - 1 / (1 + x) * x) * CF * pow(NC, -1) * pow(opx, -1)
            - 2 * Li3(1 / (1 + x) - 1 / (1 + x) * x) * CF * pow(NC, -1)
            + 2 * Li3(1 / (1 + x) - 1 / (1 + x) * x) * x * CF * pow(NC, -1)
            - 2 * Li3(x) * CF * pow(NC, -1) * pow(opx, -1)
            + Li3(x) * CF * pow(NC, -1)
            - Li3(x) * x * CF * pow(NC, -1)
            + 3 * Li2(-x) * CF * pow(NC, -1)
            + 4 * Li2(-x) * LMUF * CF * pow(NC, -1) * pow(opx, -1)
            - 2 * Li2(-x) * LMUF * CF * pow(NC, -1)
            + 3 * Li2(-x) * x * CF * pow(NC, -1)
            + 2 * Li2(-x) * x * LMUF * CF * pow(NC, -1)
            - Li2(x) * CF * pow(NC, -1)
            + 1.0 / 2.0 * Li2(x) * CF
            + Li2(x) * LMUF * CF
            - Li2(x) * x * CF * pow(NC, -1)
    ...
    if cx == "R" and cz == "0":
        ...
        res = (
            ...
            + 3 * x * CF
            + 5.0 / 2.0 * x * LMUF * CF
            - 1.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(opx, -1)
            + 1.0 / 6.0 * pow(pi, 2) * CF * pow(NC, -1)
            + 1.0 / 6.0 * pow(pi, 2) * CF
            - 1.0 / 6.0 * pow(pi, 2) * x * CF * pow(NC, -1)
            ...
            - 2 * ln(x) * ln(1 + x) * x * CF * pow(NC, -1)
            + pow(ln(x), 2) * CF * pow(NC, -1) * pow(opx, -1)
            - 1.0 / 2.0 * pow(ln(x), 2) * CF * pow(NC, -1)
            - pow(ln(x), 2) * CF
    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            tmp += (
                ...
                + 5 * LMUF * CF
                + 3.0 / 2.0 * LMUA * CF
                - 16 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1) * pow(opz, -1)
                + 16 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1)
                + 16 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 16 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2
                - 12 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * pow(omx, -1) * pow(opz, -1)
                + 12 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * pow(omx, -1)
                + 12 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * pow(opz, -1)
                - 12 * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2)
                + 2 * z * CF * pow(NC, -1)
                - 6 * z * CF * pow(NC, -1) * pow(rln2, 2) * pow(omx, -1)
            ...
            tmp += (
                ...
                - 2.0 / 3.0 * pow(pi, 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1) * pow(opx, -1)
                + 2.0 / 3.0 * pow(pi, 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                + 2.0 / 3.0 * pow(pi, 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                - 2.0 / 3.0 * pow(pi, 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                ...
                - 2.0 / 3.0 * pow(pi, 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 2.0 / 3.0 * pow(pi, 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 2.0 / 3.0 * pow(pi, 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                + 1.0 / 6.0 * pow(pi, 2) * pow(z, -1) * CF
                - 2.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 4.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 2.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 4.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
            )
            tmp += (
                -1.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                - 1.0 / 2.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(omx, -1)
                - 2.0 / 3.0 * pow(pi, 2) * CF * pow(NC, -1) * pow(omz, -1) * pow(opx, -1)
                ...
                - 8.0 / 3.0 * pow(pi, 2) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 2.0 / 3.0 * pow(pi, 2) * x * CF * pow(NC, -1)
                - 1.0 / 6.0 * pow(pi, 2) * x * CF
                - 2.0 / 3.0 * pow(pi, 2) * x * z * CF
                - 8 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * rln2 * pow(omx, -1) * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * rln2 * pow(omx, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * rln2 * pow(opz, -1)
            )
            tmp += (
                -8 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * rln2
                - 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                + 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                + 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2 * pow(omx, -1) * pow(opz, -1)
                + 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2 * pow(omx, -1)
                + 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2
                + 16 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 32 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 16 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 32 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 16 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1) * pow(opz, -1)
                - 32 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1)
                - 16 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 32 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2
                - 6 * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * rln2 * pow(omx, -1)
            ...
            tmp += (
                ...
                - 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1) * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1)
                - 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 16 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2
                + 6 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * rln2 * pow(omx, -1)
                - 8 * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * rln2
                + 4 * ln(1 + sqrtxz1 - z) * z * CF * rln2
                + 24 * ln(1 + sqrtxz1 - z) * pow(z, 2) * CF * rln2 * pow(omx, -1)
                - 24 * ln(1 + sqrtxz1 - z) * pow(z, 2) * CF * rln2
                - 64 * ln(1 + sqrtxz1 - z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 64 * ln(1 + sqrtxz1 - z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 64 * ln(1 + sqrtxz1 - z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                ...
                - 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
            )
            tmp += (
                -4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 4 * pow(ln(1 + sqrtxz1 - z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 8 * pow(ln(1 + sqrtxz1 - z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 4 * pow(ln(1 + sqrtxz1 - z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * pow(ln(1 + sqrtxz1 - z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * CF * pow(omx, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * CF
                - 4 * pow(ln(1 + sqrtxz1 - z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 4 * pow(ln(1 + sqrtxz1 - z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 4 * pow(ln(1 + sqrtxz1 - z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 4 * pow(ln(1 + sqrtxz1 - z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                - 16 * pow(ln(1 + sqrtxz1 - z), 2) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1)
            )
            tmp += (
                -8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                ...
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 6 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(omx, -1)
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1)
                - 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * CF * pow(omx, -1)
                + 2 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * CF
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
            )
            tmp += (
                -6 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 32 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                + 8 * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * rln2 * pow(opz, -1)
                - 8 * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * rln2
                - 8 * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2 * pow(omx, -1) * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2 * pow(omx, -1)
                + 8 * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                - 8 * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * rln2
                + 8 * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1) * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1)
                - 8 * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
            )
            tmp += (
                ...
                - 8 * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1)
                - 8 * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                ...
                - 32 * ln(1 + sqrtxz1 + z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                ...
                - pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
            )
            tmp += (
                ...
                - 2 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
            ...
            tmp += (
                +2 * ln(x) * LMUF * CF
                - 8 * ln(x) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 8 * ln(x) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 8 * ln(x) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * ln(x) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                - 32 * ln(x) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 4 * ln(x) * x * CF * pow(NC, -1)
                - ln(x) * x * CF * pow(poly2, -1)
                + ln(x) * x * CF * pow(xmz, -1)
                - 3.0 / 2.0 * ln(x) * x * CF
                - 2 * ln(x) * x * CF * rln2
                + 2 * ln(x) * x * LMUF * CF
            ...
            tmp += (
                ...
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1)
                + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1)
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
            ...
            tmp += (
                +8 * ln(x) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 3 * ln(x) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1)
                ...
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
            )
            tmp += (
                +2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
                ...
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(z, -1) * CF * pow(NC, -1)
            ...
            tmp += (
                ...
                - 2 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
                ...
                - 2 * ln(x) * ln(1 + x * z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 2 * ln(x) * ln(z + x) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                + 2 * ln(x) * ln(z + x) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1)
                + 2 * ln(x) * ln(z + x) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                - 2 * ln(x) * ln(z + x) * pow(z, -1) * CF * pow(NC, -1)
                - 2 * ln(x) * ln(z + x) * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 3 * pow(ln(x), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 3 * pow(ln(x), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                + 3 * pow(ln(x), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 3 * pow(ln(x), 2) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
            ...
            tmp += (
                ...
                - 7.0 / 2.0 * pow(ln(x), 2) * pow(z, -1) * CF * pow(NC, -1)
                - 3 * pow(ln(x), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                + 3 * pow(ln(x), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                + 3 * pow(ln(x), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                - 3 * pow(ln(x), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - pow(ln(x), 2) * pow(z, -1) * CF
                + 3 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 6 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 3 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 6 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 2 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(omx, -1)
                + 3 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(omz, -1) * pow(opx, -1)
                - 3 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(omz, -1)
                - 4 * pow(ln(x), 2) * CF * pow(NC, -1) * pow(opx, -1)
                + pow(ln(x), 2) * CF * pow(NC, -1)
                + 2 * pow(ln(x), 2) * CF * pow(omx, -1)
                + 5.0 / 2.0 * pow(ln(x), 2) * CF * pow(opx, -1)
                - pow(ln(x), 2) * CF
                + 3 * pow(ln(x), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 3 * pow(ln(x), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 3 * pow(ln(x), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 1.0 / 2.0 * pow(ln(x), 2) * x * pow(z, -1) * CF * pow(NC, -1)
                - pow(ln(x), 2) * x * pow(z, -1) * CF
                - 12 * pow(ln(x), 2) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 2 * ln(x) * ln(z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                + 2 * ln(x) * ln(z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                ...
                - 2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1)
                - 2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                + 4 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1)
            )
            tmp += (
                -2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                + 2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                + 2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                - 2 * ln(x) * ln(z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                + ln(x) * ln(z) * pow(z, -1) * CF
                + 2 * ln(x) * ln(z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 4 * ln(x) * ln(z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 2 * ln(x) * ln(z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(x) * ln(z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 2 * ln(x) * ln(z) * CF * pow(NC, -1) * pow(omx, -1)
                + ln(x) * ln(z) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * ln(x) * ln(z) * CF * pow(NC, -1)
                - 7 * ln(x) * ln(z) * CF * pow(omx, -1)
                + ln(x) * ln(z) * CF * pow(opx, -1)
                + 2 * ln(x) * ln(z) * CF
                + 2 * ln(x) * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 2 * ln(x) * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 2 * ln(x) * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * ln(x) * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 2 * ln(x) * ln(z) * z * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 8 * ln(x) * ln(z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 4 * ln(x) * ln(omx) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 4 * ln(x) * ln(omx) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                + 4 * ln(x) * ln(omx) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 4 * ln(x) * ln(omx) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
            ...
            tmp += (
                ...
                - 4 * ln(x) * ln(opx) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
            ...
            tmp += (
                ...
                + 2 * ln(z) * CF * sqrtxz1
                + ln(z) * LMUA * CF
                - 8 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 8 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 8 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 16 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1) * pow(opz, -1)
                + 16 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(omx, -1)
            )
            tmp += (
                +16 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 16 * ln(z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2
                + ln(z) * z * CF * pow(NC, -1) * pow(omx, -1)
                - 9 * ln(z) * z * CF * pow(NC, -1) * rln2 * pow(omx, -1)
                ...
                - 32 * ln(z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 64 * ln(z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 64 * ln(z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * rln2
                - ln(z) * x * CF * pow(NC, -1) * pow(omz, -1)
                ...
                - ln(z) * pow(x, 2) * CF * pow(poly2, -1)
                + 2 * ln(z) * pow(x, 2) * CF * pow(xmz, -1)
                - ln(z) * pow(x, 3) * CF * pow(poly2, -1)
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1)
                + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1)
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
            )
            tmp += (
                +8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                + 8 * ln(z) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 16 * ln(z) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 16 * ln(z) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 3 * ln(z) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 8 * ln(z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 16 * ln(z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 6 * ln(z) * ln(1 + sqrtxz1 + z) * CF * pow(NC, -1) * pow(omx, -1)
            ...
            tmp += (
                ...
                - 8 * ln(z) * ln(1 + sqrtxz1 + z) * z * CF * pow(NC, -1)
                ...
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * x * z * CF
                - 4 * ln(z) * ln(1 + z) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                + 2 * ln(z) * ln(1 + z) * CF * pow(NC, -1) * pow(omx, -1)
                - 2 * ln(z) * ln(1 + z) * z * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1) * pow(opx, -1)
                + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
            ...
            tmp += (
                ...
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                ...
                - 2 * ln(z) * ln(1 + x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                + 2 * ln(z) * ln(1 + x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
            ...
            tmp += (
                ...
                - 2 * ln(z) * ln(1 + x * z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                ...
                - 2 * ln(z) * ln(z + x) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - pow(ln(z), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1) * pow(opx, -1)
                + pow(ln(z), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                + pow(ln(z), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                - pow(ln(z), 2) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                ...
                - 2 * pow(ln(z), 2) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
                + 3 * pow(ln(z), 2) * pow(z, -1) * CF * pow(NC, -1)
                + 5 * pow(ln(z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                - 5 * pow(ln(z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 5 * pow(ln(z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 5 * pow(ln(z), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 5 * pow(ln(z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 10 * pow(ln(z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
            )
            tmp += (
                +5 * pow(ln(z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 10 * pow(ln(z), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                - 3 * pow(ln(z), 2) * CF
                - 5 * pow(ln(z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 5 * pow(ln(z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 5 * pow(ln(z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 5 * pow(ln(z), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 1.0 / 2.0 * pow(ln(z), 2) * z * CF * pow(NC, -1) * pow(omx, -1)
            ...
            tmp += (
                ...
                - 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                + 8 * ln(omz) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 16 * ln(omz) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 8 * ln(omz) * ln(1 + sqrtxz1 - z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 8 * ln(omz) * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 8 * ln(omz) * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 8 * ln(omz) * ln(1 + sqrtxz1 - z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 32 * ln(omz) * ln(1 + sqrtxz1 - z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
            )
            tmp += (
                +32 * ln(omz) * ln(1 + sqrtxz1 - z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                ...
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                + 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                - 8 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 16 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * pow(ln(omz), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
            )
            tmp += (
                -4 * pow(ln(omz), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * pow(ln(omz), 2) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 4 * pow(ln(omz), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 8 * pow(ln(omz), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 4 * pow(ln(omz), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * pow(ln(omz), 2) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 4 * pow(ln(omz), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 4 * pow(ln(omz), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 4 * pow(ln(omz), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 4 * pow(ln(omz), 2) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 16 * pow(ln(omz), 2) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * pow(ln(omz), 2) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
            ...
            tmp += (
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
            )
            tmp += (
                ...
                - 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                ...
                - 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
            )
            tmp += (
            ...
            tmp += (
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
            )
            tmp += (
                -8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 8 * Li2(pow(sqrtxz1, -1) * omz) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 16 * Li2(pow(sqrtxz1, -1) * omz) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 8 * Li2(pow(sqrtxz1, -1) * omz) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * Li2(pow(sqrtxz1, -1) * omz) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 8 * Li2(pow(sqrtxz1, -1) * omz) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
            )
            tmp += (
                ...
                - 8 * Li2(pow(sqrtxz1, -1) * omz) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 32 * Li2(pow(sqrtxz1, -1) * omz) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 32 * Li2(pow(sqrtxz1, -1) * omz) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1) * pow(opz, -1)
                - 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 8 * Li2(-sqrtxz1 * pow(omz, -1)) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                + 16 * Li2(-sqrtxz1 * pow(omz, -1)) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1)
                + 8 * Li2(-sqrtxz1 * pow(omz, -1)) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * Li2(-sqrtxz1 * pow(omz, -1)) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 8 * Li2(-sqrtxz1 * pow(omz, -1)) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 8 * Li2(-sqrtxz1 * pow(omz, -1)) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                + 32 * Li2(-sqrtxz1 * pow(omz, -1)) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 32 * Li2(-sqrtxz1 * pow(omz, -1)) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
            )
            tmp += (
                -4 * Li2(-z) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                + 2 * Li2(-z) * CF * pow(NC, -1) * pow(omx, -1)
                - 2 * Li2(-z) * z * CF * pow(NC, -1) * pow(omx, -1)
                ...
                - 2 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                + 2 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 2 * Li2(-x * pow(z, -1)) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
                ...
                - 2 * Li2(-x * pow(z, -1)) * pow(z, -1) * CF * pow(NC, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 4 * Li2(-x * pow(z, -1)) * pow(z, -1) * CF * pow(NC, -1)
            ...
            tmp += (
                ...
                - 2 * Li2(-x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(omz, -1)
                - 2 * Li2(-x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1) * pow(opx, -1)
                + 2 * Li2(-x * z) * pow(x, -1) * pow(z, -1) * CF * pow(NC, -1)
                - 2 * Li2(-x * z) * pow(x, -1) * CF * pow(NC, -1) * pow(opx, -1)
                ...
                - 2 * Li2(-x * z) * pow(z, -1) * CF * pow(NC, -1) * pow(opz, -1)
            ...
            tmp += (
                -4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(omx, -1)
                - 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(z, -1) * CF * pow(NC, -1) * sqrtxz1
                - 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 8 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(omx, -1) * pow(opz, -1)
                ...
                - 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * z * CF * pow(NC, -1) * pow(sqrtxz1, -1)
            )
            tmp += (
                +16 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * x * CF * pow(NC, -1) * pow(sqrtxz1, -1)
                - 2 * Li2(x) * pow(x, -2) * CF * pow(opx, -1)
                + 2 * Li2(x) * pow(x, -2) * CF
                + 4 * Li2(x) * pow(x, -2) * z * CF * pow(opx, -1)
                - 4 * Li2(x) * pow(x, -2) * z * CF
...
def c2p_q2qb_eq(x, z, rsl, order, f=C2Pq2qbEq_DR0123_scheme):
    if rsl == "ll":
