...
def C1Tg2qEq_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    res = 0.0
...
def c1tg2q_eq(x, z, rsl, order, f=C1Tg2qEq_DR0123_scheme):
    if rsl == "ll":
