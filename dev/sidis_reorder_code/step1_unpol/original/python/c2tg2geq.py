    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            tmp += (
                ...
                - 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(sqrtxz1, -1)
                + 1.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(omz, -1)
                + 1.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(opx, -1)
                - 1.0 / 4.0 * pow(NC, -1) * pow(pi, 2)
                - 8 * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 8 * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2
                - 6 * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(rln2, 2) * pow(opz, -1)
                + 6 * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(rln2, 2)
                - 27.0 / 16.0 * pow(NC, -1) * z
                - 2 * pow(NC, -1) * z * pow(rln2, 2)
                - 1.0 / 3.0 * pow(NC, -1) * z * pow(pi, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 8 * pow(NC, -1) * x * pow(z, -1) * pow(rln2, 2) * pow(opz, -1)
                + 8 * pow(NC, -1) * x * pow(z, -1) * pow(rln2, 2)
                - 16 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                + 16 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2
                - 12 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(rln2, 2) * pow(opz, -1)
                + 12 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(rln2, 2)
                - 1.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * pow(omz, -1) * pow(opx, -1)
                - 2.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * pow(omz, -1)
                + 1.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * pow(opx, -1)
                + 1.0 / 12.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2)
            )
            tmp += (
                -2.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * sqrtxz1 * pow(opz, -1)
                + 2.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * sqrtxz1
                - 80 * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 64 * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2
                - 60 * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(rln2, 2) * pow(opz, -1)
                + 48 * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(rln2, 2)
                + 1.0 / 2.0 * pow(NC, -1) * x
                - 8 * pow(NC, -1) * x * pow(rln2, 2)
                - 10.0 / 3.0 * pow(NC, -1) * x * pow(pi, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - LMUA * LMUF * pow(NC, -1) * pow(x, 2) * pow(z, -1)
            ...
            tmp += (
                ...
                - 19.0 / 16.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(z, 2) * sqrtxz3
                + 45.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * x * pow(z, -1) * sqrtxz3
                + 105.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * x * z * sqrtxz3
                - 35.0 / 16.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                + 3.0 / 2.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * pow(x, -1) * z * sqrtxz3
                - 3.0 / 2.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * sqrtxz3
                - 3.0 / 2.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                + 15.0 / 2.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                - 5.0 / 16.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                - 9.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                - 21.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(x, -1) * z * sqrtxz3
            )
            tmp += (
                -5.0 / 16.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(z, -2) * sqrtxz3
                - 5.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * sqrtxz3
                + 19.0 / 16.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(z, 2) * sqrtxz3
                - 45.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * x * pow(z, -1) * sqrtxz3
                - 105.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * x * z * sqrtxz3
                ...
                - 3.0 / 2.0 * InvTanInt(z * sqrtxz3) * pow(NC, -1) * sqrtxz3
                - 3.0 / 2.0 * InvTanInt(z * sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                + 15.0 / 2.0 * InvTanInt(z * sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                - 5.0 / 16.0 * InvTanInt(z * sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                - 9.0 / 8.0 * InvTanInt(z * sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                - 21.0 / 8.0 * InvTanInt(z * sqrtxz3) * NC * pow(x, -1) * z * sqrtxz3
            )
            tmp += (
                -5.0 / 16.0 * InvTanInt(z * sqrtxz3) * NC * pow(z, -2) * sqrtxz3
                - 5.0 / 4.0 * InvTanInt(z * sqrtxz3) * NC * sqrtxz3
                + 19.0 / 16.0 * InvTanInt(z * sqrtxz3) * NC * pow(z, 2) * sqrtxz3
                - 45.0 / 8.0 * InvTanInt(z * sqrtxz3) * NC * x * pow(z, -1) * sqrtxz3
                - 105.0 / 8.0 * InvTanInt(z * sqrtxz3) * NC * x * z * sqrtxz3
                ...
                + 105.0 / 16.0 * InvTanInt(sqrtxz3) * NC * x * z * sqrtxz3
                - 35.0 / 32.0 * InvTanInt(sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                - 4 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * rln2 * pow(opz, -1)
                + 5 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * rln2
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
            ...
            tmp += (
                ...
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2
                + 3 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * rln2
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * rln2 * pow(opz, -1)
                - 10 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * rln2
                + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2
                + 80 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                + 80 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2
                + 12 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * rln2
                - 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                - 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
            )
            tmp += (
                +16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2
                - 6 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * rln2
                - 4 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2 * pow(opz, -1)
                + 6 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2
                - 88 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 80 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                - 88 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 80 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2
                - 6 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * rln2
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2
                + 6 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * rln2
                + 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
                + 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
            )
            tmp += (
                -32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2
                - 3 * ln(1 + sqrtxz1 - z) * NC * pow(z, -1) * rln2
                - 2 * ln(1 + sqrtxz1 - z) * NC * pow(z, -1) * sqrtxz1
                + 4 * ln(1 + sqrtxz1 - z) * NC * rln2
                - 3 * ln(1 + sqrtxz1 - z) * NC * z * rln2
                + 6 * ln(1 + sqrtxz1 - z) * NC * x * pow(z, -1) * rln2
                + 4 * ln(1 + sqrtxz1 - z) * NC * x * pow(z, -1) * sqrtxz1
                - 8 * ln(1 + sqrtxz1 - z) * NC * x * rln2
                + 6 * ln(1 + sqrtxz1 - z) * NC * x * z * rln2
                - 6 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * pow(z, -1) * rln2
                - 4 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * pow(z, -1) * sqrtxz1
                + 2 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * rln2
                - 6 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * z * rln2
                - pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(z, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                ...
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                - pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * z
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1)
                - 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 20 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                + 22 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 20 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2)
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                - 2 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * z
                - 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                - ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
                + 6 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1)
                - 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 40 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 2 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * NC * x * pow(z, -1)
                - 2 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * NC * x * z
            ...
            tmp += (
                ...
                - 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                ...
                - 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2
                + ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * rln2
                + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * rln2 * pow(opz, -1)
                - 6 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * rln2
                + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                - 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2
                + 40 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 32 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2
                + 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * rln2
                - 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2
                - 2 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * rln2
                - 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2 * pow(opz, -1)
                + 2 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2
                - 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
            )
            tmp += (
                +4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2
                - 44 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 40 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2
                - 2 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * rln2
                + 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2
                + 2 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * z * rln2
                + 16 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 16 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2
                - ln(1 + sqrtxz1 + z) * NC * pow(z, -1) * rln2
                - ln(1 + sqrtxz1 + z) * NC * z * rln2
                + 2 * ln(1 + sqrtxz1 + z) * NC * x * pow(z, -1) * rln2
                + 2 * ln(1 + sqrtxz1 + z) * NC * x * z * rln2
                - 2 * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * pow(z, -1) * rln2
                - 2 * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * rln2
                - 2 * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * z * rln2
                + 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                + 3.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * pow(opz, -1)
                - pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(sqrtxz1, -1)
                - 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1)
            )
            tmp += (
                -pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 5 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                + pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                - pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                + 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                + 11.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 5 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                - 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 1.0 / 2.0 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                - 2 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
            ...
            tmp += (
                ...
                - 2 * ln(x) * pow(NC, -1) * pow(x, -2) * z
                - 12 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 8 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                + 12 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - 8 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                + 6 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(x, -1)
                + 6 * ln(x) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(x, -1) * z
                - 12 * ln(x) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 12 * ln(x) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                - 7.0 / 4.0 * ln(x) * pow(NC, -1) * pow(z, -1)
                + 2 * ln(x) * pow(NC, -1) * pow(z, -1) * rln2 * pow(opz, -1)
                - 3 * ln(x) * pow(NC, -1) * pow(z, -1) * rln2
                + 4 * ln(x) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                ...
                - 4 * ln(x) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(x) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + 8 * ln(x) * pow(NC, -1) * z * pow(opx, -1)
                - 5 * ln(x) * pow(NC, -1) * z
                - 2 * ln(x) * pow(NC, -1) * z * rln2
                - 4 * ln(x) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 8 * ln(x) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                + 4 * ln(x) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                + 13 * ln(x) * pow(NC, -1) * x * pow(z, -1)
            )
            tmp += (
                -4 * ln(x) * pow(NC, -1) * x * pow(z, -1) * rln2 * pow(opz, -1)
                + 6 * ln(x) * pow(NC, -1) * x * pow(z, -1) * rln2
                - 8 * ln(x) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * ln(x) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 40 * ln(x) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                + 32 * ln(x) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                + 8 * ln(x) * pow(NC, -1) * x * pow(omz, -1)
                - 11.0 / 4.0 * ln(x) * pow(NC, -1) * x
                - 8 * ln(x) * pow(NC, -1) * x * rln2
                + 8 * ln(x) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * ln(x) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                + 4 * ln(x) * pow(NC, -1) * x * z * pow(opx, -1)
                - 5.0 / 4.0 * ln(x) * pow(NC, -1) * x * z
                + 4 * ln(x) * pow(NC, -1) * x * z * rln2
                - 4 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                - 1.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                + 2 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2 * pow(opz, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2
                + 4 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                + 44 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 40 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                + 4 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                + 7.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 2)
                + 4 * ln(x) * pow(NC, -1) * pow(x, 2) * rln2
                - 4 * ln(x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                + 1.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 2) * z
                - 4 * ln(x) * pow(NC, -1) * pow(x, 2) * z * rln2
                - 16 * ln(x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 16 * ln(x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
            )
            tmp += (
                -2 * ln(x) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + 2 * ln(x) * NC * pow(x, -2) * pow(z, -1)
                - 2 * ln(x) * NC * pow(x, -2) * z * pow(opx, -1)
                + 2 * ln(x) * NC * pow(x, -2) * z
                - 6 * ln(x) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 133.0 / 32.0 * ln(x) * NC * pow(x, -1) * pow(z, -1)
                - 5.0 / 32.0 * ln(x) * NC * pow(x, -1)
                - 6 * ln(x) * NC * pow(x, -1) * z * pow(opx, -1)
                + 4 * ln(x) * NC * pow(x, -1) * z
                - 5.0 / 32.0 * ln(x) * NC * pow(z, -2)
                - 8 * ln(x) * NC * pow(z, -1) * pow(opx, -1)
            ...
            tmp += (
                ...
                - ln(x) * LMUA * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                ...
                - 2 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1)
            ...
            tmp += (
                ...
                - 2 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z
                ...
                - 2 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2)
                ...
                - ln(x) * ln(1 + sqrtxz1 - z) * NC * pow(z, -1)
                + 2 * ln(x) * ln(1 + sqrtxz1 - z) * NC
                - ln(x) * ln(1 + sqrtxz1 - z) * NC * z
                + 2 * ln(x) * ln(1 + sqrtxz1 - z) * NC * x * pow(z, -1)
                - 4 * ln(x) * ln(1 + sqrtxz1 - z) * NC * x
                + 2 * ln(x) * ln(1 + sqrtxz1 - z) * NC * x * z
            )
            tmp += (
                -2 * ln(x) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * pow(z, -1)
                + 2 * ln(x) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2)
                - 2 * ln(x) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * z
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * pow(opz, -1)
                ...
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1)
                + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 20 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                ...
                + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
            )
            tmp += (
                +2 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                ...
                - ln(x) * ln(1 + sqrtxz1 + z) * NC * z
                + 2 * ln(x) * ln(1 + sqrtxz1 + z) * NC * x * pow(z, -1)
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * NC * x
                + 2 * ln(x) * ln(1 + sqrtxz1 + z) * NC * x * z
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * pow(z, -1)
                - 2 * ln(x) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * z
                + ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(opx, -1)
            )
            tmp += (
                +1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                + 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z
                + 3 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                - 3 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                - 3.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1)
                - 3.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z
                + 3 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 3 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1)
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z * pow(opx, -1)
                ...
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * z * pow(opx, -1)
            )
            tmp += (
                -ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * z
                + ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, 2) * z
                + 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * pow(z, -1)
                + 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * z * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * z
                + 3.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * pow(z, -1)
                + 3.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z * pow(opx, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z
                + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(z, -1) * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(z, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * NC
                + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * z * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * pow(z, -1)) * NC * z
                + ln(x) * ln(1 + x * pow(z, -1)) * NC * x * pow(z, -1) * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * NC * x * pow(z, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * NC * x * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * NC * x * z * pow(opx, -1)
                + ln(x) * ln(1 + x * pow(z, -1)) * NC * x * z
                + ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2) * pow(z, -1)
                - ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2)
            ...
            tmp += (
                ...
                - ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(opx, -1)
                + 1.0 / 2.0 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                + 1.0 / 2.0 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * z
                + 3 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                - 3 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                - 3.0 / 2.0 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1)
                - 3.0 / 2.0 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z
                + 3 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 3 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * pow(opz, -1)
                - ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1)
                - ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * z * pow(opx, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                - ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
            )
            tmp += (
                -2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x
                - ln(x) * ln(1 + x * z) * pow(NC, -1) * x * z * pow(opx, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                + ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * z
                + 1.0 / 2.0 * ln(x) * ln(1 + x * z) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * z) * NC * pow(x, -2) * pow(z, -1)
                + 1.0 / 2.0 * ln(x) * ln(1 + x * z) * NC * pow(x, -2) * z * pow(opx, -1)
                - 1.0 / 2.0 * ln(x) * ln(1 + x * z) * NC * pow(x, -2) * z
                + 3.0 / 2.0 * ln(x) * ln(1 + x * z) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - ln(x) * ln(1 + x * z) * NC * pow(x, -1) * pow(z, -1)
                + 3.0 / 2.0 * ln(x) * ln(1 + x * z) * NC * pow(x, -1) * z * pow(opx, -1)
                - ln(x) * ln(1 + x * z) * NC * pow(x, -1) * z
                ...
                - 2 * ln(x) * ln(z + x) * pow(NC, -1) * x * pow(z, -1)
                + ln(x) * ln(z + x) * pow(NC, -1) * x
                - ln(x) * ln(z + x) * pow(NC, -1) * x * z
            )
            tmp += (
                -ln(x) * ln(z + x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
                + ln(x) * ln(z + x) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                + ln(x) * ln(z + x) * pow(NC, -1) * pow(x, 2) * z
                - 1.0 / 2.0 * ln(x) * ln(z + x) * NC * pow(z, -1)
                - 1.0 / 2.0 * ln(x) * ln(z + x) * NC * z
                + ln(x) * ln(z + x) * NC * x * pow(z, -1)
                + ln(x) * ln(z + x) * NC * x * z
                - ln(x) * ln(z + x) * NC * pow(x, 2) * pow(z, -1)
                - ln(x) * ln(z + x) * NC * pow(x, 2)
                - ln(x) * ln(z + x) * NC * pow(x, 2) * z
                + 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1)
                - 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1)
                - 3.0 / 4.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(opx, -1)
                + 3.0 / 4.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2)
                - 3.0 / 4.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                + 3.0 / 4.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * z
                + 9.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                - 9.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                - 9.0 / 4.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                + 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1)
                - 9.0 / 4.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                + 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * z
                + 9.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 9.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
            )
            tmp += (
                -1.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1)
                - 3.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
            ...
            tmp += (
                -ln(x) * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + 2 * ln(x) * ln(z) * pow(NC, -1) * z * pow(opx, -1)
                - 3.0 / 2.0 * ln(x) * ln(z) * pow(NC, -1) * z
                - ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                + ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
                + 9.0 / 2.0 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1)
                + 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 10 * ln(x) * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * ln(x) * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                + 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(omz, -1)
                - 2 * ln(x) * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                - 11 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                - ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * z
                + 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
            )
            tmp += (
                -4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
                - 1.0 / 2.0 * ln(x) * ln(z) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + 1.0 / 2.0 * ln(x) * ln(z) * NC * pow(x, -2) * pow(z, -1)
                - 1.0 / 2.0 * ln(x) * ln(z) * NC * pow(x, -2) * z * pow(opx, -1)
                + 1.0 / 2.0 * ln(x) * ln(z) * NC * pow(x, -2) * z
                - 3.0 / 2.0 * ln(x) * ln(z) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + ln(x) * ln(z) * NC * pow(x, -1) * pow(z, -1)
                - 3.0 / 2.0 * ln(x) * ln(z) * NC * pow(x, -1) * z * pow(opx, -1)
                + ln(x) * ln(z) * NC * pow(x, -1) * z
                - 2 * ln(x) * ln(z) * NC * pow(z, -1) * pow(opx, -1)
                + 3.0 / 4.0 * ln(x) * ln(z) * NC * pow(z, -1)
                + ln(x) * ln(z) * NC * pow(opx, -1)
                - 5.0 / 2.0 * ln(x) * ln(z) * NC
                - 2 * ln(x) * ln(z) * NC * z * pow(opx, -1)
                + 3.0 / 2.0 * ln(x) * ln(z) * NC * z
                - ln(x) * ln(z) * NC * x * pow(z, -1) * pow(opx, -1)
                - 7.0 / 2.0 * ln(x) * ln(z) * NC * x * pow(z, -1)
                + ln(x) * ln(z) * NC * x * pow(opx, -1)
                - 3 * ln(x) * ln(z) * NC * x
                - ln(x) * ln(z) * NC * x * z * pow(opx, -1)
                - 2 * ln(x) * ln(z) * NC * x * z
                ...
                - 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(z, -1)
                - ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(opx, -1)
                + ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2)
                - ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                + ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * z
                + 6 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
            )
            tmp += (
                -6 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                - 3 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1)
                - 3 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                + 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z
                + 6 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 6 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                + 1.0 / 2.0 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1)
                - 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(omz, -1)
                - 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(opx, -1)
                - 4 * ln(x) * ln(omx) * pow(NC, -1) * z * pow(opx, -1)
                + 2 * ln(x) * ln(omx) * pow(NC, -1) * z
                + 2 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 4 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                - 2 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 5 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1)
                - 4 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(omz, -1)
                - 2 * ln(x) * ln(omx) * pow(NC, -1) * x * z * pow(opx, -1)
                + 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                - ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                - ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2)
                + ln(x) * ln(omx) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                - ln(x) * ln(omx) * NC * pow(x, -2) * pow(z, -1)
                + ln(x) * ln(omx) * NC * pow(x, -2) * z * pow(opx, -1)
                - ln(x) * ln(omx) * NC * pow(x, -2) * z
                + 3 * ln(x) * ln(omx) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(omx) * NC * pow(x, -1) * pow(z, -1)
                + 3 * ln(x) * ln(omx) * NC * pow(x, -1) * z * pow(opx, -1)
            )
            tmp += (
                -2 * ln(x) * ln(omx) * NC * pow(x, -1) * z
                + 4 * ln(x) * ln(omx) * NC * pow(z, -1) * pow(opx, -1)
                - 5.0 / 2.0 * ln(x) * ln(omx) * NC * pow(z, -1)
            ...
            tmp += (
                ...
                - ln(x) * ln(opx) * pow(NC, -1) * pow(x, -2)
                + ln(x) * ln(opx) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                - ln(x) * ln(opx) * pow(NC, -1) * pow(x, -2) * z
                - 6 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 4 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                + 6 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - 4 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
            )
            tmp += (
                +3 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1)
                + 3 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                - 2 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * z
                - 6 * ln(x) * ln(opx) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                ...
                - ln(x) * ln(opx) * pow(NC, -1) * z
                - 2 * ln(x) * ln(opx) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 4 * ln(x) * ln(opx) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                ...
                - ln(x) * ln(opx) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + ln(x) * ln(opx) * NC * pow(x, -2) * pow(z, -1)
                - ln(x) * ln(opx) * NC * pow(x, -2) * z * pow(opx, -1)
                + ln(x) * ln(opx) * NC * pow(x, -2) * z
                - 3 * ln(x) * ln(opx) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 2 * ln(x) * ln(opx) * NC * pow(x, -1) * pow(z, -1)
                - 3 * ln(x) * ln(opx) * NC * pow(x, -1) * z * pow(opx, -1)
                + 2 * ln(x) * ln(opx) * NC * pow(x, -1) * z
                - 4 * ln(x) * ln(opx) * NC * pow(z, -1) * pow(opx, -1)
            ...
            tmp += (
                +ln(x) * ln(opx) * NC * z
                - 2 * ln(x) * ln(opx) * NC * x * pow(z, -1) * pow(opx, -1)
                - 2 * ln(x) * ln(opx) * NC * x * pow(z, -1)
                + 2 * ln(x) * ln(opx) * NC * x * pow(opx, -1)
                - 2 * ln(x) * ln(opx) * NC * x * z * pow(opx, -1)
                - 2 * ln(x) * ln(opx) * NC * x * z
                - 2 * ln(x) * ln(opx) * NC * pow(x, 2) * pow(z, -1)
                + 2 * ln(x) * ln(opx) * NC * pow(x, 2)
                - 2 * ln(x) * ln(opx) * NC * pow(x, 2) * z
                + 23.0 / 8.0 * ln(z) * pow(NC, -1) * pow(z, -1)
                + 6 * ln(z) * pow(NC, -1) * pow(z, -1) * rln2 * pow(opz, -1)
                - 5 * ln(z) * pow(NC, -1) * pow(z, -1) * rln2
                + 4 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                + 8 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                - 8 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2
                ...
                - 4 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                - 8 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 8 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2
                + 1.0 / 8.0 * ln(z) * pow(NC, -1) * z
                - 2 * ln(z) * pow(NC, -1) * z * rln2
                - 7 * ln(z) * pow(NC, -1) * x * pow(z, -1)
                - 12 * ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2 * pow(opz, -1)
                + 10 * ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2
                - 8 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 8 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                + 16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2
            )
            tmp += (
                -40 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                + 32 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                - 80 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 64 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2
                - 3.0 / 4.0 * ln(z) * pow(NC, -1) * x
                - 8 * ln(z) * pow(NC, -1) * x * rln2
                + 8 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                - 8 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                + 16 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 16 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2
                - ln(z) * pow(NC, -1) * x * z
                + 4 * ln(z) * pow(NC, -1) * x * z * rln2
                + 13.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                + 6 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2 * pow(opz, -1)
                - 4 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * rln2
                + 4 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                + 8 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                - 8 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2
                + 44 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 40 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                + 88 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 80 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2
                + 1.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 2)
                + 4 * ln(z) * pow(NC, -1) * pow(x, 2) * rln2
                - 4 * ln(z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                - 8 * ln(z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 8 * ln(z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2
            )
            tmp += (
                +ln(z) * pow(NC, -1) * pow(x, 2) * z
                - 4 * ln(z) * pow(NC, -1) * pow(x, 2) * z * rln2
                - 16 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 16 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
                - 32 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 32 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2
                - 5.0 / 32.0 * ln(z) * NC * pow(x, -1) * pow(z, -1)
                - 5.0 / 32.0 * ln(z) * NC * pow(x, -1)
                + 5.0 / 32.0 * ln(z) * NC * pow(z, -2)
                - 63.0 / 16.0 * ln(z) * NC * pow(z, -1)
                ...
                + 1.0 / 32.0 * ln(z) * NC * z
                + 2 * ln(z) * NC * z * rln2
                - 5.0 / 32.0 * ln(z) * NC * x * pow(z, -2)
                + 93.0 / 16.0 * ln(z) * NC * x * pow(z, -1)
                - 4 * ln(z) * NC * x * pow(z, -1) * rln2
                - 2 * ln(z) * NC * x * pow(z, -1) * sqrtxz1
                - 7.0 / 16.0 * ln(z) * NC * x
                + 2 * ln(z) * NC * x * rln2
                + 27.0 / 32.0 * ln(z) * NC * x * z
                - 4 * ln(z) * NC * x * z * rln2
                - 131.0 / 32.0 * ln(z) * NC * pow(x, 2) * pow(z, -1)
            ...
            tmp += (
                ...
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z
                + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
            )
            tmp += (
                -4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1)
                + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 40 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 32 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x
                - 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
                + 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                - 44 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                + 40 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2)
                + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                + 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z
                + 16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
                - ln(z) * ln(1 + sqrtxz1 - z) * NC * pow(z, -1)
            )
            tmp += (
                +ln(z) * ln(1 + sqrtxz1 - z) * NC
                - ln(z) * ln(1 + sqrtxz1 - z) * NC * z
                + 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * pow(z, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x
                + 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * z
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * pow(z, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * z
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * pow(opz, -1)
                ...
                - 6 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1)
                + 8 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 8 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 40 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 32 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
            ...
            tmp += (
                -2 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
                + 2 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                - 44 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                + 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * z
                - 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * pow(z, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2)
                - 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * z
                - ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
            ...
            tmp += (
                ...
                - 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                - 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z
                - 3 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                + 3 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                + 3.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                - ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1)
                + 3.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                - ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z
                - 3 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                ...
                - 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z
                - ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
            ...
            tmp += (
                ...
                - 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * pow(z, -1)
                - 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * z * pow(opx, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -2) * z
                - 3.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * pow(z, -1)
                - 3.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z * pow(opx, -1)
                + ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(z, -1) * pow(opx, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(z, -1)
                + ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(opx, -1)
                - ln(z) * ln(1 + x * pow(z, -1)) * NC
                - 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * z * pow(opx, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * pow(z, -1)) * NC * z
                - ln(z) * ln(1 + x * pow(z, -1)) * NC * x * pow(z, -1) * pow(opx, -1)
                - ln(z) * ln(1 + x * pow(z, -1)) * NC * x * pow(z, -1)
                + ln(z) * ln(1 + x * pow(z, -1)) * NC * x * pow(opx, -1)
                - ln(z) * ln(1 + x * pow(z, -1)) * NC * x * z * pow(opx, -1)
                - ln(z) * ln(1 + x * pow(z, -1)) * NC * x * z
                - ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2) * pow(z, -1)
                + ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2)
            )
            tmp += (
                -ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2) * z
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(omz, -1)
                - ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1)
                - 1.0 / 2.0 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(opx, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2)
                - 1.0 / 2.0 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * z
                + 3 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                - 3 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                - 3.0 / 2.0 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1)
                - 3.0 / 2.0 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z
                + 3 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 3 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * pow(opz, -1)
                - ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1)
                - ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(opx, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * z * pow(opx, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
            )
            tmp += (
                -ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x
                - ln(z) * ln(1 + x * z) * pow(NC, -1) * x * z * pow(opx, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                + ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                - 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * z
                + 1.0 / 2.0 * ln(z) * ln(1 + x * z) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                - 1.0 / 2.0 * ln(z) * ln(1 + x * z) * NC * pow(x, -2) * pow(z, -1)
                + 1.0 / 2.0 * ln(z) * ln(1 + x * z) * NC * pow(x, -2) * z * pow(opx, -1)
                - 1.0 / 2.0 * ln(z) * ln(1 + x * z) * NC * pow(x, -2) * z
                + 3.0 / 2.0 * ln(z) * ln(1 + x * z) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - ln(z) * ln(1 + x * z) * NC * pow(x, -1) * pow(z, -1)
                + 3.0 / 2.0 * ln(z) * ln(1 + x * z) * NC * pow(x, -1) * z * pow(opx, -1)
                - ln(z) * ln(1 + x * z) * NC * pow(x, -1) * z
            ...
            tmp += (
                ...
                - 5.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                ...
                - 5.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 5.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + pow(ln(z), 2) * pow(NC, -1) * z * pow(opx, -1)
                + 1.0 / 4.0 * pow(ln(z), 2) * pow(NC, -1) * z
                - 1.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                + 1.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
                - 5 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 5 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 25 * pow(ln(z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                + 20 * pow(ln(z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                - pow(ln(z), 2) * pow(NC, -1) * x * pow(omz, -1)
                + 5 * pow(ln(z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                - 5 * pow(ln(z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
            ...
            tmp += (
                ...
                - ln(omx) * LMUF * pow(NC, -1) * x * pow(z, -1)
            ...
            tmp += (
                ...
                - pow(ln(omx), 2) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
            ...
            tmp += (
                ...
                - 4 * ln(omz) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2
                + 12 * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 8 * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2
                - 7.0 / 4.0 * ln(omz) * pow(NC, -1)
                - 4 * ln(omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 4 * ln(omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2
                + 3.0 / 8.0 * ln(omz) * pow(NC, -1) * z
                - 5 * ln(omz) * pow(NC, -1) * x * pow(z, -1)
                - 8 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * pow(opz, -1)
                + 8 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2
                - 40 * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 32 * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2
                + 4 * ln(omz) * pow(NC, -1) * x
                + 8 * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                - 8 * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2
                ...
                - 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * rln2
                + 44 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
            )
            tmp += (
                -40 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2
                - 7.0 / 2.0 * ln(omz) * pow(NC, -1) * pow(x, 2)
                - 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * rln2
                - 1.0 / 2.0 * ln(omz) * pow(NC, -1) * pow(x, 2) * z
                - 16 * ln(omz) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2 * pow(opz, -1)
                + 16 * ln(omz) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * rln2
                - 15.0 / 8.0 * ln(omz) * NC * pow(z, -1)
                + 7.0 / 4.0 * ln(omz) * NC
                - 3.0 / 8.0 * ln(omz) * NC * z
                + 5 * ln(omz) * NC * x * pow(z, -1)
                - 4 * ln(omz) * NC * x
                + 1.0 / 4.0 * ln(omz) * NC * x * z
                - 9.0 / 2.0 * ln(omz) * NC * pow(x, 2) * pow(z, -1)
            ...
            tmp += (
                ...
                - 4 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                ...
                - 4 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 40 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 32 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                - 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                - 4 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
            )
            tmp += (
                -44 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                + 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
                - 2 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                ...
                - 2 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                + 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 20 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                - 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
            )
            tmp += (
                -2 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 2 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                - 22 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(z, -1) * sqrtxz1
            )
            tmp += (
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                - 20 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
            )
            tmp += (
                +22 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 20 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                - 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
            ...
            tmp += (
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
            ...
            tmp += (
                -4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
                + 20 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                - 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1)
                + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x
                - 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                - 22 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                ...
                - 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1)
            )
            tmp += (
            ...
            tmp += (
                ...
                - Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1)
                - 1.0 / 2.0 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(opx, -1)
                + 1.0 / 2.0 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2)
                - 1.0 / 2.0 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z * pow(opx, -1)
                + 1.0 / 2.0 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z
                + 3 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(omz, -1)
                - 3 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1)
                - 3.0 / 2.0 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(opx, -1)
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1)
                - 3.0 / 2.0 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z
                + 3 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
            )
            tmp += (
                -3 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                - Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * pow(opz, -1)
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1)
                - Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(opx, -1)
                - Li2(-x * pow(z, -1)) * pow(NC, -1)
                - 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * z * pow(opx, -1)
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * z
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                - Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * pow(opz, -1)
                - 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1)
                - Li2(-x * pow(z, -1)) * pow(NC, -1) * x * z * pow(opx, -1)
                - 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * z
                + Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                - Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(opz, -1)
                + 1.0 / 2.0 * Li2(-x * pow(z, -1)) * NC * pow(x, -2) * pow(z, -1) * pow(opx, -1)
                - 1.0 / 2.0 * Li2(-x * pow(z, -1)) * NC * pow(x, -2) * pow(z, -1)
                + 1.0 / 2.0 * Li2(-x * pow(z, -1)) * NC * pow(x, -2) * z * pow(opx, -1)
                - 1.0 / 2.0 * Li2(-x * pow(z, -1)) * NC * pow(x, -2) * z
                + 3.0 / 2.0 * Li2(-x * pow(z, -1)) * NC * pow(x, -1) * pow(z, -1) * pow(opx, -1)
                - Li2(-x * pow(z, -1)) * NC * pow(x, -1) * pow(z, -1)
                + 3.0 / 2.0 * Li2(-x * pow(z, -1)) * NC * pow(x, -1) * z * pow(opx, -1)
                - Li2(-x * pow(z, -1)) * NC * pow(x, -1) * z
                + 2 * Li2(-x * pow(z, -1)) * NC * pow(z, -1) * pow(opx, -1)
                - Li2(-x * pow(z, -1)) * NC * pow(z, -1)
            ...
            tmp += (
                ...
                - Li2(-x * pow(z, -1)) * NC * x * pow(opx, -1)
                + Li2(-x * pow(z, -1)) * NC * x * z * pow(opx, -1)
                + 2 * Li2(-x * pow(z, -1)) * NC * x * z
                - 2 * Li2(-x * pow(z, -1)) * NC * pow(x, 2)
            ...
            tmp += (
                ...
                - 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1
                ...
                - 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * z * pow(sqrtxz1, -1)
                - 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                + 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1
            )
            tmp += (
                -20 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(opz, -1)
                ...
                - 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1)
                + 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1 * pow(opz, -1)
                - 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * sqrtxz1
                + 22 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(opz, -1)
                - 20 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1)
                - 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1) * pow(opz, -1)
                + 2 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz1, -1)
                - 8 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz1, -1) * pow(opz, -1)
            )
            tmp += (
                ...
                + 6 * Li2(x) * pow(NC, -1) * pow(z, -1) * pow(omz, -1) * pow(opx, -1)
                - 6 * Li2(x) * pow(NC, -1) * pow(z, -1) * pow(opx, -1)
                - 1.0 / 4.0 * Li2(x) * pow(NC, -1) * pow(z, -1)
                ...
                + 4 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * pow(omz, -1)
                - 2 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * pow(opx, -1)
                - 7.0 / 2.0 * Li2(x) * pow(NC, -1) * x * pow(z, -1)
            ...
            tmp += (
                ...
                - 2 * Li2(x) * pow(NC, -1) * x * z * pow(opx, -1)
                + 2 * Li2(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(omz, -1)
                - 3 * Li2(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                ...
                - 2 * Li2(x) * NC * pow(x, -1) * z
                + 4 * Li2(x) * NC * pow(z, -1) * pow(opx, -1)
                - 7.0 / 4.0 * Li2(x) * NC * pow(z, -1)
                - 2 * Li2(x) * NC * pow(opx, -1)
                + 3.0 / 2.0 * Li2(x) * NC
                + 4 * Li2(x) * NC * z * pow(opx, -1)
                - 3.0 / 2.0 * Li2(x) * NC * z
                + 2 * Li2(x) * NC * x * pow(z, -1) * pow(opx, -1)
                - 1.0 / 2.0 * Li2(x) * NC * x * pow(z, -1)
                - 2 * Li2(x) * NC * x * pow(opx, -1)
                + Li2(x) * NC * x
                + 2 * Li2(x) * NC * x * z * pow(opx, -1)
                + Li2(x) * NC * pow(x, 2) * pow(z, -1)
