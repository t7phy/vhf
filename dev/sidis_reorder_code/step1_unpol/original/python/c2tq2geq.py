...
def C2Tq2gEq_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    ...
    if cx == "D" and cz == "R":
        ...
        opz = 1.0 + z
        res = (
            -5 * pow(NC, -1) * pow(z, -1) * zeta3 * CF
            - 1.0 / 4.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF
            + 3 * pow(NC, -1) * CF
            + 3 * pow(NC, -1) * zeta3 * CF
            + 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF
            + 13.0 / 8.0 * pow(NC, -1) * z * CF
            - 3.0 / 2.0 * pow(NC, -1) * z * zeta3 * CF
            - 1.0 / 8.0 * pow(NC, -1) * z * pow(pi, 2) * CF
            + 1169.0 / 54.0 * NC * pow(z, -1) * CF
            - 14 * NC * pow(z, -1) * zeta3 * CF
            + 4.0 / 3.0 * NC * pow(z, -1) * pow(rln2, 3) * CF
            - 1.0 / 4.0 * NC * pow(z, -1) * pow(pi, 2) * CF
            - 2.0 / 3.0 * NC * pow(z, -1) * pow(pi, 2) * rln2 * CF
            - 295.0 / 18.0 * NC * CF
            + 4.0 / 3.0 * NC * pow(rln2, 3) * CF
            - 5.0 / 3.0 * NC * pow(pi, 2) * CF
            - 2.0 / 3.0 * NC * pow(pi, 2) * rln2 * CF
            - 389.0 / 72.0 * NC * z * CF
            - 12 * NC * z * zeta3 * CF
            + 2.0 / 3.0 * NC * z * pow(rln2, 3) * CF
            + 7.0 / 24.0 * NC * z * pow(pi, 2) * CF
            - 1.0 / 3.0 * NC * z * pow(pi, 2) * rln2 * CF
            - 269.0 / 54.0 * NC * pow(z, 2) * CF
            + 11.0 / 6.0 * LMUR * NC * z * CF
            - 1.0 / 3.0 * LMUR * NF * z * CF
            - 1.0 / 3.0 * LMUF * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF
        ...
        res += (
            ...
            - 55.0 / 12.0 * ln(z) * LMUA * NC * z * CF
            - 4.0 / 3.0 * ln(z) * LMUA * NC * pow(z, 2) * CF
            + 2.0 / 3.0 * ln(z) * LMUA * NF * pow(z, -1) * CF
            - 2.0 / 3.0 * ln(z) * LMUA * NF * CF
            + 1.0 / 3.0 * ln(z) * LMUA * NF * z * CF
            - 1.0 / 2.0 * ln(z) * pow(LMUA, 2) * pow(NC, -1) * CF
            + 1.0 / 4.0 * ln(z) * pow(LMUA, 2) * pow(NC, -1) * z * CF
            - 2 * ln(z) * pow(LMUA, 2) * NC * pow(z, -1) * CF
            - 3.0 / 2.0 * ln(z) * pow(LMUA, 2) * NC * CF
            - 9.0 / 4.0 * ln(z) * pow(LMUA, 2) * NC * z * CF
            + ln(z) * ln(1 + z) * NC * z * CF
            - 4 * ln(z) * ln(1 + z) * LMUA * NC * pow(z, -1) * CF
            - 4 * ln(z) * ln(1 + z) * LMUA * NC * CF
            - 2 * ln(z) * ln(1 + z) * LMUA * NC * z * CF
            + pow(ln(z), 2) * pow(NC, -1) * CF
            - 13.0 / 16.0 * pow(ln(z), 2) * pow(NC, -1) * z * CF
            - 20.0 / 3.0 * pow(ln(z), 2) * NC * pow(z, -1) * CF
            - 5 * pow(ln(z), 2) * NC * CF
            - 7.0 / 16.0 * pow(ln(z), 2) * NC * z * CF
        ...
        res += (
            -10.0 / 3.0 * pow(ln(z), 3) * NC * pow(z, -1) * CF
            - 5.0 / 4.0 * pow(ln(z), 3) * NC * CF
            - 65.0 / 24.0 * pow(ln(z), 3) * NC * z * CF
            + 2 * pow(ln(z), 2) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
            - 2 * pow(ln(z), 2) * ln(omz) * pow(NC, -1) * CF
            + pow(ln(z), 2) * ln(omz) * pow(NC, -1) * z * CF
            + pow(ln(z), 2) * ln(omz) * NC * pow(z, -1) * CF
            - pow(ln(z), 2) * ln(omz) * NC * CF
            + 1.0 / 2.0 * pow(ln(z), 2) * ln(omz) * NC * z * CF
            + 3 * ln(z) * ln(omz) * NC * z * CF
            - 2 * ln(z) * ln(omz) * LMUA * pow(NC, -1) * pow(z, -1) * CF
            + 2 * ln(z) * ln(omz) * LMUA * pow(NC, -1) * CF
            - ln(z) * ln(omz) * LMUA * pow(NC, -1) * z * CF
            - 6 * ln(z) * ln(omz) * LMUA * NC * pow(z, -1) * CF
            + 6 * ln(z) * ln(omz) * LMUA * NC * CF
            - 3 * ln(z) * ln(omz) * LMUA * NC * z * CF
            ...
            - 3.0 / 2.0 * ln(z) * pow(ln(omz), 2) * pow(NC, -1) * CF
            ...
            - 6 * ln(z) * Li2(z) * pow(NC, -1) * CF
            + 3 * ln(z) * Li2(z) * pow(NC, -1) * z * CF
            - 4 * ln(z) * Li2(z) * NC * pow(z, -1) * CF
            + 4 * ln(z) * Li2(z) * NC * CF
            - 2 * ln(z) * Li2(z) * NC * z * CF
            + 9.0 / 2.0 * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
            + 1.0 / 3.0 * ln(omz) * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF
            - 9.0 / 2.0 * ln(omz) * pow(NC, -1) * CF
            - 1.0 / 2.0 * ln(omz) * pow(NC, -1) * pow(pi, 2) * CF
            + 5.0 / 2.0 * ln(omz) * pow(NC, -1) * z * CF
        )
        res += (
            +1.0 / 4.0 * ln(omz) * pow(NC, -1) * z * pow(pi, 2) * CF
            - 55.0 / 18.0 * ln(omz) * NC * pow(z, -1) * CF
            - 2 * ln(omz) * NC * pow(z, -1) * pow(rln2, 2) * CF
            - ln(omz) * NC * pow(z, -1) * pow(pi, 2) * CF
            + 23.0 / 3.0 * ln(omz) * NC * CF
            - 2 * ln(omz) * NC * pow(rln2, 2) * CF
            + 1.0 / 2.0 * ln(omz) * NC * pow(pi, 2) * CF
            - 31.0 / 6.0 * ln(omz) * NC * z * CF
            - ln(omz) * NC * z * pow(rln2, 2) * CF
            - 11.0 / 12.0 * ln(omz) * NC * z * pow(pi, 2) * CF
            - 13.0 / 9.0 * ln(omz) * NC * pow(z, 2) * CF
            + 11.0 / 3.0 * ln(omz) * LMUR * NC * pow(z, -1) * CF
            - 11.0 / 3.0 * ln(omz) * LMUR * NC * CF
            + 11.0 / 6.0 * ln(omz) * LMUR * NC * z * CF
            - 2.0 / 3.0 * ln(omz) * LMUR * NF * pow(z, -1) * CF
            + 2.0 / 3.0 * ln(omz) * LMUR * NF * CF
            - 1.0 / 3.0 * ln(omz) * LMUR * NF * z * CF
            + 3.0 / 2.0 * ln(omz) * LMUF * pow(NC, -1) * pow(z, -1) * CF
            - 3.0 / 2.0 * ln(omz) * LMUF * pow(NC, -1) * CF
            + 3.0 / 4.0 * ln(omz) * LMUF * pow(NC, -1) * z * CF
            - 3.0 / 2.0 * ln(omz) * LMUF * NC * pow(z, -1) * CF
            + 3.0 / 2.0 * ln(omz) * LMUF * NC * CF
            - 3.0 / 4.0 * ln(omz) * LMUF * NC * z * CF
            - 3.0 / 2.0 * ln(omz) * LMUA * pow(NC, -1) * pow(z, -1) * CF
            + 5.0 / 2.0 * ln(omz) * LMUA * pow(NC, -1) * CF
            + 49.0 / 6.0 * ln(omz) * LMUA * NC * pow(z, -1) * CF
            - 41.0 / 6.0 * ln(omz) * LMUA * NC * CF
            - 17.0 / 6.0 * ln(omz) * LMUA * NC * z * CF
            - 4.0 / 3.0 * ln(omz) * LMUA * NC * pow(z, 2) * CF
            + 2.0 / 3.0 * ln(omz) * LMUA * NF * pow(z, -1) * CF
            - 2.0 / 3.0 * ln(omz) * LMUA * NF * CF
            + 1.0 / 3.0 * ln(omz) * LMUA * NF * z * CF
            - ln(omz) * pow(LMUA, 2) * pow(NC, -1) * pow(z, -1) * CF
            + ln(omz) * pow(LMUA, 2) * pow(NC, -1) * CF
            - 1.0 / 2.0 * ln(omz) * pow(LMUA, 2) * pow(NC, -1) * z * CF
            + 3 * ln(omz) * pow(LMUA, 2) * NC * pow(z, -1) * CF
            - 3 * ln(omz) * pow(LMUA, 2) * NC * CF
            + 3.0 / 2.0 * ln(omz) * pow(LMUA, 2) * NC * z * CF
            + 4 * ln(omz) * ln(1 + z) * NC * pow(z, -1) * rln2 * CF
            + 4 * ln(omz) * ln(1 + z) * NC * rln2 * CF
            + 2 * ln(omz) * ln(1 + z) * NC * z * rln2 * CF
        )
        res += (
            -2 * ln(omz) * pow(ln(1 + z), 2) * NC * pow(z, -1) * CF
            - 2 * ln(omz) * pow(ln(1 + z), 2) * NC * CF
            - ln(omz) * pow(ln(1 + z), 2) * NC * z * CF
            + 3.0 / 2.0 * pow(ln(omz), 2) * pow(NC, -1) * pow(z, -1) * CF
            - 2 * pow(ln(omz), 2) * pow(NC, -1) * CF
            + 1.0 / 8.0 * pow(ln(omz), 2) * pow(NC, -1) * z * CF
            - 20.0 / 3.0 * pow(ln(omz), 2) * NC * pow(z, -1) * CF
            + 6 * pow(ln(omz), 2) * NC * CF
            - 1.0 / 8.0 * pow(ln(omz), 2) * NC * z * CF
            + 2.0 / 3.0 * pow(ln(omz), 2) * NC * pow(z, 2) * CF
            + 2 * pow(ln(omz), 2) * LMUA * pow(NC, -1) * pow(z, -1) * CF
            - 2 * pow(ln(omz), 2) * LMUA * pow(NC, -1) * CF
            + pow(ln(omz), 2) * LMUA * pow(NC, -1) * z * CF
            - 4 * pow(ln(omz), 2) * LMUA * NC * pow(z, -1) * CF
            + 4 * pow(ln(omz), 2) * LMUA * NC * CF
            - 2 * pow(ln(omz), 2) * LMUA * NC * z * CF
            - 5.0 / 6.0 * pow(ln(omz), 3) * pow(NC, -1) * pow(z, -1) * CF
            + 5.0 / 6.0 * pow(ln(omz), 3) * pow(NC, -1) * CF
            - 5.0 / 12.0 * pow(ln(omz), 3) * pow(NC, -1) * z * CF
            + 7.0 / 6.0 * pow(ln(omz), 3) * NC * pow(z, -1) * CF
            - 7.0 / 6.0 * pow(ln(omz), 3) * NC * CF
            ...
            - 4 * Li3(1.0 / 2.0 - 1.0 / 2.0 * z) * NC * pow(z, -1) * CF
            - 4 * Li3(1.0 / 2.0 - 1.0 / 2.0 * z) * NC * CF
            - 2 * Li3(1.0 / 2.0 - 1.0 / 2.0 * z) * NC * z * CF
            - 4 * Li3(1.0 / 2.0 + 1.0 / 2.0 * z) * NC * pow(z, -1) * CF
            - 4 * Li3(1.0 / 2.0 + 1.0 / 2.0 * z) * NC * CF
        )
        res += (
            ...
            + 4 * Li3(1 / (1 + z)) * NC * CF
            + 2 * Li3(1 / (1 + z)) * NC * z * CF
            - 4 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * NC * pow(z, -1) * CF
            - 4 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * NC * CF
            - 2 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * NC * z * CF
            - 6 * Li3(z) * pow(NC, -1) * pow(z, -1) * CF
            + 8 * Li3(z) * pow(NC, -1) * CF
            - 4 * Li3(z) * pow(NC, -1) * z * CF
            + 20 * Li3(z) * NC * pow(z, -1) * CF
            - 2 * Li3(z) * NC * CF
            + 15 * Li3(z) * NC * z * CF
            + Li2(-z) * NC * z * CF
            - 4 * Li2(-z) * LMUA * NC * pow(z, -1) * CF
            - 4 * Li2(-z) * LMUA * NC * CF
            - 2 * Li2(-z) * LMUA * NC * z * CF
            - 3.0 / 2.0 * Li2(z) * pow(NC, -1) * pow(z, -1) * CF
            + Li2(z) * pow(NC, -1) * z * CF
            + 89.0 / 6.0 * Li2(z) * NC * pow(z, -1) * CF
            - 2 * Li2(z) * NC * CF
            + Li2(z) * NC * z * CF
            - 4.0 / 3.0 * Li2(z) * NC * pow(z, 2) * CF
            - 6 * Li2(z) * LMUA * pow(NC, -1) * pow(z, -1) * CF
            + 5 * Li2(z) * LMUA * pow(NC, -1) * CF
            - 5.0 / 2.0 * Li2(z) * LMUA * pow(NC, -1) * z * CF
            - 6 * Li2(z) * LMUA * NC * pow(z, -1) * CF
            - Li2(z) * LMUA * NC * CF
            - 11.0 / 2.0 * Li2(z) * LMUA * NC * z * CF
        )
    ...
    if cx == "0" and cz == "R":
        ...
        res = (
            ...
            - 17.0 / 4.0 * pow(NC, -1) * CF
            - 5.0 / 6.0 * pow(NC, -1) * pow(pi, 2) * CF
            + 5.0 / 2.0 * pow(NC, -1) * z * CF
            + 5.0 / 12.0 * pow(NC, -1) * z * pow(pi, 2) * CF
            - 55.0 / 18.0 * NC * pow(z, -1) * CF
            - 2.0 / 3.0 * NC * pow(z, -1) * pow(pi, 2) * CF
            + 95.0 / 12.0 * NC * CF
            + 1.0 / 6.0 * NC * pow(pi, 2) * CF
            - 31.0 / 6.0 * NC * z * CF
            - 3.0 / 4.0 * NC * z * pow(pi, 2) * CF
            - 13.0 / 9.0 * NC * pow(z, 2) * CF
            + 11.0 / 3.0 * LMUR * NC * pow(z, -1) * CF
            - 11.0 / 3.0 * LMUR * NC * CF
            + 11.0 / 6.0 * LMUR * NC * z * CF
            - 2.0 / 3.0 * LMUR * NF * pow(z, -1) * CF
            + 2.0 / 3.0 * LMUR * NF * CF
            - 1.0 / 3.0 * LMUR * NF * z * CF
            + 3.0 / 2.0 * LMUF * pow(NC, -1) * pow(z, -1) * CF
            - 3.0 / 2.0 * LMUF * pow(NC, -1) * CF
            + 7.0 / 4.0 * LMUF * pow(NC, -1) * z * CF
            - 3.0 / 2.0 * LMUF * NC * pow(z, -1) * CF
            + 3.0 / 2.0 * LMUF * NC * CF
            - 7.0 / 4.0 * LMUF * NC * z * CF
            - 3.0 / 2.0 * LMUA * pow(NC, -1) * pow(z, -1) * CF
            + 5.0 / 2.0 * LMUA * pow(NC, -1) * CF
            - LMUA * pow(NC, -1) * z * CF
            + 49.0 / 6.0 * LMUA * NC * pow(z, -1) * CF
            - 41.0 / 6.0 * LMUA * NC * CF
            - 11.0 / 6.0 * LMUA * NC * z * CF
            - 4.0 / 3.0 * LMUA * NC * pow(z, 2) * CF
            + 2.0 / 3.0 * LMUA * NF * pow(z, -1) * CF
            - 2.0 / 3.0 * LMUA * NF * CF
            + 1.0 / 3.0 * LMUA * NF * z * CF
            - 2 * LMUA * LMUF * pow(NC, -1) * pow(z, -1) * CF
            + 2 * LMUA * LMUF * pow(NC, -1) * CF
            - LMUA * LMUF * pow(NC, -1) * z * CF
            + 2 * LMUA * LMUF * NC * pow(z, -1) * CF
            - 2 * LMUA * LMUF * NC * CF
            + LMUA * LMUF * NC * z * CF
            + 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(z, -1) * CF
            - 89.0 / 6.0 * ln(z) * NC * pow(z, -1) * CF
            + 2 * ln(z) * NC * CF
            + 2 * ln(z) * NC * z * CF
            + 4.0 / 3.0 * ln(z) * NC * pow(z, 2) * CF
            + 2 * ln(z) * LMUF * pow(NC, -1) * pow(z, -1) * CF
            - 2 * ln(z) * LMUF * pow(NC, -1) * CF
            + ln(z) * LMUF * pow(NC, -1) * z * CF
            - 2 * ln(z) * LMUF * NC * pow(z, -1) * CF
            + 2 * ln(z) * LMUF * NC * CF
            - ln(z) * LMUF * NC * z * CF
        ...
        res += (
            ...
            - 6 * pow(ln(z), 2) * NC * pow(z, -1) * CF
            - 3 * pow(ln(z), 2) * NC * CF
            - 11.0 / 2.0 * pow(ln(z), 2) * NC * z * CF
            + 2 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
            - 2 * ln(z) * ln(omz) * pow(NC, -1) * CF
            ...
            - 40.0 / 3.0 * ln(omz) * NC * pow(z, -1) * CF
            + 12 * ln(omz) * NC * CF
            + 1.0 / 4.0 * ln(omz) * NC * z * CF
            + 4.0 / 3.0 * ln(omz) * NC * pow(z, 2) * CF
            + 2 * ln(omz) * LMUF * pow(NC, -1) * pow(z, -1) * CF
            - 2 * ln(omz) * LMUF * pow(NC, -1) * CF
            + ln(omz) * LMUF * pow(NC, -1) * z * CF
            - 2 * ln(omz) * LMUF * NC * pow(z, -1) * CF
            + 2 * ln(omz) * LMUF * NC * CF
            - ln(omz) * LMUF * NC * z * CF
            + 2 * ln(omz) * LMUA * pow(NC, -1) * pow(z, -1) * CF
            - 2 * ln(omz) * LMUA * pow(NC, -1) * CF
            + ln(omz) * LMUA * pow(NC, -1) * z * CF
            - 6 * ln(omz) * LMUA * NC * pow(z, -1) * CF
            + 6 * ln(omz) * LMUA * NC * CF
            - 3 * ln(omz) * LMUA * NC * z * CF
            - 2 * pow(ln(omz), 2) * pow(NC, -1) * pow(z, -1) * CF
            + 2 * pow(ln(omz), 2) * pow(NC, -1) * CF
            - pow(ln(omz), 2) * pow(NC, -1) * z * CF
        ...
        res += +6 * Li2(z) * pow(NC, -1) * pow(z, -1) * CF - 5 * Li2(z) * pow(NC, -1) * CF + 5.0 / 2.0 * Li2(z) * pow(NC, -1) * z * CF + 6 * Li2(z) * NC * pow(z, -1) * CF + Li2(z) * NC * CF + 11.0 / 2.0 * Li2(z) * NC * z * CF
    ...
    if cx == "1" and cz == "R":
        ...
        res = (
            ...
            - 40.0 / 3.0 * NC * pow(z, -1) * CF
            + 12 * NC * CF
            + 1.0 / 4.0 * NC * z * CF
            + 4.0 / 3.0 * NC * pow(z, 2) * CF
            + 4 * LMUF * pow(NC, -1) * pow(z, -1) * CF
            - 4 * LMUF * pow(NC, -1) * CF
            + 2 * LMUF * pow(NC, -1) * z * CF
            - 4 * LMUF * NC * pow(z, -1) * CF
            + 4 * LMUF * NC * CF
            - 2 * LMUF * NC * z * CF
            + 2 * LMUA * pow(NC, -1) * pow(z, -1) * CF
            - 2 * LMUA * pow(NC, -1) * CF
            + LMUA * pow(NC, -1) * z * CF
            - 2 * LMUA * NC * pow(z, -1) * CF
            + 2 * LMUA * NC * CF
            - LMUA * NC * z * CF
            - 2 * ln(z) * pow(NC, -1) * pow(z, -1) * CF
            + ln(z) * pow(NC, -1) * CF
            - 1.0 / 2.0 * ln(z) * pow(NC, -1) * z * CF
            - 2 * ln(z) * NC * pow(z, -1) * CF
            - 5 * ln(z) * NC * CF
            - 7.0 / 2.0 * ln(z) * NC * z * CF
            - 4 * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
            + 4 * ln(omz) * pow(NC, -1) * CF
    ...
    if cx == "2" and cz == "R":
        ...
        omz = 1.0 - z
        opz = 1.0 + z
        res = -3 * pow(NC, -1) * pow(z, -1) * CF + 3 * pow(NC, -1) * CF - 3.0 / 2.0 * pow(NC, -1) * z * CF + 3 * NC * pow(z, -1) * CF - 3 * NC * CF + 3.0 / 2.0 * NC * z * CF
    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            tmp = (
                ...
                - 5.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(omx, -1)
                ...
                - 12 * ln(x) * pow(NC, -1) * x * CF
                + 12 * ln(x) * pow(NC, -1) * x * z * CF
                + 13 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 3 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF
                - 19 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(omx, -1)
                ...
                - 13 * ln(x) * ln(z) * pow(NC, -1) * z * CF * pow(omx, -1)
                + 11 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                - 22 * ln(x) * ln(z) * pow(NC, -1) * x * CF
            ...
            tmp += (
                ...
                - 32 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                + 20 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                - 22 * ln(x) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
            ...
            tmp += (
                -6 * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                + 6 * ln(z) * pow(NC, -1) * x * CF
                - 6 * ln(z) * pow(NC, -1) * x * z * CF
                + 5 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 2 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF
                - 9 * pow(ln(z), 2) * pow(NC, -1) * CF * pow(omx, -1)
            ...
            tmp += (
                ...
                - 2 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * CF
                + 2 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF
                - 2 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                ...
                - Li2(z * pow(omx, -1)) * pow(NC, -1) * pow(z, -1) * CF
            )
            tmp += (
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            tmp = (
                ...
                - 4 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * z * CF
                + 13 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 7.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF
                - 20 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(omx, -1)
                + 7 * pow(ln(x), 2) * pow(NC, -1) * CF
                + 10 * pow(ln(x), 2) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 19.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                + 19 * pow(ln(x), 2) * pow(NC, -1) * x * CF
                - 13 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF
                - 20 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
            )
            tmp += (
                ...
                - 28 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                + 20 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                - 16 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
            ...
            tmp += (
                ...
                - 5 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
                - 26 * ln(z) * ln(omz) * pow(NC, -1) * CF * pow(omx, -1)
                + 10 * ln(z) * ln(omz) * pow(NC, -1) * CF
                + 13 * ln(z) * ln(omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 11 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                + 22 * ln(z) * ln(omz) * pow(NC, -1) * x * CF
                - 16 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF
                - 2 * ln(z) * ln(xmz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + ln(z) * ln(xmz) * pow(NC, -1) * pow(z, -1) * CF
                + 4 * ln(z) * ln(xmz) * pow(NC, -1) * CF * pow(omx, -1)
                - 2 * ln(z) * ln(xmz) * pow(NC, -1) * CF
            ...
            tmp += (
                ...
                - 6 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                + 12 * pow(ln(omz), 2) * pow(NC, -1) * x * CF
                - 8 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF
                - 2 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + 2 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * CF * pow(omx, -1)
                - Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                + 2 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * CF
                ...
                - Li2(pow(z, -1) * omx) * pow(NC, -1) * z * CF * pow(omx, -1)
                - Li2(pow(z, -1) * omx) * pow(NC, -1) * x * pow(z, -1) * CF
            ...
            tmp += (
                ...
                - Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * pow(z, -1) * CF
                - 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * CF * pow(omx, -1)
                + 2 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * CF
                + 2 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * z * CF * pow(omx, -1)
                - Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            tmp = (
                ...
                - 7.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF
                - 21 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(omx, -1)
                + 7 * pow(ln(x), 2) * pow(NC, -1) * CF
                + 21.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 21.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                + 21 * pow(ln(x), 2) * pow(NC, -1) * x * CF
                - 14 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF
                - 18 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
            )
            tmp += (
                +6 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF
                ...
                - 18 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + 3 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF
                ...
                - 12 * ln(x) * ln(omz) * pow(NC, -1) * CF
                - 18 * ln(x) * ln(omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                + 18 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 36 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
            ...
            tmp += (
                ...
                - 3.0 / 2.0 * pow(ln(omx), 2) * pow(NC, -1) * pow(z, -1) * CF
                - 10 * pow(ln(omx), 2) * pow(NC, -1) * CF * pow(omx, -1)
                + 3 * pow(ln(omx), 2) * pow(NC, -1) * CF
                + 5 * pow(ln(omx), 2) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 11.0 / 2.0 * pow(ln(omx), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                + 11 * pow(ln(omx), 2) * pow(NC, -1) * x * CF
                - 7 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF
                + 12 * ln(omx) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - ln(omx) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
                - 14 * ln(omx) * ln(omz) * pow(NC, -1) * CF * pow(omx, -1)
            ...
            tmp += (
                ...
                - Li2(pow(omx, -1) * omz) * pow(NC, -1) * pow(z, -1) * CF
                - 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * CF * pow(omx, -1)
                + 2 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * CF
                + 2 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                - Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * pow(z, -1) * CF
                + 2 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * CF
                - 2 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF
                - Li2(z * pow(omx, -1)) * pow(NC, -1) * pow(z, -1) * CF
                - 2 * Li2(z * pow(omx, -1)) * pow(NC, -1) * CF * pow(omx, -1)
                + 2 * Li2(z * pow(omx, -1)) * pow(NC, -1) * CF
                + Li2(z * pow(omx, -1)) * pow(NC, -1) * z * CF * pow(omx, -1)
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            tmp += (
                -3 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF
                - 18 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(omx, -1)
                + 6 * pow(ln(x), 2) * pow(NC, -1) * CF
                + 9 * pow(ln(x), 2) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 9 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                - 10 * ln(x) * ln(z) * pow(NC, -1) * CF
                - 14 * ln(x) * ln(z) * pow(NC, -1) * z * CF * pow(omx, -1)
                + 13 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                - 26 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                + 18 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                - 18 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF
            ...
            tmp += (
                ...
                - 10 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF
                + 14 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 4 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
                - 22 * ln(z) * ln(omz) * pow(NC, -1) * CF * pow(omx, -1)
                + 8 * ln(z) * ln(omz) * pow(NC, -1) * CF
                + 11 * ln(z) * ln(omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 10 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
            )
            tmp += (
        ...
        if round(z, ndecimals) > round(x, ndecimals):
            ...
            tmp = (
                ...
                - 1.0 / 2.0 * NC * pow(z, -1) * pow(pi, 2) * CF
                + 3 * NC * CF
                - NC * pow(pi, 2) * CF * pow(omx, -1)
                + NC * pow(pi, 2) * CF
                - NC * z * CF * pow(omx, -1)
                + 1.0 / 2.0 * NC * z * pow(pi, 2) * CF * pow(omx, -1)
                + NC * x * pow(z, -1) * CF
                - 1.0 / 2.0 * NC * x * pow(z, -1) * pow(pi, 2) * CF
                + NC * x * pow(pi, 2) * CF
                - NC * x * z * pow(pi, 2) * CF
                + 6 * ln(x) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 6 * ln(x) * NC * CF * pow(omx, -1)
                + 9 * ln(x) * NC * CF
                + 6 * ln(x) * NC * z * CF * pow(omx, -1)
                - 6 * ln(x) * NC * x * pow(z, -1) * CF
                - 6 * ln(x) * NC * x * z * CF
                - 2 * ln(x) * ln(-xmz) * NC * pow(z, -1) * CF * pow(omx, -1)
                + ln(x) * ln(-xmz) * NC * pow(z, -1) * CF
                + 2 * ln(x) * ln(-xmz) * NC * CF * pow(omx, -1)
                - 2 * ln(x) * ln(-xmz) * NC * CF
                - ln(x) * ln(-xmz) * NC * z * CF * pow(omx, -1)
                + ln(x) * ln(-xmz) * NC * x * pow(z, -1) * CF
                - 2 * ln(x) * ln(-xmz) * NC * x * CF
                + 2 * ln(x) * ln(-xmz) * NC * x * z * CF
                - 7 * pow(ln(x), 2) * NC * pow(z, -1) * CF * pow(omx, -1)
        ...
        if round(z, ndecimals) < round(x, ndecimals):
            ...
            tmp += (
                ...
                + 4 * ln(z) * NC * x * pow(z, -1) * CF
                + 4 * ln(z) * NC * x * z * CF
                - 4 * pow(ln(z), 2) * NC * pow(z, -1) * CF * pow(omx, -1)
                + 2 * pow(ln(z), 2) * NC * pow(z, -1) * CF
                + 4 * pow(ln(z), 2) * NC * CF * pow(omx, -1)
                - 4 * pow(ln(z), 2) * NC * CF
                - 2 * pow(ln(z), 2) * NC * z * CF * pow(omx, -1)
                + 2 * pow(ln(z), 2) * NC * x * pow(z, -1) * CF
                - 4 * pow(ln(z), 2) * NC * x * CF
            ...
            tmp += (
                ...
                - Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * pow(z, -1) * CF
                - 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * CF * pow(omx, -1)
                + 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * CF
                + Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * z * CF * pow(omx, -1)
                - Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * x * pow(z, -1) * CF
                + 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * x * CF
                - 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * x * z * CF
                - 2 * Li2(omx * pow(omz, -1)) * NC * pow(z, -1) * CF * pow(omx, -1)
                + Li2(omx * pow(omz, -1)) * NC * pow(z, -1) * CF
                + 2 * Li2(omx * pow(omz, -1)) * NC * CF * pow(omx, -1)
                - 2 * Li2(omx * pow(omz, -1)) * NC * CF
                - Li2(omx * pow(omz, -1)) * NC * z * CF * pow(omx, -1)
                + Li2(omx * pow(omz, -1)) * NC * x * pow(z, -1) * CF
                - 2 * Li2(omx * pow(omz, -1)) * NC * x * CF
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            tmp = (
                ...
                - 13.0 / 12.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF
                + 41.0 / 4.0 * pow(NC, -1) * CF
                + 4 * pow(NC, -1) * pow(rln2, 2) * CF * pow(omx, -1)
                + 2 * pow(NC, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1)
                - 10.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF * pow(omx, -1)
                + 7.0 / 6.0 * pow(NC, -1) * pow(pi, 2) * CF
                - 4 * pow(NC, -1) * z * CF * pow(omx, -1)
                - 1.0 / 2.0 * pow(NC, -1) * z * CF
                - 2 * pow(NC, -1) * z * pow(rln2, 2) * CF * pow(omx, -1)
                ...
                - 29.0 / 12.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF
                - 2 * pow(NC, -1) * x * CF * pow(omxmz, -1)
                + 23.0 / 4.0 * pow(NC, -1) * x * CF
                + 2 * pow(NC, -1) * x * sqrtxz1 * rln2 * CF
                + 25.0 / 6.0 * pow(NC, -1) * x * pow(pi, 2) * CF
                - 11.0 / 2.0 * pow(NC, -1) * x * z * CF
                - 5.0 / 2.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF
                + 2 * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -1)
                - 2 * pow(NC, -1) * pow(x, 2) * CF
                - 2 * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -1)
                + 215.0 / 18.0 * NC * pow(z, -1) * CF
                - 2 * NC * pow(z, -1) * pow(pi, 2) * CF * pow(omx, -1)
                + 17.0 / 12.0 * NC * pow(z, -1) * pow(pi, 2) * CF
                - 163.0 / 12.0 * NC * CF
                - 8 * NC * pow(rln2, 2) * CF * pow(omx, -1)
                + 4 * NC * pow(rln2, 2) * CF
                - 4 * NC * sqrtxz1 * rln2 * CF * pow(omx, -1)
                + 4.0 / 3.0 * NC * pow(pi, 2) * CF * pow(omx, -1)
            )
            tmp += (
                -1.0 / 2.0 * NC * pow(pi, 2) * CF
                + NC * z * CF * pow(omx, -1)
                + 4.0 / 3.0 * NC * z * CF
                - NC * z * pow(pi, 2) * CF * pow(omx, -1)
                + 1.0 / 6.0 * NC * z * pow(pi, 2) * CF
                - 31.0 / 9.0 * NC * pow(z, 2) * CF
                - 43.0 / 18.0 * NC * x * pow(z, -1) * CF
                + 17.0 / 12.0 * NC * x * pow(z, -1) * pow(pi, 2) * CF
                - 37.0 / 12.0 * NC * x * CF
                + 4 * NC * x * pow(rln2, 2) * CF
                + 4 * NC * x * sqrtxz1 * rln2 * CF
                - 5.0 / 6.0 * NC * x * pow(pi, 2) * CF
                + 1.0 / 3.0 * NC * x * z * CF
                + 4 * NC * x * z * pow(rln2, 2) * CF
                + 5.0 / 2.0 * NC * x * z * pow(pi, 2) * CF
                + 53.0 / 9.0 * NC * x * pow(z, 2) * CF
                - 11.0 / 6.0 * LMUR * NC * pow(z, -1) * CF
                + 11.0 / 3.0 * LMUR * NC * CF
                - 11.0 / 6.0 * LMUR * NC * x * pow(z, -1) * CF
                + 11.0 / 3.0 * LMUR * NC * x * CF
                - 11.0 / 3.0 * LMUR * NC * x * z * CF
                + 1.0 / 3.0 * LMUR * NF * pow(z, -1) * CF
                - 2.0 / 3.0 * LMUR * NF * CF
                + 1.0 / 3.0 * LMUR * NF * x * pow(z, -1) * CF
                - 2.0 / 3.0 * LMUR * NF * x * CF
                + 2.0 / 3.0 * LMUR * NF * x * z * CF
                - 7.0 / 4.0 * LMUF * pow(NC, -1) * pow(z, -1) * CF
                ...
                - 5.0 / 2.0 * LMUF * NC * CF
                + 2 * LMUF * NC * z * CF
                - 1.0 / 4.0 * LMUF * NC * x * pow(z, -1) * CF
                - 1.0 / 2.0 * LMUF * NC * x * CF
                + 1.0 / 2.0 * LMUF * NC * x * z * CF
                + 3 * LMUA * pow(NC, -1) * pow(z, -1) * CF
                - 5.0 / 2.0 * LMUA * pow(NC, -1) * CF
                - 3.0 / 2.0 * LMUA * pow(NC, -1) * x * CF
                + LMUA * pow(NC, -1) * x * z * CF
                - 53.0 / 6.0 * LMUA * NC * pow(z, -1) * CF
                + 29.0 / 6.0 * LMUA * NC * CF
                + 3 * LMUA * NC * z * CF
                - 4.0 / 3.0 * LMUA * NC * pow(z, 2) * CF
                - 23.0 / 6.0 * LMUA * NC * x * pow(z, -1) * CF
                - 1.0 / 6.0 * LMUA * NC * x * CF
                + 11.0 / 3.0 * LMUA * NC * x * z * CF
                + 8.0 / 3.0 * LMUA * NC * x * pow(z, 2) * CF
                - 1.0 / 3.0 * LMUA * NF * pow(z, -1) * CF
                + 2.0 / 3.0 * LMUA * NF * CF
                - 1.0 / 3.0 * LMUA * NF * x * pow(z, -1) * CF
            )
            tmp += (
                +2.0 / 3.0 * LMUA * NF * x * CF
                - 2.0 / 3.0 * LMUA * NF * x * z * CF
            ...
            tmp += (
                ...
                - 6 * ln(x) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1)
                ...
                - 1.0 / 2.0 * ln(x) * pow(NC, -1) * z * CF
                - 3 * ln(x) * pow(NC, -1) * z * rln2 * CF * pow(omx, -1)
                - 43.0 / 4.0 * ln(x) * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                - 15.0 / 2.0 * ln(x) * pow(NC, -1) * x * z * CF
                - 2 * ln(x) * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -2)
                + 2 * ln(x) * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -1)
                + 2 * ln(x) * pow(NC, -1) * pow(x, 2) * CF
                + 2 * ln(x) * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -2)
                - 4 * ln(x) * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -1)
                - 2 * ln(x) * pow(NC, -1) * pow(x, 4) * CF * pow(omxmz, -2)
                + 35.0 / 3.0 * ln(x) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 163.0 / 12.0 * ln(x) * NC * pow(z, -1) * CF
                + 4 * ln(x) * NC * pow(z, -1) * rln2 * CF * pow(omx, -1)
                - 2 * ln(x) * NC * pow(z, -1) * rln2 * CF
                - 4 * ln(x) * NC * CF * pow(omx, -1)
                + ln(x) * NC * CF
                - 8 * ln(x) * NC * rln2 * CF * pow(omx, -1)
                + 2 * ln(x) * NC * rln2 * CF
                - 2 * ln(x) * NC * sqrtxz1 * CF * pow(omx, -1)
                - 51.0 / 4.0 * ln(x) * NC * z * CF * pow(omx, -1)
            )
            tmp += (
                +13.0 / 2.0 * ln(x) * NC * z * CF
                + 2 * ln(x) * NC * z * rln2 * CF * pow(omx, -1)
                - 8.0 / 3.0 * ln(x) * NC * pow(z, 2) * CF * pow(omx, -1)
                - 8.0 / 3.0 * ln(x) * NC * pow(z, 2) * CF
                - 67.0 / 12.0 * ln(x) * NC * x * pow(z, -1) * CF
                - 2 * ln(x) * NC * x * pow(z, -1) * rln2 * CF
                + 5 * ln(x) * NC * x * CF
                + 2 * ln(x) * NC * x * rln2 * CF
            ...
            tmp += (
                -19 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                - 16 * ln(x) * ln(omx) * NC * pow(z, -1) * CF * pow(omx, -1)
                + 8 * ln(x) * ln(omx) * NC * pow(z, -1) * CF
                + 16 * ln(x) * ln(omx) * NC * CF * pow(omx, -1)
                - 16 * ln(x) * ln(omx) * NC * CF
                - 8 * ln(x) * ln(omx) * NC * z * CF * pow(omx, -1)
                + ln(x) * ln(omx) * NC * z * CF
                + 8 * ln(x) * ln(omx) * NC * x * pow(z, -1) * CF
                - 16 * ln(x) * ln(omx) * NC * x * CF
                + 15 * ln(x) * ln(omx) * NC * x * z * CF
                + 24 * ln(x) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 15.0 / 2.0 * ln(x) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
                - 34 * ln(x) * ln(omz) * pow(NC, -1) * CF * pow(omx, -1)
                + 13 * ln(x) * ln(omz) * pow(NC, -1) * CF
                + 17 * ln(x) * ln(omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                - ln(x) * ln(omz) * pow(NC, -1) * z * CF
                - 35.0 / 2.0 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                + 33 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
                - 22 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF
                - 14 * ln(x) * ln(omz) * NC * pow(z, -1) * CF * pow(omx, -1)
                + 15.0 / 2.0 * ln(x) * ln(omz) * NC * pow(z, -1) * CF
                + 14 * ln(x) * ln(omz) * NC * CF * pow(omx, -1)
                - 13 * ln(x) * ln(omz) * NC * CF
                - 7 * ln(x) * ln(omz) * NC * z * CF * pow(omx, -1)
                + ln(x) * ln(omz) * NC * z * CF
                + 15.0 / 2.0 * ln(x) * ln(omz) * NC * x * pow(z, -1) * CF
                - 13 * ln(x) * ln(omz) * NC * x * CF
                + 12 * ln(x) * ln(omz) * NC * x * z * CF
                - 3 * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 5 * ln(z) * pow(NC, -1) * pow(z, -1) * CF
                - 2 * ln(z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1)
            ...
            tmp += (
                ...
                - 7 * ln(z) * pow(NC, -1) * z * CF * pow(omx, -1)
                - ln(z) * pow(NC, -1) * z * CF
                - ln(z) * pow(NC, -1) * z * rln2 * CF * pow(omx, -1)
                + 5 * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                + ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                + ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                - 7 * ln(z) * pow(NC, -1) * x * CF
                + ln(z) * pow(NC, -1) * x * sqrtxz1 * CF
                + 9 * ln(z) * pow(NC, -1) * x * z * CF
                + 4 * ln(z) * NC * pow(z, -1) * CF * pow(omx, -1)
                + 44.0 / 3.0 * ln(z) * NC * pow(z, -1) * CF
                - 4 * ln(z) * NC * pow(z, -1) * rln2 * CF * pow(omx, -1)
                + 2 * ln(z) * NC * pow(z, -1) * rln2 * CF
                - 2 * ln(z) * NC * CF * pow(omx, -1)
                + 14 * ln(z) * NC * CF
                - 8 * ln(z) * NC * rln2 * CF * pow(omx, -1)
                + 6 * ln(z) * NC * rln2 * CF
                - 2 * ln(z) * NC * sqrtxz1 * CF * pow(omx, -1)
                + 6 * ln(z) * NC * z * CF * pow(omx, -1)
                + 2 * ln(z) * NC * z * CF
                - 2 * ln(z) * NC * z * rln2 * CF * pow(omx, -1)
                + 4.0 / 3.0 * ln(z) * NC * pow(z, 2) * CF
                ...
                - 8.0 / 3.0 * ln(z) * NC * x * pow(z, 2) * CF
                - ln(z) * LMUF * pow(NC, -1) * pow(z, -1) * CF
                + ln(z) * LMUF * pow(NC, -1) * CF
                - 1.0 / 2.0 * ln(z) * LMUF * pow(NC, -1) * z * CF
                - ln(z) * LMUF * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                + ln(z) * LMUA * pow(NC, -1) * CF
                + 1.0 / 2.0 * ln(z) * LMUA * pow(NC, -1) * z * CF
                - ln(z) * LMUA * pow(NC, -1) * x * CF
            )
            tmp += (
                -1.0 / 2.0 * ln(z) * LMUA * pow(NC, -1) * x * z * CF
                - 2 * ln(z) * LMUA * NC * pow(z, -1) * CF
                - 5 * ln(z) * LMUA * NC * CF
                - 1.0 / 2.0 * ln(z) * LMUA * NC * z * CF
                - 2 * ln(z) * LMUA * NC * x * pow(z, -1) * CF
                - 3 * ln(z) * LMUA * NC * x * CF
                - 15.0 / 2.0 * ln(z) * LMUA * NC * x * z * CF
                + 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * CF
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * CF * pow(omx, -1)
                ...
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * CF
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * CF
                - 2 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * z * CF
                + 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(z, -1) * CF
                + 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * CF * pow(omx, -1)
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * CF
                + 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * z * CF * pow(omx, -1)
                - 2 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * pow(z, -1) * CF
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * CF
                - 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * z * CF
                - 4 * ln(z) * ln(1 + z) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 4 * ln(z) * ln(1 + z) * NC * CF * pow(omx, -1)
                - 2 * ln(z) * ln(1 + z) * NC * z * CF * pow(omx, -1)
                - 3 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
            ...
            tmp += (
                ...
                + 8 * ln(z) * ln(omx) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 3 * ln(z) * ln(omx) * NC * pow(z, -1) * CF
                - 8 * ln(z) * ln(omx) * NC * CF * pow(omx, -1)
                + 14 * ln(z) * ln(omx) * NC * CF
                + 4 * ln(z) * ln(omx) * NC * z * CF * pow(omx, -1)
                - 3 * ln(z) * ln(omx) * NC * x * pow(z, -1) * CF
                + 12 * ln(z) * ln(omx) * NC * x * CF
                - ln(z) * ln(omx) * NC * x * z * CF
                - 12 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + 4 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
                + 20 * ln(z) * ln(omz) * pow(NC, -1) * CF * pow(omx, -1)
                - 8 * ln(z) * ln(omz) * pow(NC, -1) * CF
            ...
            tmp += (
                -5 * ln(z) * ln(omz) * NC * pow(z, -1) * CF
                - 4 * ln(z) * ln(omz) * NC * CF * pow(omx, -1)
                + 10 * ln(z) * ln(omz) * NC * CF
                + 2 * ln(z) * ln(omz) * NC * z * CF * pow(omx, -1)
                - 5 * ln(z) * ln(omz) * NC * x * pow(z, -1) * CF
                + 10 * ln(z) * ln(omz) * NC * x * CF
                - 10 * ln(z) * ln(omz) * NC * x * z * CF
                - 6 * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 11.0 / 4.0 * ln(omx) * pow(NC, -1) * pow(z, -1) * CF
                + 6 * ln(omx) * pow(NC, -1) * CF * pow(omx, -1)
                ...
                - 3 * ln(omx) * NC * CF
                + 4 * ln(omx) * NC * z * CF * pow(omx, -1)
                - 7.0 / 2.0 * ln(omx) * NC * z * CF
                + 4.0 / 3.0 * ln(omx) * NC * pow(z, 2) * CF
                + 41.0 / 12.0 * ln(omx) * NC * x * pow(z, -1) * CF
                - 6 * ln(omx) * NC * x * CF
                - 3 * ln(omx) * NC * x * z * CF
                - 8.0 / 3.0 * ln(omx) * NC * x * pow(z, 2) * CF
                - 2 * ln(omx) * LMUF * pow(NC, -1) * pow(z, -1) * CF
                + 3 * ln(omx) * LMUF * pow(NC, -1) * CF
                - 1.0 / 2.0 * ln(omx) * LMUF * pow(NC, -1) * z * CF
                - 2 * ln(omx) * LMUF * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                - 3 * ln(omx) * LMUF * NC * x * CF
                + 5.0 / 2.0 * ln(omx) * LMUF * NC * x * z * CF
                - ln(omx) * LMUA * pow(NC, -1) * pow(z, -1) * CF
                + ln(omx) * LMUA * pow(NC, -1) * CF
                - 1.0 / 2.0 * ln(omx) * LMUA * pow(NC, -1) * z * CF
            )
            tmp += (
                -ln(omx) * LMUA * pow(NC, -1) * x * pow(z, -1) * CF
            ...
            tmp += (
                -6 * ln(omx) * ln(omz) * NC * pow(z, -1) * CF
                - 4 * ln(omx) * ln(omz) * NC * CF * pow(omx, -1)
                + 10 * ln(omx) * ln(omz) * NC * CF
                + 2 * ln(omx) * ln(omz) * NC * z * CF * pow(omx, -1)
                - ln(omx) * ln(omz) * NC * z * CF
                - 6 * ln(omx) * ln(omz) * NC * x * pow(z, -1) * CF
                + 10 * ln(omx) * ln(omz) * NC * x * CF
                - 9 * ln(omx) * ln(omz) * NC * x * z * CF
                - 8 * ln(omz) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                - 11.0 / 4.0 * ln(omz) * pow(NC, -1) * pow(z, -1) * CF
                + 8 * ln(omz) * pow(NC, -1) * CF * pow(omx, -1)
                + ln(omz) * pow(NC, -1) * CF
                - 8 * ln(omz) * pow(NC, -1) * z * CF * pow(omx, -1)
                + 2 * ln(omz) * pow(NC, -1) * z * CF
                + 25.0 / 4.0 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 4 * ln(omz) * pow(NC, -1) * x * CF * omx
                + 9.0 / 2.0 * ln(omz) * pow(NC, -1) * x * z * CF
                + 2 * ln(omz) * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -2)
                - 2 * ln(omz) * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -1)
                - 2 * ln(omz) * pow(NC, -1) * pow(x, 2) * CF
                - 2 * ln(omz) * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -2)
            ...
            tmp += (
                ...
                + pow(ln(omz), 2) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 5.0 / 2.0 * pow(ln(omz), 2) * NC * pow(z, -1) * CF
                - pow(ln(omz), 2) * NC * CF * pow(omx, -1)
                + 4 * pow(ln(omz), 2) * NC * CF
                + 1.0 / 2.0 * pow(ln(omz), 2) * NC * z * CF * pow(omx, -1)
                - 1.0 / 2.0 * pow(ln(omz), 2) * NC * z * CF
                - 5.0 / 2.0 * pow(ln(omz), 2) * NC * x * pow(z, -1) * CF
                + 4 * pow(ln(omz), 2) * NC * x * CF
                - 7.0 / 2.0 * pow(ln(omz), 2) * NC * x * z * CF
            ...
            tmp += (
                ...
                - Li2(1 - x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF
                - 4 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * CF * pow(omx, -1)
                + 2 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * CF
                + 2 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * z * CF * pow(omx, -1)
                - Li2(1 - x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                + 2 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * x * CF
                - 2 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * x * z * CF
                - 2 * Li2(1 - x * pow(z, -1)) * NC * pow(z, -1) * CF * pow(omx, -1)
                + Li2(1 - x * pow(z, -1)) * NC * pow(z, -1) * CF
                + 2 * Li2(1 - x * pow(z, -1)) * NC * CF * pow(omx, -1)
                - 2 * Li2(1 - x * pow(z, -1)) * NC * CF
                - Li2(1 - x * pow(z, -1)) * NC * z * CF * pow(omx, -1)
                + Li2(1 - x * pow(z, -1)) * NC * x * pow(z, -1) * CF
                - 2 * Li2(1 - x * pow(z, -1)) * NC * x * CF
                + 2 * Li2(1 - x * pow(z, -1)) * NC * x * z * CF
                - 4 * Li2(-z) * NC * pow(z, -1) * CF * pow(omx, -1)
                - 4 * Li2(-z) * NC * CF * pow(omx, -1)
                - 2 * Li2(-z) * NC * z * CF * pow(omx, -1)
                - 2 * Li2(x) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + 3.0 / 2.0 * Li2(x) * pow(NC, -1) * pow(z, -1) * CF
                + 2 * Li2(x) * pow(NC, -1) * CF * pow(omx, -1)
                - Li2(x) * pow(NC, -1) * CF
                - Li2(x) * pow(NC, -1) * z * CF * pow(omx, -1)
                + 3.0 / 2.0 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * CF
                - Li2(x) * pow(NC, -1) * x * CF
                + Li2(x) * pow(NC, -1) * x * z * CF
                - 1.0 / 2.0 * Li2(x) * NC * pow(z, -1) * CF
                - Li2(x) * NC * CF
                - 1.0 / 2.0 * Li2(x) * NC * x * pow(z, -1) * CF
                - Li2(x) * NC * x * CF
                + Li2(x) * NC * x * z * CF
                - 4 * Li2(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                + 6 * Li2(z) * pow(NC, -1) * CF * pow(omx, -1)
                - 3 * Li2(z) * pow(NC, -1) * z * CF * pow(omx, -1)
                - 2 * Li2(z) * pow(NC, -1) * x * pow(z, -1) * CF
                + 2 * Li2(z) * pow(NC, -1) * x * CF
            )
            tmp += -Li2(z) * pow(NC, -1) * x * z * CF - 3 * Li2(z) * NC * pow(z, -1) * CF - 2 * Li2(z) * NC * CF - 3 * Li2(z) * NC * x * pow(z, -1) * CF - 11 * Li2(z) * NC * x * z * CF
...
def C2Tq2gEq(x, z, rsl, order, f=C2Tq2gEq_DR0123_scheme):
    if rsl == "ll":
