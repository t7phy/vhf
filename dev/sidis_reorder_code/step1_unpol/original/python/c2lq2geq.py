    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            tmp = (
                ...
                - 6 * pow(NC, -1) * x * pow(pi, 2) * CF
                + 10.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF
                - 24 * ln(x) * pow(NC, -1) * x * CF
            ...
            tmp += (
                ...
                - 20 * ln(omx) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                + 52 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF
                - 32 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF
                + 16 * ln(omz) * pow(NC, -1) * x * CF
                - 16 * ln(omz) * pow(NC, -1) * x * z * CF
                - 10 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                + 26 * pow(ln(omz), 2) * pow(NC, -1) * x * CF
                - 16 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF
                + 4 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 12 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * CF
                + 8 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * z * CF
                - 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * CF
                ...
                - 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * CF
                - 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                + 8 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * CF
                - 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * z * CF
                - 4 * Li2(z) * pow(NC, -1) * x * pow(z, -1) * CF
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            tmp = (
                ...
                + 24 * ln(z) * ln(omx) * pow(NC, -1) * x * CF
                - 16 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF
                - 12 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                + 44 * ln(z) * ln(omz) * pow(NC, -1) * x * CF
                - 32 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF
                - 4 * ln(z) * ln(xmz) * pow(NC, -1) * x * CF
                + 4 * ln(z) * ln(xmz) * pow(NC, -1) * x * z * CF
                + 12 * ln(omx) * pow(NC, -1) * x * CF
                - 12 * ln(omx) * pow(NC, -1) * x * z * CF
            ...
            tmp += (
                +18 * pow(ln(omx), 2) * pow(NC, -1) * x * CF
                - 10 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF
                - 16 * ln(omx) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                - 8 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * CF
                + 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * z * CF
                - 4 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x * pow(z, -1) * CF
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            tmp = (
                8.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF
                - 26.0 / 3.0 * pow(NC, -1) * x * pow(pi, 2) * CF
                ...
                + 12 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                - 48 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                + 36 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                + 24 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF
                - 60 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                + 36 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                + 24 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 72 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
            ...
            tmp += (
                ...
                - 20 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF
                + 4 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 12 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * CF
                + 8 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * z * CF
                + 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * CF
                - 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF
                + 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                - 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * CF
                + 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * CF
                - 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            tmp = (
                ...
                + 16 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                - 52 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                + 36 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                + 20 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF
                - 56 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                + 36 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                + 20 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                - 60 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
                ...
                - 20 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF
                - 12 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
        ...
        if round(z, ndecimals) > round(x, ndecimals):
            ...
            tmp = (
                2 * NC * x * pow(pi, 2) * CF
                - 2 * NC * x * z * pow(pi, 2) * CF
                - 12 * ln(x) * NC * x * z * CF
                - 4 * ln(x) * ln(-xmz) * NC * x * CF
                + 4 * ln(x) * ln(-xmz) * NC * x * z * CF
                - 14 * pow(ln(x), 2) * NC * x * CF
                + 14 * pow(ln(x), 2) * NC * x * z * CF
                + 24 * ln(x) * ln(z) * NC * x * CF
                - 24 * ln(x) * ln(z) * NC * x * z * CF
                ...
                - 4 * ln(z) * ln(-xmz) * NC * x * z * CF
                - 10 * pow(ln(z), 2) * NC * x * CF
                + 10 * pow(ln(z), 2) * NC * x * z * CF
                - 20 * ln(z) * ln(omx) * NC * x * CF
                + 20 * ln(z) * ln(omx) * NC * x * z * CF
                - 4 * ln(z) * ln(omz) * NC * x * CF
                + 4 * ln(z) * ln(omz) * NC * x * z * CF
                + 8 * ln(omx) * NC * x * z * CF
                - 8 * pow(ln(omx), 2) * NC * x * CF
                + 8 * pow(ln(omx), 2) * NC * x * z * CF
                - 8 * ln(omx) * ln(omz) * NC * x * CF
                + 8 * ln(omx) * ln(omz) * NC * x * z * CF
                + 4 * ln(omz) * NC * x * z * CF
                - 2 * pow(ln(omz), 2) * NC * x * CF
                + 2 * pow(ln(omz), 2) * NC * x * z * CF
                + 4 * Li2(pow(omx, -1) * omz) * NC * x * CF
                - 4 * Li2(pow(omx, -1) * omz) * NC * x * z * CF
                - 4 * Li2(x * pow(z, -1) * pow(omx, -1) * omz) * NC * x * CF
        ...
        if round(z, ndecimals) < round(x, ndecimals):
            ...
            tmp = (
                ...
                - 4 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * NC * x * z * CF
                - 4 * Li2(omx * pow(omz, -1)) * NC * x * CF
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            tmp = (
                ...
                - 14 * pow(NC, -1) * x * z * CF
                - 14.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF
                + 4 * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -1)
                - 4 * pow(NC, -1) * pow(x, 2) * CF
                - 4 * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -1)
                + NC * pow(z, -1) * CF
                + 10 * NC * CF
                - 7 * NC * z * CF
                - 4 * NC * pow(z, 2) * CF
                ...
                + 10 * NC * x * pow(z, 2) * CF
                + 22.0 / 3.0 * LMUR * NC * x * CF
                - 22.0 / 3.0 * LMUR * NC * x * z * CF
                - 4.0 / 3.0 * LMUR * NF * x * CF
                ...
                - LMUF * NC * x * CF
                + LMUF * NC * x * z * CF
                + 2 * LMUA * pow(NC, -1) * x * pow(z, -1) * CF
                - 4 * LMUA * pow(NC, -1) * x * CF
                + 2 * LMUA * pow(NC, -1) * x * z * CF
                - 6 * LMUA * NC * x * pow(z, -1) * CF
                - 22.0 / 3.0 * LMUA * NC * x * CF
                + 28.0 / 3.0 * LMUA * NC * x * z * CF
                + 4 * LMUA * NC * x * pow(z, 2) * CF
                + 4.0 / 3.0 * LMUA * NF * x * CF
                - 4.0 / 3.0 * LMUA * NF * x * z * CF
                - 4 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                - 4 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * sqrtxz1 * CF
                - 8 * ln(1 + sqrtxz1 - z) * NC * x * rln2 * CF
                - 8 * ln(1 + sqrtxz1 - z) * NC * x * sqrtxz1 * CF
                - 8 * ln(1 + sqrtxz1 - z) * NC * x * z * rln2 * CF
            )
            tmp += (
                ...
                - 16 * ln(x) * pow(NC, -1) * x * z * CF
                + 4 * ln(x) * pow(NC, -1) * pow(x, 2) * CF * pow(omxmz, -1)
                + 4 * ln(x) * pow(NC, -1) * pow(x, 2) * CF
                + 4 * ln(x) * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -2)
                - 8 * ln(x) * pow(NC, -1) * pow(x, 3) * CF * pow(omxmz, -1)
                - 4 * ln(x) * pow(NC, -1) * pow(x, 4) * CF * pow(omxmz, -2)
                - 2 * ln(x) * NC * CF
                + 2 * ln(x) * NC * z * CF
                - 7 * ln(x) * NC * x * pow(z, -1) * CF
                - 7 * ln(x) * NC * x * CF
                + 4 * ln(x) * NC * x * rln2 * CF
                ...
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * NC * x * CF
                - 4 * ln(x) * ln(1 + sqrtxz1 + z) * NC * x * z * CF
                + 14 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                - 44 * pow(ln(x), 2) * pow(NC, -1) * x * CF
                + 30 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF
                + 16 * pow(ln(x), 2) * NC * x * CF
                - 16 * pow(ln(x), 2) * NC * x * z * CF
                - 12 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                + 40 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                - 34 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                - 32 * ln(x) * ln(z) * NC * x * CF
                - 2 * ln(x) * ln(z) * NC * x * z * CF
            )
            tmp += (
                -20 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF
                + 56 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                - 36 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                - 28 * ln(x) * ln(omx) * NC * x * CF
                + 28 * ln(x) * ln(omx) * NC * x * z * CF
                - 20 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF
                + 62 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
                - 42 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF
                - 22 * ln(x) * ln(omz) * NC * x * CF
                + 22 * ln(x) * ln(omz) * NC * x * z * CF
                - 4 * ln(z) * pow(NC, -1) * CF
                - 4 * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                - 4 * ln(z) * NC * x * pow(z, 2) * CF
                - 2 * ln(z) * LMUA * pow(NC, -1) * x * z * CF
                - 8 * ln(z) * LMUA * NC * x * CF
                - 14 * ln(z) * LMUA * NC * x * z * CF
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * CF
                - 4 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * z * CF
                - 8 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * CF
                - 8 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * z * CF
                + 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                - 10 * pow(ln(z), 2) * pow(NC, -1) * x * CF
                + 10 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF
            ...
            tmp += (
                -4 * ln(omz) * NC * x * pow(z, 2) * CF
                - 8 * ln(omz) * LMUA * NC * x * CF
                + 8 * ln(omz) * LMUA * NC * x * z * CF
                + 8 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                - 24 * pow(ln(omz), 2) * pow(NC, -1) * x * CF
                + 16 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF
                + 6 * pow(ln(omz), 2) * NC * x * CF
                - 6 * pow(ln(omz), 2) * NC * x * z * CF
                ...
                - 4 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * x * z * CF
                - 4 * Li2(1 - x * pow(z, -1)) * NC * x * CF
...
def C2Lq2gEq(x, z, rsl, order, f=C2Lq2gEq_DR0123_scheme):
    if rsl == "ll":
