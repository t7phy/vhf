    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            tmp = (
                ...
                + 3.0 / 2.0 * CF
                + 5.0 / 4.0 * z * CF
                - 3.0 / 4.0 * x * pow(z, -2) * CF
                + 3.0 / 2.0 * x * pow(z, -1) * CF
                + 1.0 / 2.0 * x * CF
                - 5.0 / 4.0 * x * z * CF
                + 5.0 / 4.0 * pow(x, 2) * pow(z, -1) * CF
                - 5.0 / 4.0 * pow(x, 2) * CF
                - 3.0 / 4.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(x, -2) * sqrtxz3 * CF
