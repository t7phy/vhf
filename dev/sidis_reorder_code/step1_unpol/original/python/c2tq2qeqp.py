    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            tmp += (
                ...
                - 5.0 / 16.0 * ln(x) * pow(x, -1) * CF
                - 5.0 / 16.0 * ln(x) * pow(z, -2) * CF
                - 17.0 / 8.0 * ln(x) * pow(z, -1) * CF
                + 17.0 / 8.0 * ln(x) * CF
                + 5.0 / 16.0 * ln(x) * z * CF
            )
            tmp += (
                -5.0 / 16.0 * ln(x) * x * pow(z, -2) * CF
                - 17.0 / 8.0 * ln(x) * x * pow(z, -1) * CF
                + 17.0 / 8.0 * ln(x) * x * CF
                + 5.0 / 16.0 * ln(x) * x * z * CF
                + 5.0 / 16.0 * ln(x) * pow(x, 2) * pow(z, -1) * CF
                - 5.0 / 16.0 * ln(x) * pow(x, 2) * CF
                - 2 * ln(x) * ln(z) * pow(z, -1) * CF
                - 2 * ln(x) * ln(z) * CF
                - 2 * ln(x) * ln(z) * x * pow(z, -1) * CF
                - 2 * ln(x) * ln(z) * x * CF
                - 5.0 / 16.0 * ln(z) * pow(x, -1) * pow(z, -1) * CF
                - 5.0 / 16.0 * ln(z) * pow(x, -1) * CF
                + 5.0 / 16.0 * ln(z) * pow(z, -2) * CF
                - 17.0 / 8.0 * ln(z) * pow(z, -1) * CF
                - 17.0 / 8.0 * ln(z) * CF
                + 5.0 / 16.0 * ln(z) * z * CF
                - 5.0 / 16.0 * ln(z) * x * pow(z, -2) * CF
                + 17.0 / 8.0 * ln(z) * x * pow(z, -1) * CF
                + 17.0 / 8.0 * ln(z) * x * CF
                - 5.0 / 16.0 * ln(z) * x * z * CF
