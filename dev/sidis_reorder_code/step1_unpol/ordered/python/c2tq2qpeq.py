...
def C2Tq2qpEq_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    ...
    if cx == "D" and cz == "R":
        ...
        if "000" == order:
            ...
            res += +(-1) * Li3(1 - z) * CF + (-1) * Li3(1 - z) * z * CF + (-1) * 2 * Li3(z) * CF + (-1) * 2 * Li3(z) * z * CF + (-1) * 2.0 / 3.0 * Li2(z) * pow(z, -1) * CF + 1.0 / 2.0 * Li2(z) * CF + 2 * Li2(z) * z * CF + 2.0 / 3.0 * Li2(z) * pow(z, 2) * CF + 0
        if "001" == order:
            res += (
                ...
                + (-1) * 2.0 / 3.0 * ln(omz) * LMUA * pow(z, -1) * CF
        ...
        if "002" == order:
            res += 1.0 / 3.0 * pow(LMUA, 2) * pow(z, -1) * CF + 1.0 / 4.0 * pow(LMUA, 2) * CF + (-1) * 1.0 / 4.0 * pow(LMUA, 2) * z * CF + (-1) * 1.0 / 3.0 * pow(LMUA, 2) * pow(z, 2) * CF + 1.0 / 2.0 * ln(z) * pow(LMUA, 2) * CF + 1.0 / 2.0 * ln(z) * pow(LMUA, 2) * z * CF + 0
        return res
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                ...
                tmp += (
                    ...
                    + 3.0 / 2.0 * ln(omz) * z * CF
                    + (-1) * 2.0 / 3.0 * ln(omz) * pow(z, 2) * CF
                    + (-1) * 1.0 / 3.0 * ln(omz) * x * pow(z, -1) * CF
                    + (-1) * 3.0 / 2.0 * ln(omz) * x * CF
            ...
            if "001" == order:
                tmp += 1.0 / 3.0 * LMUA * pow(z, -1) * CF + 1.0 / 2.0 * LMUA * CF + (-1) * 3.0 / 2.0 * LMUA * z * CF + 2.0 / 3.0 * LMUA * pow(z, 2) * CF + 1.0 / 3.0 * LMUA * x * pow(z, -1) * CF + 3.0 / 2.0 * LMUA * x * CF + (-1) * 1.0 / 2.0 * LMUA * x * z * CF + (-1) * 4.0 / 3.0 * LMUA * x * pow(z, 2) * CF + ln(z) * LMUA * CF + ln(z) * LMUA * x * CF + 2 * ln(z) * LMUA * x * z * CF + 0
            res += tmp

        return res


def c2tq2qp__eq(x, z, rsl, order, f=C2Tq2qpEq_DR0123_scheme):
    if rsl == "ll":
