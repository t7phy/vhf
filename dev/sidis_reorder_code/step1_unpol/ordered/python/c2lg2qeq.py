        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 7.0 / 3.0 * pow(NC, -1) * x * pow(pi, 2)
                    + (-1) * 2 * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + (-1) * 2 * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    ...
                    + (-1) * 6 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + (-1) * 6 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    + (-1) * 12 * ln(x) * NC * x
                    + 12 * ln(x) * NC * pow(x, 2)
                    + 13 * pow(ln(x), 2) * pow(NC, -1) * x
                    + (-1) * 13 * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 12 * pow(ln(x), 2) * NC * x
                    + 12 * pow(ln(x), 2) * NC * pow(x, 2)
                    + (-1) * 16 * ln(x) * ln(z) * pow(NC, -1) * x
                    + 16 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2)
                    + 20 * ln(x) * ln(z) * NC * x
                    + (-1) * 20 * ln(x) * ln(z) * NC * pow(x, 2)
                    + (-1) * 22 * ln(x) * ln(omx) * pow(NC, -1) * x
                    + 22 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + 16 * ln(x) * ln(omx) * NC * x
                    + (-1) * 16 * ln(x) * ln(omx) * NC * pow(x, 2)
                    + (-1) * 20 * ln(x) * ln(omz) * pow(NC, -1) * x
                    + 20 * ln(x) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + 20 * ln(x) * ln(omz) * NC * x
                    + (-1) * 20 * ln(x) * ln(omz) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(xmz) * pow(NC, -1) * x
                    + (-1) * 2 * ln(x) * ln(xmz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * ln(x) * ln(xmz) * NC * x
                    + 4 * ln(x) * ln(xmz) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(omxmz) * pow(NC, -1) * x
                    + (-1) * 2 * ln(x) * ln(omxmz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * ln(x) * ln(omxmz) * NC * x
                    + 4 * ln(x) * ln(omxmz) * NC * pow(x, 2)
                    + (-1) * 2 * ln(z) * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 4 * ln(z) * pow(NC, -1) * x * pow(omz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 5 * pow(ln(z), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 8 * pow(ln(z), 2) * NC * x
                    + 8 * pow(ln(z), 2) * NC * pow(x, 2)
                    + 12 * ln(z) * ln(omx) * pow(NC, -1) * x
                    + (-1) * 12 * ln(z) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 8 * ln(z) * ln(omx) * NC * x
                    + 8 * ln(z) * ln(omx) * NC * pow(x, 2)
                    + 8 * ln(z) * ln(omz) * pow(NC, -1) * x
                    + (-1) * 8 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 16 * ln(z) * ln(omz) * NC * x
                    + 16 * ln(z) * ln(omz) * NC * pow(x, 2)
                    + (-1) * 2 * ln(z) * ln(xmz) * pow(NC, -1) * x
                    + 2 * ln(z) * ln(xmz) * pow(NC, -1) * pow(x, 2)
                    + 4 * ln(z) * ln(xmz) * NC * x
                    + (-1) * 4 * ln(z) * ln(xmz) * NC * pow(x, 2)
                    + (-1) * 4 * ln(omx) * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 4 * ln(omx) * pow(NC, -1) * x * pow(omz, -1)
                    + 4 * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + 4 * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    + 4 * ln(omx) * NC * x
                    + (-1) * 4 * ln(omx) * NC * pow(x, 2)
                    + 8 * pow(ln(omx), 2) * pow(NC, -1) * x
                    + (-1) * 8 * pow(ln(omx), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 2 * pow(ln(omx), 2) * NC * x
                    + 2 * pow(ln(omx), 2) * NC * pow(x, 2)
                    + 14 * ln(omx) * ln(omz) * pow(NC, -1) * x
                    + (-1) * 14 * ln(omx) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 12 * ln(omx) * ln(omz) * NC * x
                    + 12 * ln(omx) * ln(omz) * NC * pow(x, 2)
                    + (-1) * 4 * ln(omz) * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 2 * ln(omz) * pow(NC, -1) * x * pow(omz, -1)
                    + 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + 2 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    + 8 * ln(omz) * NC * x
                    + (-1) * 8 * ln(omz) * NC * pow(x, 2)
                    + 6 * pow(ln(omz), 2) * pow(NC, -1) * x
                    + (-1) * 6 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 6 * pow(ln(omz), 2) * NC * x
                    + 6 * pow(ln(omz), 2) * NC * pow(x, 2)
                    + (-1) * 2 * ln(omz) * ln(omxmz) * pow(NC, -1) * x
                    + 2 * ln(omz) * ln(omxmz) * pow(NC, -1) * pow(x, 2)
                    + 4 * ln(omz) * ln(omxmz) * NC * x
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(omz) * ln(omxmz) * NC * pow(x, 2)
                    + 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * NC * x
                    + (-1) * 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * NC * pow(x, 2)
                    + (-1) * 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x
                    + 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * pow(x, 2)
                    + 2 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x
                    + (-1) * 2 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * pow(x, 2)
                    + 4 * Li2(omx * pow(omz, -1)) * NC * x
                    + (-1) * 4 * Li2(omx * pow(omz, -1)) * NC * pow(x, 2)
                    + (-1) * 2 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x
                    + 2 * Li2(z * pow(omx, -1)) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * Li2(z * pow(omx, -1)) * NC * x
                    + 4 * Li2(z * pow(omx, -1)) * NC * pow(x, 2)
                    + 2 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x
                    + (-1) * 2 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * pow(x, 2)
                    + 0
                )
            res += tmp
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 12 * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 14 * pow(ln(x), 2) * NC * x
                    + 14 * pow(ln(x), 2) * NC * pow(x, 2)
                    + (-1) * 18 * ln(x) * ln(z) * pow(NC, -1) * x
                    + 18 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2)
                    + 24 * ln(x) * ln(z) * NC * x
                    + (-1) * 24 * ln(x) * ln(z) * NC * pow(x, 2)
                    + (-1) * 20 * ln(x) * ln(omx) * pow(NC, -1) * x
                    + 20 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + 12 * ln(x) * ln(omx) * NC * x
                    + (-1) * 12 * ln(x) * ln(omx) * NC * pow(x, 2)
                    + (-1) * 18 * ln(x) * ln(omz) * pow(NC, -1) * x
                    + 18 * ln(x) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + 24 * ln(x) * ln(omz) * NC * x
                    + (-1) * 24 * ln(x) * ln(omz) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(xmz) * pow(NC, -1) * x
                    + (-1) * 2 * ln(x) * ln(xmz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * ln(x) * ln(xmz) * NC * x
                    + 4 * ln(x) * ln(xmz) * NC * pow(x, 2)
                ...
                tmp += (
                    ...
                    + (-1) * 10 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 20 * ln(z) * ln(omz) * NC * x
                    ...
                    + (-1) * 12 * ln(omx) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 8 * ln(omx) * ln(omz) * NC * x
                    ...
                    + (-1) * 5 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 8 * pow(ln(omz), 2) * NC * x
                    + 0
                )
                tmp += (
                    +8 * pow(ln(omz), 2) * NC * pow(x, 2)
                    + (-1) * 2 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x
                    + 2 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x
                    + 2 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * pow(x, 2)
                    + 2 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x
                    + (-1) * 2 * Li2(pow(z, -1) * omx) * pow(NC, -1) * pow(x, 2)
                    + 4 * Li2(pow(z, -1) * omx) * NC * x
                    + (-1) * 4 * Li2(pow(z, -1) * omx) * NC * pow(x, 2)
                    + 2 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x
                    + (-1) * 2 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * pow(x, 2)
                    + 4 * Li2(omx * pow(omz, -1)) * NC * x
                    + (-1) * 4 * Li2(omx * pow(omz, -1)) * NC * pow(x, 2)
                    + (-1) * 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * NC * x
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + 4 * NC * pow(x, 2)
                    + (-1) * 10.0 / 3.0 * NC * pow(x, 2) * pow(pi, 2)
                    + 6 * ln(x) * pow(NC, -1) * x * pow(z, -1)
                    + 6 * ln(x) * pow(NC, -1) * x * pow(omz, -1)
                    + (-1) * 6 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + (-1) * 6 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    ...
                    + (-1) * 14 * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 14 * pow(ln(x), 2) * NC * x
                    + 14 * pow(ln(x), 2) * NC * pow(x, 2)
                    + (-1) * 18 * ln(x) * ln(z) * pow(NC, -1) * x
                    + 18 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2)
                ...
                tmp += (
                    +4 * ln(omz) * ln(omxmz) * NC * x
                    + (-1) * 4 * ln(omz) * ln(omxmz) * NC * pow(x, 2)
                    + (-1) * 2 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x
                    + 2 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * Li2(pow(omx, -1) * omz) * NC * x
                    ...
                    + (-1) * 2 * Li2(x * pow(z, -1) * pow(omx, -1) * omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * NC * x
                    + 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * NC * pow(x, 2)
                    + 2 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x
                    + (-1) * 2 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * pow(x, 2)
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 1.0 / 8.0 * pow(NC, -1) * pow(x, -1)
                    + (-1) * 1.0 / 2.0 * pow(NC, -1) * pow(z, -1)
                    + (-1) * 1.0 / 8.0 * pow(NC, -1) * pow(poly2, -1)
                    + 3.0 / 8.0 * pow(NC, -1)
                    + (-1) * 1.0 / 2.0 * pow(NC, -1) * z
                    + (-1) * 5.0 / 2.0 * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 1.0 / 4.0 * pow(NC, -1) * x * pow(poly2, -1)
                    + (-1) * 2 * pow(NC, -1) * x * pow(omz, -1)
                    + pow(NC, -1) * x * pow(omxmz, -1)
                    + 37.0 / 8.0 * pow(NC, -1) * x
                    + 3 * pow(NC, -1) * x * pow(pi, 2)
                    + 17.0 / 2.0 * pow(NC, -1) * x * z
                    + (-1) * pow(NC, -1) * x * z * pow(pi, 2)
                    + 3 * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + 1.0 / 4.0 * pow(NC, -1) * pow(x, 2) * pow(poly2, -1)
                    + 2 * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    + (-1) * 2 * pow(NC, -1) * pow(x, 2) * pow(omxmz, -1)
                    + (-1) * 39.0 / 8.0 * pow(NC, -1) * pow(x, 2)
                    + (-1) * 7.0 / 3.0 * pow(NC, -1) * pow(x, 2) * pow(pi, 2)
                    + (-1) * 8 * pow(NC, -1) * pow(x, 2) * z
                    + 1.0 / 8.0 * pow(NC, -1) * pow(x, 3) * pow(poly2, -1)
                    + pow(NC, -1) * pow(x, 3) * pow(omxmz, -1)
                    + (-1) * 1.0 / 8.0 * pow(NC, -1) * pow(x, 4) * pow(poly2, -1)
                    + (-1) * 1.0 / 8.0 * NC * pow(x, -1) * pow(poly2, -1)
                    ...
                    + (-1) * NC * x * pow(omxmz, -1)
                    + (-1) * 95.0 / 24.0 * NC * x
                    + (-1) * 17.0 / 3.0 * NC * x * pow(pi, 2)
                    + (-1) * 57.0 / 2.0 * NC * x * z
                    + NC * x * z * pow(pi, 2)
                    + (-1) * NC * pow(x, 2) * pow(z, -1)
                    + (-1) * 1.0 / 4.0 * NC * pow(x, 2) * pow(poly2, -1)
                    + 2 * NC * pow(x, 2) * pow(omxmz, -1)
                    + 1343.0 / 72.0 * NC * pow(x, 2)
                    + 3 * NC * pow(x, 2) * pow(pi, 2)
                    + 8 * NC * pow(x, 2) * z
                    + (-1) * 1.0 / 8.0 * NC * pow(x, 3) * pow(poly2, -1)
                    + (-1) * NC * pow(x, 3) * pow(omxmz, -1)
                    + 1.0 / 8.0 * NC * pow(x, 4) * pow(poly2, -1)
                    + 0
                )
                tmp += (
                    +3.0 / 16.0 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(poly2, -1)
                    + (-1) * 3.0 / 16.0 * ln(x) * pow(NC, -1) * pow(poly2, -2)
                    + 1.0 / 16.0 * ln(x) * pow(NC, -1) * pow(poly2, -1)
                    + 1.0 / 2.0 * ln(x) * pow(NC, -1)
                    + 1.0 / 4.0 * ln(x) * pow(NC, -1) * z
                    + (-1) * 7 * ln(x) * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 9.0 / 16.0 * ln(x) * pow(NC, -1) * x * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * ln(x) * pow(NC, -1) * x * pow(poly2, -1)
                    + (-1) * 6 * ln(x) * pow(NC, -1) * x * pow(omz, -1)
                    + (-1) * ln(x) * pow(NC, -1) * x * pow(omxmz, -1)
                    + ln(x) * pow(NC, -1) * x
                    ...
                    + (-1) * 2 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(xmz, -1)
                    + ln(x) * pow(NC, -1) * pow(x, 2) * pow(omxmz, -2)
                    + ln(x) * pow(NC, -1) * pow(x, 2) * pow(omxmz, -1)
                    + (-1) * 7.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * ln(x) * pow(NC, -1) * pow(x, 2) * z
                ...
                tmp += (
                    +(-1) * 2 * ln(x) * pow(NC, -1) * pow(x, 3) * pow(omxmz, -2)
                    + (-1) * 9.0 / 16.0 * ln(x) * pow(NC, -1) * pow(x, 4) * pow(poly2, -2)
                    + (-1) * 11.0 / 16.0 * ln(x) * pow(NC, -1) * pow(x, 4) * pow(poly2, -1)
                    + (-1) * ln(x) * pow(NC, -1) * pow(x, 4) * pow(xmz, -2)
                    + ln(x) * pow(NC, -1) * pow(x, 4) * pow(omxmz, -2)
                    + (-1) * 3.0 / 16.0 * ln(x) * pow(NC, -1) * pow(x, 5) * pow(poly2, -2)
                    + 3.0 / 16.0 * ln(x) * pow(NC, -1) * pow(x, 6) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(x) * NC * pow(x, -1) * pow(poly2, -2)
                    + (-1) * 5.0 / 16.0 * ln(x) * NC * pow(x, -1) * pow(poly2, -1)
                    ...
                    + (-1) * ln(x) * NC * x * pow(z, 3) * pow(xmz, -2)
                    + (-1) * 9.0 / 16.0 * ln(x) * NC * pow(x, 2) * pow(poly2, -2)
                    + (-1) * 5.0 / 8.0 * ln(x) * NC * pow(x, 2) * pow(poly2, -1)
                    + (-1) * ln(x) * NC * pow(x, 2) * pow(omxmz, -2)
                    + (-1) * 3 * ln(x) * NC * pow(x, 2) * pow(omxmz, -1)
                    + (-1) * 64 * ln(x) * NC * pow(x, 2)
                    + 4 * ln(x) * NC * pow(x, 2) * z
                    + (-1) * 9.0 / 16.0 * ln(x) * NC * pow(x, 3) * pow(poly2, -2)
                    + (-1) * 1.0 / 16.0 * ln(x) * NC * pow(x, 3) * pow(poly2, -1)
                    + (-1) * 3 * ln(x) * NC * pow(x, 3) * pow(xmz, -1)
                    ...
                    + (-1) * ln(x) * NC * pow(x, 4) * pow(omxmz, -2)
                    + 3.0 / 16.0 * ln(x) * NC * pow(x, 5) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(x) * NC * pow(x, 6) * pow(poly2, -2)
                    + 0
                )
                tmp += (
                    +3.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 1.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1)
                    + 1.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(sqrtxz2, -1)
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * z * pow(sqrtxz2, -1)
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 31.0 / 16.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1)
                    + (-1) * 11.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1)
                    + 11.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + 29.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1)
                    + (-1) * 29.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 3.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 0
                )
                tmp += (
                    +(-1) * 3.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 7.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, -1) * pow(sqrtxz2, -1)
                    + (-1) * 5.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 151.0 / 16.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * x * pow(sqrtxz2, -1)
                    + 51.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * x * z * pow(sqrtxz2, -1)
                    + (-1) * 51.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + (-1) * 129.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, 2) * pow(sqrtxz2, -1)
                    + 129.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, 2) * z * pow(sqrtxz2, -1)
                    + (-1) * 9.0 / 16.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 193.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, 3) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 32.0 * ln(x) * ln(1 - sqrtxz2 + x) * NC * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 32.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 1.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 1.0 / 32.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1)
                    + (-1) * 1.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 31.0 / 16.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1)
                    + 11.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1)
                    + (-1) * 11.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + (-1) * 29.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1)
                    + 29.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1)
                    + (-1) * 9.0 / 16.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 5.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 73.0 / 32.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 32.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    ...
                    + (-1) * 7.0 / 32.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(x, -1) * pow(sqrtxz2, -1)
                    + 0
                )
                tmp += (
                    +5.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(sqrtxz2, -1)
                    + (-1) * 5.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * z * pow(sqrtxz2, -1)
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * x * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * x * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 151.0 / 16.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * x * pow(sqrtxz2, -1)
                    + (-1) * 51.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * x * z * pow(sqrtxz2, -1)
                    + 51.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + 129.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(x, 2) * pow(sqrtxz2, -1)
                    + (-1) * 129.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(x, 2) * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 3.0 / 32.0 * ln(x) * ln(1 + sqrtxz2 + x) * NC * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 4 * ln(x) * ln(1 + x) * pow(NC, -1) * x
                    + (-1) * 4 * ln(x) * ln(1 + x) * pow(NC, -1) * x * z
                    + 4 * ln(x) * ln(1 + x) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * ln(x) * ln(1 + x) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * ln(x) * ln(1 + x) * NC * x * z
                    + 4 * ln(x) * ln(1 + x) * NC * pow(x, 2) * z
                    + (-1) * 15 * pow(ln(x), 2) * pow(NC, -1) * x
                ...
                tmp += (
                    +(-1) * pow(ln(x), 2) * NC * x * z
                    + (-1) * 13 * pow(ln(x), 2) * NC * pow(x, 2)
                    + (-1) * 3 * pow(ln(x), 2) * NC * pow(x, 2) * z
                    + 10 * ln(x) * ln(z) * pow(NC, -1) * x
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * x * z
                    + (-1) * 14 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 22 * ln(x) * ln(z) * NC * x
                    + (-1) * 2 * ln(x) * ln(z) * NC * x * z
                    + 18 * ln(x) * ln(z) * NC * pow(x, 2)
                    + 22 * ln(x) * ln(omx) * pow(NC, -1) * x
                    + 2 * ln(x) * ln(omx) * pow(NC, -1) * x * z
                    + (-1) * 22 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 18 * ln(x) * ln(omx) * NC * x
                    + (-1) * 2 * ln(x) * ln(omx) * NC * x * z
                    + 18 * ln(x) * ln(omx) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(omx) * NC * pow(x, 2) * z
                    + 20 * ln(x) * ln(omz) * pow(NC, -1) * x
                    + (-1) * 2 * ln(x) * ln(omz) * pow(NC, -1) * x * z
                    + (-1) * 20 * ln(x) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 40 * ln(x) * ln(omz) * NC * x
                    + 2 * ln(x) * ln(omz) * NC * x * z
                    + 24 * ln(x) * ln(omz) * NC * pow(x, 2)
                    + 3.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, -1) * pow(poly2, -1)
                    + 3.0 / 16.0 * ln(z) * pow(NC, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 16.0 * ln(z) * pow(NC, -1) * pow(poly2, -1)
                    + 1.0 / 4.0 * ln(z) * pow(NC, -1)
                    + (-1) * 7.0 / 4.0 * ln(z) * pow(NC, -1) * z
                    + 2 * ln(z) * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 9.0 / 16.0 * ln(z) * pow(NC, -1) * x * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * ln(z) * pow(NC, -1) * x * pow(poly2, -1)
                    + 4 * ln(z) * pow(NC, -1) * x * pow(omz, -1)
                    + (-1) * 15.0 / 4.0 * ln(z) * pow(NC, -1) * x
                    + 11.0 / 4.0 * ln(z) * pow(NC, -1) * x * z
                    + (-1) * ln(z) * pow(NC, -1) * x * pow(z, 3) * pow(xmz, -2)
                    + (-1) * 2 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + (-1) * 9.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(poly2, -2)
                    + (-1) * 5.0 / 8.0 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(poly2, -1)
                    + (-1) * 4 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 5 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(xmz, -1)
                    + 9.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, 4) * pow(poly2, -2)
                    + 11.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, 4) * pow(poly2, -1)
                    + ln(z) * pow(NC, -1) * pow(x, 4) * pow(xmz, -2)
                    + (-1) * 3.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, 5) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(z) * pow(NC, -1) * pow(x, 6) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(z) * NC * pow(x, -1) * pow(poly2, -2)
                    + (-1) * 5.0 / 16.0 * ln(z) * NC * pow(x, -1) * pow(poly2, -1)
                    + 11.0 / 6.0 * ln(z) * NC * pow(x, -1)
                    + (-1) * 3.0 / 16.0 * ln(z) * NC * pow(poly2, -2)
                    + (-1) * 7.0 / 16.0 * ln(z) * NC * pow(poly2, -1)
                    + (-1) * 27.0 / 4.0 * ln(z) * NC
                    + 47.0 / 4.0 * ln(z) * NC * z
                    + 9.0 / 16.0 * ln(z) * NC * x * pow(poly2, -2)
                    + 3.0 / 8.0 * ln(z) * NC * x * pow(poly2, -1)
                    + (-1) * 95.0 / 4.0 * ln(z) * NC * x
                    + (-1) * 51.0 / 4.0 * ln(z) * NC * x * z
                    ...
                    + (-1) * 9.0 / 16.0 * ln(z) * NC * pow(x, 3) * pow(poly2, -2)
                    + (-1) * 1.0 / 16.0 * ln(z) * NC * pow(x, 3) * pow(poly2, -1)
                    + 3 * ln(z) * NC * pow(x, 3) * pow(xmz, -1)
                    + (-1) * 9.0 / 16.0 * ln(z) * NC * pow(x, 4) * pow(poly2, -2)
                    + (-1) * 3.0 / 16.0 * ln(z) * NC * pow(x, 4) * pow(poly2, -1)
                    + (-1) * ln(z) * NC * pow(x, 4) * pow(xmz, -2)
                    + 3.0 / 16.0 * ln(z) * NC * pow(x, 5) * pow(poly2, -2)
                    + 3.0 / 16.0 * ln(z) * NC * pow(x, 6) * pow(poly2, -2)
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * x
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, 2)
                    + 0
                )
                tmp += (
                    +3 * pow(ln(z), 2) * NC * x
                    + (-1) * 3 * pow(ln(z), 2) * NC * pow(x, 2)
                    + (-1) * 8 * ln(z) * ln(omx) * pow(NC, -1) * x
                    + 8 * ln(z) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + 10 * ln(z) * ln(omx) * NC * x
                    + (-1) * 10 * ln(z) * ln(omx) * NC * pow(x, 2)
                    + (-1) * 14 * ln(z) * ln(omz) * pow(NC, -1) * x
                    + 14 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + 22 * ln(z) * ln(omz) * NC * x
                    + (-1) * 22 * ln(z) * ln(omz) * NC * pow(x, 2)
                    + (-1) * ln(omx) * pow(NC, -1) * z
                    + 4 * ln(omx) * pow(NC, -1) * x * pow(z, -1)
                    + 4 * ln(omx) * pow(NC, -1) * x * pow(omz, -1)
                    + ln(omx) * pow(NC, -1) * x
                    + (-1) * 3 * ln(omx) * pow(NC, -1) * x * z
                    + (-1) * 4 * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + (-1) * 4 * ln(omx) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    + (-1) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    ...
                    + (-1) * 4 * ln(omx) * NC * pow(x, 2) * z
                    + (-1) * 8 * pow(ln(omx), 2) * pow(NC, -1) * x
                    + 8 * pow(ln(omx), 2) * pow(NC, -1) * pow(x, 2)
                    + 6 * pow(ln(omx), 2) * NC * x
                    + (-1) * 6 * pow(ln(omx), 2) * NC * pow(x, 2)
                    + (-1) * 14 * ln(omx) * ln(omz) * pow(NC, -1) * x
                    + 14 * ln(omx) * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + 16 * ln(omx) * ln(omz) * NC * x
                    + (-1) * 16 * ln(omx) * ln(omz) * NC * pow(x, 2)
                    + (-1) * ln(omz) * pow(NC, -1) * z
                    + 4 * ln(omz) * pow(NC, -1) * x * pow(z, -1)
                    + 2 * ln(omz) * pow(NC, -1) * x * pow(omz, -1)
                    + ln(omz) * pow(NC, -1) * x * pow(omxmz, -1)
                    + 4 * ln(omz) * pow(NC, -1) * x
                    + (-1) * 3 * ln(omz) * pow(NC, -1) * x * z
                    + (-1) * 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + (-1) * 2 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(omz, -1)
                    + (-1) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(omxmz, -2)
                    + (-1) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(omxmz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(omz) * pow(NC, -1) * pow(x, 2)
                    + 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * z
                    + 2 * ln(omz) * pow(NC, -1) * pow(x, 3) * pow(omxmz, -2)
                    + (-1) * ln(omz) * pow(NC, -1) * pow(x, 4) * pow(omxmz, -2)
                    + 4.0 / 3.0 * ln(omz) * NC * pow(x, -1)
                    + (-1) * 4 * ln(omz) * NC
                    + ln(omz) * NC * z
                    + (-1) * ln(omz) * NC * x * pow(omxmz, -1)
                    + (-1) * 30 * ln(omz) * NC * x
                    + 3 * ln(omz) * NC * x * z
                    + ln(omz) * NC * pow(x, 2) * pow(omxmz, -2)
                    + 3 * ln(omz) * NC * pow(x, 2) * pow(omxmz, -1)
                    + 98.0 / 3.0 * ln(omz) * NC * pow(x, 2)
                    + (-1) * 4 * ln(omz) * NC * pow(x, 2) * z
                    + (-1) * 2 * ln(omz) * NC * pow(x, 3) * pow(omxmz, -2)
                    + (-1) * 2 * ln(omz) * NC * pow(x, 3) * pow(omxmz, -1)
                    + ln(omz) * NC * pow(x, 4) * pow(omxmz, -2)
                    + (-1) * 7 * pow(ln(omz), 2) * pow(NC, -1) * x
                    + 7 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2)
                    + 10 * pow(ln(omz), 2) * NC * x
                    + (-1) * 10 * pow(ln(omz), 2) * NC * pow(x, 2)
                    + 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    ...
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * z * pow(sqrtxz2, -1)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 0
                )
                tmp += (
                    +(-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 31.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1)
                    + (-1) * 11.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 29.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 0
                )
                tmp += (
                    +(-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 7.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, -1) * pow(sqrtxz2, -1)
                    + (-1) * 5.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 151.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * pow(sqrtxz2, -1)
                    + 51.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * z * pow(sqrtxz2, -1)
                    + (-1) * 51.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + (-1) * 129.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 2) * pow(sqrtxz2, -1)
                    + 129.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 2) * z * pow(sqrtxz2, -1)
                    + (-1) * 9.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 193.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 3) * pow(sqrtxz2, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 1.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1)
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 31.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1)
                    + 11.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * z * pow(sqrtxz2, -1)
                    + (-1) * 11.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + (-1) * 29.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1)
                    + 29.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 9.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 5.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 73.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    ...
                    + (-1) * 7.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, -1) * pow(sqrtxz2, -1)
                    + 5.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(sqrtxz2, -1)
                    + (-1) * 5.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * z * pow(sqrtxz2, -1)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 151.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * pow(sqrtxz2, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 51.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * x * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 129.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 2) * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * NC * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 1.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1)
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(sqrtxz2, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 31.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1)
                    + 11.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1)
                    + (-1) * 11.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + (-1) * 29.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1)
                    + 29.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1)
                    + (-1) * 9.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 5.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 73.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    ...
                    + (-1) * 7.0 / 32.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, -1) * pow(sqrtxz2, -1)
                    + 0
                )
                tmp += (
                    +5.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(sqrtxz2, -1)
                    + (-1) * 5.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * z * pow(sqrtxz2, -1)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 151.0 / 16.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * pow(sqrtxz2, -1)
                    + (-1) * 51.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 129.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 2) * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    ...
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * z * pow(sqrtxz2, -1)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 31.0 / 16.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1)
                    + (-1) * 11.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 29.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 3.0 / 32.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 0
                )
                tmp += (
                    +(-1) * 1.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + 7.0 / 32.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, -1) * pow(sqrtxz2, -1)
                    + (-1) * 5.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 151.0 / 16.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * pow(sqrtxz2, -1)
                    + 51.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * z * pow(sqrtxz2, -1)
                    + (-1) * 51.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * x * pow(z, 2) * pow(sqrtxz2, -1)
                    + (-1) * 129.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 2) * pow(sqrtxz2, -1)
                    + 129.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 2) * z * pow(sqrtxz2, -1)
                    + (-1) * 9.0 / 16.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + (-1) * 3.0 / 8.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1)
                    + (-1) * 193.0 / 32.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 3) * pow(sqrtxz2, -1)
                    ...
                    + (-1) * 3.0 / 32.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * NC * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2)
                    + 2 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * x
                    + 0
                )
                tmp += (
                    +(-1) * 2 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 6 * Li2(1 - x * pow(z, -1)) * NC * x
                    + 6 * Li2(1 - x * pow(z, -1)) * NC * pow(x, 2)
                    + 4 * Li2(-x) * pow(NC, -1) * x
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * x * z
                    + 4 * Li2(-x) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * Li2(-x) * NC * x * z
                    + 4 * Li2(-x) * NC * pow(x, 2) * z
                    + 2 * Li2(x) * pow(NC, -1) * x
                    + 4 * Li2(x) * pow(NC, -1) * x * z
                    + (-1) * 2 * Li2(x) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 2 * Li2(x) * pow(NC, -1) * pow(x, 2) * z
                    + 18 * Li2(x) * NC * x
                    + (-1) * 4 * Li2(x) * NC * x * z
                    + (-1) * 2 * Li2(x) * NC * pow(x, 2)
                    + 2 * Li2(x) * NC * pow(x, 2) * z
                    + (-1) * 8 * Li2(z) * pow(NC, -1) * x
                    + 8 * Li2(z) * pow(NC, -1) * pow(x, 2)
                    + 8 * Li2(z) * NC * x
                    + (-1) * 8 * Li2(z) * NC * pow(x, 2)
                    + 0
                )
            if "001" == order:
            ...
            if "010" == order:
                ...
                tmp += LMUF * pow(NC, -1) * x * z + (-1) * 2 * LMUF * pow(NC, -1) * pow(x, 2) * z + (-1) * 4.0 / 3.0 * LMUF * NC * pow(x, -1) + 4 * LMUF * NC + (-1) * LMUF * NC * z + 38.0 / 3.0 * LMUF * NC * x + (-1) * LMUF * NC * x * z + (-1) * 46.0 / 3.0 * LMUF * NC * pow(x, 2) + 2 * LMUF * NC * pow(x, 2) * z + 4.0 / 3.0 * LMUF * NF * x + (-1) * 4.0 / 3.0 * LMUF * NF * pow(x, 2) + 0
            ...
            if "100" == order:
                tmp += 22.0 / 3.0 * LMUR * NC * x + (-1) * 22.0 / 3.0 * LMUR * NC * pow(x, 2) + (-1) * 4.0 / 3.0 * LMUR * NF * x + 4.0 / 3.0 * LMUR * NF * pow(x, 2) + 0
            res += tmp

        return res


def C2Lg2qEq(x, z, rsl, order, f=C2Lg2qEq_DR0123_scheme):
    if rsl == "ll":
