        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 8 * ln(z) * ln(xmz) * pow(NC, -1) * x * z * CF
                    + 12 * ln(omx) * pow(NC, -1) * x * z * CF
                    + (-1) * 8 * pow(ln(omx), 2) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 8 * pow(ln(omx), 2) * pow(NC, -1) * x * CF
                    + 10 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 8 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF
                    + 20 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF
                    + 12 * ln(omz) * pow(NC, -1) * x * z * CF
                    + (-1) * 2 * pow(ln(omz), 2) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 2 * pow(ln(omz), 2) * pow(NC, -1) * x * CF
                    + 8 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF
                    + 4 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x * CF
                    + (-1) * 4 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * CF
                    + 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * z * CF
                    + 4 * Li2(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(z) * pow(NC, -1) * x * CF
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) < round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + 20 * ln(x) * ln(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 20 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                    + (-1) * 44 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                    + 20 * ln(x) * ln(omx) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 20 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                    + (-1) * 32 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                    + 16 * ln(x) * ln(omz) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 16 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
                    + (-1) * 40 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * ln(x) * ln(xmz) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 4 * ln(x) * ln(xmz) * pow(NC, -1) * x * CF
                    + 8 * ln(x) * ln(xmz) * pow(NC, -1) * x * z * CF
                    + 16 * ln(z) * pow(NC, -1) * x * z * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x * CF
                    + (-1) * 4 * Li2(pow(x, -1) * z * omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * CF
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * CF
                    + (-1) * 8 * ln(z) * ln(-xmz) * pow(NC, -1) * x * z * CF
                    + (-1) * 10 * pow(ln(z), 2) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 10 * pow(ln(z), 2) * pow(NC, -1) * x * CF
                    + 20 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF
                    + (-1) * 20 * ln(z) * ln(omx) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 20 * ln(z) * ln(omx) * pow(NC, -1) * x * CF
                    + 24 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * ln(z) * ln(omz) * pow(NC, -1) * x * CF * pow(omz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * CF
                    + 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * Li2(x * pow(z, -1) * pow(omx, -1) * omz) * pow(NC, -1) * x * CF * pow(omz, -1)
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals) and round(z, ndecimals) > round(x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + 24 * ln(x) * ln(omx) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 24 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                    + (-1) * 40 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                    + 12 * ln(x) * ln(omz) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 12 * ln(x) * ln(omz) * pow(NC, -1) * x * CF
                    + (-1) * 32 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF
                    + 16 * ln(z) * pow(NC, -1) * x * z * CF
                    + 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * CF
                    + (-1) * 8 * ln(z) * ln(-xmz) * pow(NC, -1) * x * z * CF
        ...
        if round(z, ndecimals) < round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 12 * ln(x) * NC * x * CF
                    + 12 * ln(x) * NC * x * z * CF
                    + (-1) * 14 * pow(ln(x), 2) * NC * x * z * CF
                    + 12 * ln(x) * ln(z) * NC * x * z * CF
                    + 24 * ln(x) * ln(omx) * NC * x * z * CF
                    + 24 * ln(x) * ln(omz) * NC * x * z * CF
                    + (-1) * 4 * ln(x) * ln(omxmz) * NC * x * z * CF
                    + 4 * ln(z) * NC * x * CF
                    + (-1) * 4 * ln(z) * NC * x * z * CF
                    + (-1) * 2 * pow(ln(z), 2) * NC * x * z * CF
                    + (-1) * 8 * ln(z) * ln(omx) * NC * x * z * CF
                    + (-1) * 8 * ln(z) * ln(omz) * NC * x * z * CF
                    + 8 * ln(omx) * NC * x * CF
                    + (-1) * 8 * ln(omx) * NC * x * z * CF
                    + (-1) * 8 * pow(ln(omx), 2) * NC * x * z * CF
                    + (-1) * 20 * ln(omx) * ln(omz) * NC * x * z * CF
                    + 8 * ln(omz) * NC * x * CF
                    + (-1) * 8 * ln(omz) * NC * x * z * CF
                    + (-1) * 10 * pow(ln(omz), 2) * NC * x * z * CF
                    + 4 * ln(omz) * ln(omxmz) * NC * x * z * CF
                    + 4 * Li2(z * pow(omx, -1)) * NC * x * z * CF
                    + (-1) * 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * NC * x * z * CF
                    + (-1) * 4 * Li2(z) * NC * x * z * CF
                    + 0
                )
            res += tmp
        ...
        if round(z, ndecimals) > round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 8 * ln(omz) * NC * x * z * CF
                    + 4 * ln(omz) * ln(-omxmz) * NC * x * z * CF
                    + (-1) * 8 * pow(ln(omz), 2) * NC * x * z * CF
                    + 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * NC * x * z * CF
                    + (-1) * 4 * Li2(pow(z, -1) * omx) * NC * x * z * CF
                    + (-1) * 4 * Li2(z) * NC * x * z * CF
                    + 0
                )
            res += tmp
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(pi, 2) * CF * pow(opx, -1)
                    ...
                    + (-1) * pow(NC, -1) * pow(poly2, -1) * CF
                    + 21 * pow(NC, -1) * CF
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 36 * pow(NC, -1) * z * CF
                    + 4.0 / 3.0 * pow(NC, -1) * z * pow(pi, 2) * CF * pow(opx, -1)
                    + 8 * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 8 * pow(NC, -1) * x * pow(z, -1) * CF
                    + 4 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF
                    + (-1) * 8 * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 23 * pow(NC, -1) * x * CF
                    + 8 * pow(NC, -1) * x * pow(rln2, 2) * CF
                    + 12 * pow(NC, -1) * x * sqrtxz1 * rln2 * CF
                    + (-1) * 2 * pow(NC, -1) * x * pow(pi, 2) * CF * pow(omz, -1)
                    ...
                    + pow(NC, -1) * pow(x, 2) * CF
                    + (-1) * pow(NC, -1) * pow(x, 3) * pow(poly2, -1) * CF
                    + (-1) * 2 * pow(NC, -1) * pow(x, 3) * CF * pow(xmz, -1)
                    + pow(NC, -1) * pow(x, 4) * pow(poly2, -1) * CF
                    + 20.0 / 9.0 * pow(x, -1) * CF
                    + (-1) * 4.0 / 3.0 * pow(x, -1) * z * pow(pi, 2) * CF * pow(opx, -1)
                    + 4.0 / 3.0 * pow(x, -1) * z * pow(pi, 2) * CF
                    + 8.0 / 3.0 * pow(x, -1) * pow(z, 2) * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 8.0 / 3.0 * pow(x, -1) * pow(z, 2) * pow(pi, 2) * CF
                    + (-1) * 56.0 / 3.0 * CF
                    + 20 * z * CF
                ...
                tmp += (
                    ...
                    + (-1) * 2 * x * z * pow(pi, 2) * CF
                    + (-1) * 7 * x * pow(z, 2) * CF
                    + (-1) * 32 * x * pow(z, 2) * pow(rln2, 2) * CF
                    + 8.0 / 3.0 * x * pow(z, 2) * pow(pi, 2) * CF
                    + 88.0 / 9.0 * pow(x, 2) * CF
                    + (-1) * 4.0 / 3.0 * NC * z * CF
                    + 20.0 / 9.0 * NC * x * z * CF
                    + (-1) * 4 * NC * x * z * pow(pi, 2) * CF
                    + 2 * NC * pow(x, 2) * CF * pow(xmz, -1)
                    + 2 * NC * pow(x, 2) * CF
                    + (-1) * 2 * NC * pow(x, 3) * CF * pow(xmz, -1)
                    + 4.0 / 3.0 * NF * z * CF
                    + (-1) * 32.0 / 9.0 * NF * x * z * CF
                ...
                tmp += (
                    +(-1) * 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * rln2 * CF
                    + (-1) * 12 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * sqrtxz1 * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * pow(NC, -1) * x * pow(z, 3) * CF * pow(xmz, -2)
                    + 3.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(poly2, -2) * CF
                    + 3 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(poly2, -1) * CF
                    + 10 * ln(x) * pow(NC, -1) * pow(x, 2) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 3) * pow(poly2, -2) * CF
                    + (-1) * 5.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 3) * pow(poly2, -1) * CF
                    + (-1) * 2 * ln(x) * pow(NC, -1) * pow(x, 3) * CF * pow(xmz, -2)
                    + (-1) * 18 * ln(x) * pow(NC, -1) * pow(x, 3) * CF * pow(xmz, -1)
                    ...
                    + (-1) * 3.0 / 2.0 * ln(x) * pow(NC, -1) * pow(x, 6) * pow(poly2, -2) * CF
                    + (-1) * 16 * ln(x) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 16 * ln(x) * pow(x, -1) * z * CF
                    + 32 * ln(x) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 32 * ln(x) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * ln(x) * CF
                    + (-1) * 16 * ln(x) * z * CF * pow(opx, -1)
                    + 9 * ln(x) * z * CF
                    + 32 * ln(x) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 3 * ln(x) * x * CF
                    + (-1) * 4 * ln(x) * x * sqrtxz1 * CF
                    + ln(x) * x * z * CF
                    + 8 * ln(x) * x * z * rln2 * CF
                    + (-1) * 4 * ln(x) * x * pow(z, 2) * CF
                    + (-1) * 32 * ln(x) * x * pow(z, 2) * rln2 * CF
                    + (-1) * 4 * ln(x) * pow(x, 2) * CF * pow(xmz, -1)
                    + (-1) * 12 * ln(x) * pow(x, 2) * CF
                ...
                tmp += (
                    +(-1) * 2 * ln(x) * NC * pow(x, 3) * CF * pow(xmz, -2)
                    + (-1) * 2 * ln(x) * NC * pow(x, 3) * CF * pow(xmz, -1)
                    + 2 * ln(x) * NC * pow(x, 4) * CF * pow(xmz, -2)
                    + (-1) * 8.0 / 3.0 * ln(x) * NF * x * z * CF
                    + 3.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 3.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + 47.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 36 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1) * CF
                    + 36 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + 4 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + 9 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 18 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 5.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 3.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 8 * ln(x) * ln(1 - sqrtxz2 + x) * x * pow(sqrtxz2, -1) * CF
                    + 32 * ln(x) * ln(1 - sqrtxz2 + x) * x * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 32 * ln(x) * ln(1 - sqrtxz2 + x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 8 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + 16 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + 3.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 3.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 47.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF
                    + 36 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 36 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 4 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 9 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + 18 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 5.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 2 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 3.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 32 * ln(x) * ln(1 + sqrtxz2 + x) * x * z * pow(sqrtxz2, -1) * CF
                    + 32 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 - z) * x * z * CF
                    + 16 * ln(x) * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * CF
                    + 16 * ln(x) * ln(1 + sqrtxz1 + z) * x * pow(z, 2) * CF
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * z * CF
                    + (-1) * 8 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(1 + x * pow(z, -1)) * pow(z, 2) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(1 + x * pow(z, -1)) * x * pow(z, 2) * CF
                    + (-1) * 8 * ln(x) * ln(1 + x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 16 * ln(x) * ln(1 + x) * pow(NC, -1) * x * CF
                    + (-1) * 8 * ln(x) * ln(1 + x) * pow(NC, -1) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(1 + x) * x * CF
                    + 24 * ln(x) * ln(1 + x) * x * z * CF
                    + (-1) * 16 * ln(x) * ln(1 + x) * x * pow(z, 2) * CF
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(x, -1) * z * CF
                    + (-1) * 8 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, 2) * CF
                    + 4 * ln(x) * ln(1 + x * z) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(1 + x * z) * pow(z, 2) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 16 * ln(x) * ln(1 + x * z) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(x) * ln(z + x) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(z + x) * pow(NC, -1) * x * z * CF
                    + 4 * ln(x) * ln(z + x) * x * z * CF
                    + 8 * ln(x) * ln(z + x) * x * pow(z, 2) * CF
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 28 * ln(x) * ln(omx) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 28 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                    + 44 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                    + 8 * ln(x) * ln(omx) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * pow(x, -1) * z * CF
                    + (-1) * 16 * ln(x) * ln(omx) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 16 * ln(x) * ln(omx) * pow(x, -1) * pow(z, 2) * CF
                    + 8 * ln(x) * ln(omx) * z * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * ln(omx) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(omx) * x * z * CF
                    + (-1) * 16 * ln(x) * ln(omx) * x * pow(z, 2) * CF
                    ...
                    + (-1) * 26 * ln(x) * ln(omz) * NC * x * z * CF
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * x * CF
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(opx) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * pow(x, -1) * z * CF
                    + 16 * ln(x) * ln(opx) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * ln(opx) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 8 * ln(x) * ln(opx) * z * CF * pow(opx, -1)
                    + 16 * ln(x) * ln(opx) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(opx) * x * z * CF
                    + 16 * ln(x) * ln(opx) * x * pow(z, 2) * CF
                    + 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, -1) * pow(poly2, -2) * CF
                    + (-1) * 5.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, -1) * pow(poly2, -1) * CF
                    + ln(z) * pow(NC, -1) * pow(x, -1) * CF
                    + 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(poly2, -2) * CF
                    + (-1) * 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(poly2, -1) * CF
                    + 10 * ln(z) * pow(NC, -1) * CF
                    + (-1) * 9 * ln(z) * pow(NC, -1) * z * CF
                    + 16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 18 * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 2 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 3.0 / 2.0 * ln(z) * pow(NC, -1) * x * pow(poly2, -2) * CF
                    + (-1) * 3 * ln(z) * pow(NC, -1) * x * pow(poly2, -1) * CF
                    + (-1) * 16 * ln(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 21 * ln(z) * pow(NC, -1) * x * CF
                    + 12 * ln(z) * pow(NC, -1) * x * rln2 * CF
                    + 6 * ln(z) * pow(NC, -1) * x * sqrtxz1 * CF
                    + (-1) * 25 * ln(z) * pow(NC, -1) * x * z * CF
                    + 12 * ln(z) * pow(NC, -1) * x * z * rln2 * CF
                    + 4 * ln(z) * pow(NC, -1) * x * pow(z, 3) * CF * pow(xmz, -2)
                    + (-1) * 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(poly2, -2) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 3 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(poly2, -1) * CF
                    + (-1) * 10 * ln(z) * pow(NC, -1) * pow(x, 2) * CF
                    + (-1) * 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(poly2, -2) * CF
                    + (-1) * 5.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 3) * pow(poly2, -1) * CF
                    + 2 * ln(z) * pow(NC, -1) * pow(x, 3) * CF * pow(xmz, -2)
                    + 18 * ln(z) * pow(NC, -1) * pow(x, 3) * CF * pow(xmz, -1)
                    + (-1) * 3.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 4) * pow(poly2, -2) * CF
                    + (-1) * 7.0 / 2.0 * ln(z) * pow(NC, -1) * pow(x, 4) * pow(poly2, -1) * CF
                    + (-1) * 6 * ln(z) * pow(NC, -1) * pow(x, 4) * CF * pow(xmz, -2)
                ...
                tmp += (
                    +(-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 36 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * ln(z) * ln(omz) * x * CF
                    + 8 * ln(z) * ln(omz) * x * z * CF
                    + 12 * ln(z) * ln(omz) * NC * x * z * CF
                    + (-1) * 2 * ln(omx) * pow(NC, -1) * z * CF
                    + (-1) * 2 * ln(omx) * pow(NC, -1) * x * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 8 * pow(ln(omx), 2) * pow(NC, -1) * x * CF
                    + (-1) * 12 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF
                    + 10 * pow(ln(omx), 2) * NC * x * z * CF
                    + 8 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 8 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF
                    + (-1) * 20 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF
                    ...
                    + 2 * ln(omz) * NC * z * CF
                    + (-1) * 6 * ln(omz) * NC * x * CF
                    + (-1) * 10.0 / 3.0 * ln(omz) * NC * x * z * CF
                    + 4.0 / 3.0 * ln(omz) * NF * x * z * CF
                    + 2 * pow(ln(omz), 2) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 2 * pow(ln(omz), 2) * pow(NC, -1) * x * CF
                    + (-1) * 12 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF
                    ...
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 0
                )
                tmp += (
                    +3.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + 47.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 36 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * z * pow(sqrtxz2, -1) * CF
                    + 36 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 18 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 5.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 3.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(sqrtxz2, -1) * CF
                    + 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 3.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 47.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF
                    + 36 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 36 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + (-1) * 9 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + 18 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 5.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                ...
                tmp += (
                    +(-1) * 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * z * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 3.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 3.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                ...
                tmp += (
                    +(-1) * 47.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF
                    + 36 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 36 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + (-1) * 9 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + 18 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 5.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    ...
                    + (-1) * 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * z * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    +3.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 3.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF * pow(omz, -1)
                    + 47.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 36 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * z * pow(sqrtxz2, -1) * CF
                    + 36 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * pow(z, -1) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 18 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 5.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 3.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(NC, -1) * pow(x, 7) * pow(sqrtxz2, -1) * pow(poly2, -2) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(sqrtxz2, -1) * CF
                    + 32 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 32 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 8 * Li2(1 - x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    ...
                    + (-1) * 8 * Li2(1 - x * pow(z, -1)) * x * z * CF
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(x, -1) * z * CF
                    + (-1) * 8 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF
                    + 4 * Li2(-x * pow(z, -1)) * z * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x * pow(z, -1)) * pow(z, 2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * Li2(-x * z) * pow(x, -1) * z * CF
                    + (-1) * 8 * Li2(-x * z) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * Li2(-x * z) * pow(x, -1) * pow(z, 2) * CF
                    + 4 * Li2(-x * z) * z * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x * z) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 16 * Li2(-x * z) * x * pow(z, 2) * CF
                    ...
                    + 4 * Li2(x) * x * CF
                    + 8 * Li2(x) * x * z * CF
                    + (-1) * 16 * Li2(x) * x * pow(z, 2) * CF
                    + 2 * Li2(x) * NC * x * z * CF
                    + 4 * Li2(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(z) * pow(NC, -1) * x * CF
                    + (-1) * 14 * Li2(z) * pow(NC, -1) * x * z * CF
                    + (-1) * 2 * Li2(z) * x * CF
                    + 12 * Li2(z) * x * z * CF
                    + 6 * Li2(z) * NC * x * z * CF
                    + 0
            ...
            if "010" == order:
                tmp += 2 * LMUF * pow(NC, -1) * z * CF + LMUF * pow(NC, -1) * x * z * CF + (-1) * 4.0 / 3.0 * LMUF * pow(x, -1) * CF + 4 * LMUF * CF + (-1) * 8.0 / 3.0 * LMUF * pow(x, 2) * CF + (-1) * 2 * LMUF * NC * z * CF + (-1) * LMUF * NC * x * z * CF + 0
            ...
            if "100" == order:
                tmp += 22.0 / 3.0 * LMUR * NC * x * z * CF + (-1) * 4.0 / 3.0 * LMUR * NF * x * z * CF + 0
            res += tmp

        return res


def C2Lq2qEq(x, z, rsl, order, f=C2Lq2qEq_DR0123_scheme):
    if rsl == "ll":
