...
def C2Tq2qEqp_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    res = 0.0
    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    +(-1) * 5.0 / 8.0 * pow(x, -1) * pow(z, -1) * CF
                    + 5.0 / 8.0 * pow(x, -1) * CF
                    + (-1) * 5.0 / 8.0 * pow(z, -2) * CF
                    + (-1) * 15.0 / 4.0 * pow(z, -1) * CF
                    + 15.0 / 4.0 * CF
                    + 5.0 / 8.0 * z * CF
                    + 5.0 / 8.0 * x * pow(z, -2) * CF
                    + 15.0 / 4.0 * x * pow(z, -1) * CF
                    + (-1) * 15.0 / 4.0 * x * CF
                    + (-1) * 5.0 / 8.0 * x * z * CF
                    + 5.0 / 8.0 * pow(x, 2) * pow(z, -1) * CF
                    + (-1) * 5.0 / 8.0 * pow(x, 2) * CF
                    ...
                    + 5.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(x, 2) * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(x, -2) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(x, -1) * pow(z, -1) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(x, -1) * z * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(z, -2) * sqrtxz3 * CF
                    + (-1) * 13.0 / 2.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(z, 2) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * x * pow(z, -1) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * x * z * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(x, 2) * sqrtxz3 * CF
                    + (-1) * 5.0 / 16.0 * InvTanInt(-sqrtxz3) * pow(x, -2) * sqrtxz3 * CF
                    + (-1) * 9.0 / 8.0 * InvTanInt(-sqrtxz3) * pow(x, -1) * pow(z, -1) * sqrtxz3 * CF
                    + 0
                )
                tmp += (
                    +(-1) * 9.0 / 8.0 * InvTanInt(-sqrtxz3) * pow(x, -1) * z * sqrtxz3 * CF
                    + (-1) * 5.0 / 16.0 * InvTanInt(-sqrtxz3) * pow(z, -2) * sqrtxz3 * CF
                    + (-1) * 13.0 / 4.0 * InvTanInt(-sqrtxz3) * sqrtxz3 * CF
                    + (-1) * 5.0 / 16.0 * InvTanInt(-sqrtxz3) * pow(z, 2) * sqrtxz3 * CF
                    + (-1) * 9.0 / 8.0 * InvTanInt(-sqrtxz3) * x * pow(z, -1) * sqrtxz3 * CF
                    + (-1) * 9.0 / 8.0 * InvTanInt(-sqrtxz3) * x * z * sqrtxz3 * CF
                    + (-1) * 5.0 / 16.0 * InvTanInt(-sqrtxz3) * pow(x, 2) * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * InvTanInt(z * sqrtxz3) * pow(x, -2) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * InvTanInt(z * sqrtxz3) * pow(x, -1) * pow(z, -1) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * InvTanInt(z * sqrtxz3) * pow(x, -1) * z * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * InvTanInt(z * sqrtxz3) * pow(z, -2) * sqrtxz3 * CF
                    + (-1) * 13.0 / 2.0 * InvTanInt(z * sqrtxz3) * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * InvTanInt(z * sqrtxz3) * pow(z, 2) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * InvTanInt(z * sqrtxz3) * x * pow(z, -1) * sqrtxz3 * CF
                    + (-1) * 9.0 / 4.0 * InvTanInt(z * sqrtxz3) * x * z * sqrtxz3 * CF
                    + (-1) * 5.0 / 8.0 * InvTanInt(z * sqrtxz3) * pow(x, 2) * sqrtxz3 * CF
                    ...
                    + 5.0 / 16.0 * InvTanInt(sqrtxz3) * pow(x, 2) * sqrtxz3 * CF
                    + 5.0 / 16.0 * ln(x) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 5.0 / 16.0 * ln(x) * pow(x, -1) * CF
                    + (-1) * 5.0 / 16.0 * ln(x) * pow(z, -2) * CF
                    + (-1) * 17.0 / 8.0 * ln(x) * pow(z, -1) * CF
                    + 17.0 / 8.0 * ln(x) * CF
                    + 5.0 / 16.0 * ln(x) * z * CF
                    + 0
                )
                tmp += (
                    +(-1) * 5.0 / 16.0 * ln(x) * x * pow(z, -2) * CF
                    + (-1) * 17.0 / 8.0 * ln(x) * x * pow(z, -1) * CF
                    + 17.0 / 8.0 * ln(x) * x * CF
                    + 5.0 / 16.0 * ln(x) * x * z * CF
                    + 5.0 / 16.0 * ln(x) * pow(x, 2) * pow(z, -1) * CF
                    + (-1) * 5.0 / 16.0 * ln(x) * pow(x, 2) * CF
                    + (-1) * 2 * ln(x) * ln(z) * pow(z, -1) * CF
                    + (-1) * 2 * ln(x) * ln(z) * CF
                    + (-1) * 2 * ln(x) * ln(z) * x * pow(z, -1) * CF
                    + (-1) * 2 * ln(x) * ln(z) * x * CF
                    + (-1) * 5.0 / 16.0 * ln(z) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 5.0 / 16.0 * ln(z) * pow(x, -1) * CF
                    + 5.0 / 16.0 * ln(z) * pow(z, -2) * CF
                    + (-1) * 17.0 / 8.0 * ln(z) * pow(z, -1) * CF
                    + (-1) * 17.0 / 8.0 * ln(z) * CF
                    + 5.0 / 16.0 * ln(z) * z * CF
                    + (-1) * 5.0 / 16.0 * ln(z) * x * pow(z, -2) * CF
                    + 17.0 / 8.0 * ln(z) * x * pow(z, -1) * CF
                    + 17.0 / 8.0 * ln(z) * x * CF
                    + (-1) * 5.0 / 16.0 * ln(z) * x * z * CF
                    + 5.0 / 16.0 * ln(z) * pow(x, 2) * pow(z, -1) * CF
                    + 5.0 / 16.0 * ln(z) * pow(x, 2) * CF
                    + 0
                )
            res += tmp
...
def c2tq2q_eqp_(x, z, rsl, order, f=C2Tq2qEqp_DR0123_scheme):
    if rsl == "ll":
