...
def C2Tq2qbEq_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    ...
    if cx == "D" and cz == "R":
        ...
        if "000" == order:
            res += (
                ...
                + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(rln2, 3) * CF
                + (-1) * 1.0 / 12.0 * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * rln2 * CF * pow(opz, -1)
                + 1.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * rln2 * CF
                + (-1) * 1.0 / 4.0 * pow(NC, -1) * z * CF
                + 2.0 / 3.0 * pow(NC, -1) * z * pow(rln2, 3) * CF
                + (-1) * 1.0 / 12.0 * pow(NC, -1) * z * pow(pi, 2) * CF
                + (-1) * 1.0 / 3.0 * pow(NC, -1) * z * pow(pi, 2) * rln2 * CF
                ...
                + (-1) * 2 * ln(1 + z) * pow(NC, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                + ln(1 + z) * pow(NC, -1) * pow(rln2, 2) * CF
                + 1.0 / 3.0 * ln(1 + z) * pow(NC, -1) * pow(pi, 2) * CF * pow(opz, -1)
                + (-1) * 1.0 / 6.0 * ln(1 + z) * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * ln(1 + z) * pow(NC, -1) * z * pow(rln2, 2) * CF
                + 1.0 / 6.0 * ln(1 + z) * pow(NC, -1) * z * pow(pi, 2) * CF
                + (-1) * 7.0 / 4.0 * ln(z) * pow(NC, -1) * CF
            ...
            res += (
                ...
                + (-1) * 2 * ln(omz) * ln(1 + z) * pow(NC, -1) * rln2 * CF
                + 2 * ln(omz) * ln(1 + z) * pow(NC, -1) * z * rln2 * CF
                + (-1) * 2 * ln(omz) * pow(ln(1 + z), 2) * pow(NC, -1) * CF * pow(opz, -1)
                + ln(omz) * pow(ln(1 + z), 2) * pow(NC, -1) * CF
                + (-1) * ln(omz) * pow(ln(1 + z), 2) * pow(NC, -1) * z * CF
                ...
                + (-1) * 2 * ln(omz) * Li2(-z) * pow(NC, -1) * CF
                + 2 * ln(omz) * Li2(-z) * pow(NC, -1) * z * CF
                + (-1) * ln(omz) * Li2(z) * CF
                + (-1) * ln(omz) * Li2(z) * z * CF
                + 2.0 / 3.0 * ln(opz) * pow(NC, -1) * pow(pi, 2) * CF * pow(opz, -1)
                + (-1) * 1.0 / 3.0 * ln(opz) * pow(NC, -1) * pow(pi, 2) * CF
                + 1.0 / 3.0 * ln(opz) * pow(NC, -1) * z * pow(pi, 2) * CF
                + (-1) * 4 * Li3(1.0 / 2.0 - 1.0 / 2.0 * z) * pow(NC, -1) * CF * pow(opz, -1)
                + 2 * Li3(1.0 / 2.0 - 1.0 / 2.0 * z) * pow(NC, -1) * CF
                + 0
            )
            res += (
                +(-1) * 2 * Li3(1.0 / 2.0 - 1.0 / 2.0 * z) * pow(NC, -1) * z * CF
                + (-1) * 4 * Li3(1.0 / 2.0 + 1.0 / 2.0 * z) * pow(NC, -1) * CF * pow(opz, -1)
                + 2 * Li3(1.0 / 2.0 + 1.0 / 2.0 * z) * pow(NC, -1) * CF
                + (-1) * 2 * Li3(1.0 / 2.0 + 1.0 / 2.0 * z) * pow(NC, -1) * z * CF
                ...
                + (-1) * 2 * Li3(1 / (1 + z)) * pow(NC, -1) * CF
                + 2 * Li3(1 / (1 + z)) * pow(NC, -1) * z * CF
                + (-1) * 4 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * pow(NC, -1) * CF * pow(opz, -1)
                + 2 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * pow(NC, -1) * CF
                + (-1) * 2 * Li3(1 / (1 + z) - 1 / (1 + z) * z) * pow(NC, -1) * z * CF
                + 2 * Li3(z) * pow(NC, -1) * CF * pow(opz, -1)
                + (-1) * Li3(z) * pow(NC, -1) * CF
                + Li3(z) * pow(NC, -1) * z * CF
                + (-1) * 2 * Li3(z) * CF
        ...
        if "001" == order:
            res += (
                2 * LMUA * pow(NC, -1) * CF
                + (-1) * 1.0 / 3.0 * LMUA * pow(NC, -1) * pow(pi, 2) * CF * pow(opz, -1)
                + 1.0 / 6.0 * LMUA * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * 2 * LMUA * pow(NC, -1) * z * CF
                + (-1) * 1.0 / 6.0 * LMUA * pow(NC, -1) * z * pow(pi, 2) * CF
            ...
            res += (
                ...
                + (-1) * 4 * ln(z) * ln(1 + z) * LMUA * pow(NC, -1) * CF * pow(opz, -1)
                + 2 * ln(z) * ln(1 + z) * LMUA * pow(NC, -1) * CF
                + (-1) * 2 * ln(z) * ln(1 + z) * LMUA * pow(NC, -1) * z * CF
                + pow(ln(z), 2) * LMUA * pow(NC, -1) * CF * pow(opz, -1)
                + (-1) * 1.0 / 2.0 * pow(ln(z), 2) * LMUA * pow(NC, -1) * CF
                + 1.0 / 2.0 * pow(ln(z), 2) * LMUA * pow(NC, -1) * z * CF
                + (-1) * pow(ln(z), 2) * LMUA * CF
                + (-1) * pow(ln(z), 2) * LMUA * z * CF
                + 0
            )
            res += (-1) * 2.0 / 3.0 * ln(omz) * LMUA * pow(z, -1) * CF + (-1) * 1.0 / 2.0 * ln(omz) * LMUA * CF + 1.0 / 2.0 * ln(omz) * LMUA * z * CF + 2.0 / 3.0 * ln(omz) * LMUA * pow(z, 2) * CF + 0
            res += (-1) * 4 * Li2(-z) * LMUA * pow(NC, -1) * CF * pow(opz, -1) + 2 * Li2(-z) * LMUA * pow(NC, -1) * CF + (-1) * 2 * Li2(-z) * LMUA * pow(NC, -1) * z * CF + Li2(z) * LMUA * CF + Li2(z) * LMUA * z * CF + 0
        if "002" == order:
            res += 1.0 / 3.0 * pow(LMUA, 2) * pow(z, -1) * CF + 1.0 / 4.0 * pow(LMUA, 2) * CF + (-1) * 1.0 / 4.0 * pow(LMUA, 2) * z * CF + (-1) * 1.0 / 3.0 * pow(LMUA, 2) * pow(z, 2) * CF + 0
            res += 1.0 / 2.0 * ln(z) * pow(LMUA, 2) * CF + 1.0 / 2.0 * ln(z) * pow(LMUA, 2) * z * CF + 0
        return res
    ...
    if cx == "0" and cz == "R":
        ...
        if "000" == order:
            res += (
                ...
                + (-1) * 2 * ln(z) * ln(1 + z) * pow(NC, -1) * CF
                + 2 * ln(z) * ln(1 + z) * pow(NC, -1) * z * CF
                + (-1) * pow(ln(z), 2) * pow(NC, -1) * CF * pow(opz, -1)
        ...
        if "001" == order:
            res += (-1) * 2.0 / 3.0 * LMUA * pow(z, -1) * CF + (-1) * 1.0 / 2.0 * LMUA * CF + 1.0 / 2.0 * LMUA * z * CF + 2.0 / 3.0 * LMUA * pow(z, 2) * CF + (-1) * ln(z) * LMUA * CF + (-1) * ln(z) * LMUA * z * CF + 0
        return res
    ...
    if cx == "R" and cz == "D":
        ...
        if "000" == order:
            res += (
                +(-1) * 15.0 / 4.0 * pow(NC, -1) * CF
                + 2 * pow(NC, -1) * zeta3 * CF * pow(opx, -1)
                + (-1) * pow(NC, -1) * zeta3 * CF
                + 4.0 / 3.0 * pow(NC, -1) * pow(rln2, 3) * CF * pow(opx, -1)
                + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(rln2, 3) * CF
                + (-1) * 1.0 / 12.0 * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * rln2 * CF * pow(opx, -1)
                + 1.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * rln2 * CF
                + 15.0 / 4.0 * pow(NC, -1) * x * CF
                + pow(NC, -1) * x * zeta3 * CF
                + 2.0 / 3.0 * pow(NC, -1) * x * pow(rln2, 3) * CF
                + (-1) * 1.0 / 12.0 * pow(NC, -1) * x * pow(pi, 2) * CF
                + (-1) * 1.0 / 3.0 * pow(NC, -1) * x * pow(pi, 2) * rln2 * CF
                ...
                + (-1) * 2 * ln(1 + x) * pow(NC, -1) * pow(rln2, 2) * CF * pow(opx, -1)
                + ln(1 + x) * pow(NC, -1) * pow(rln2, 2) * CF
                + (-1) * 1.0 / 3.0 * ln(1 + x) * pow(NC, -1) * pow(pi, 2) * CF * pow(opx, -1)
                + 1.0 / 6.0 * ln(1 + x) * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * ln(1 + x) * pow(NC, -1) * x * pow(rln2, 2) * CF
                + (-1) * 1.0 / 6.0 * ln(1 + x) * pow(NC, -1) * x * pow(pi, 2) * CF
                + 2.0 / 3.0 * pow(ln(1 + x), 3) * pow(NC, -1) * CF * pow(opx, -1)
                + (-1) * 1.0 / 3.0 * pow(ln(1 + x), 3) * pow(NC, -1) * CF
                + 0
            )
            res += (
                +1.0 / 3.0 * pow(ln(1 + x), 3) * pow(NC, -1) * x * CF
                + (-1) * 3.0 / 4.0 * ln(x) * pow(NC, -1) * CF
                + (-1) * 2.0 / 3.0 * ln(x) * pow(NC, -1) * pow(pi, 2) * CF * pow(opx, -1)
                + 1.0 / 3.0 * ln(x) * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * 19.0 / 4.0 * ln(x) * pow(NC, -1) * x * CF
                + (-1) * 1.0 / 3.0 * ln(x) * pow(NC, -1) * x * pow(pi, 2) * CF
                + 23.0 / 6.0 * ln(x) * CF
                ...
                + (-1) * 4 * pow(ln(x), 2) * ln(1 + x) * pow(NC, -1) * CF * pow(opx, -1)
                + 2 * pow(ln(x), 2) * ln(1 + x) * pow(NC, -1) * CF
                + (-1) * 2 * pow(ln(x), 2) * ln(1 + x) * pow(NC, -1) * x * CF
                + 1.0 / 2.0 * pow(ln(x), 3) * pow(NC, -1) * CF * pow(opx, -1)
                + (-1) * 1.0 / 4.0 * pow(ln(x), 3) * pow(NC, -1) * CF
            ...
            res += (
                ...
                + (-1) * 2 * ln(omx) * ln(1 + x) * pow(NC, -1) * rln2 * CF
                + 2 * ln(omx) * ln(1 + x) * pow(NC, -1) * x * rln2 * CF
                + (-1) * 2 * ln(omx) * pow(ln(1 + x), 2) * pow(NC, -1) * CF * pow(opx, -1)
                + ln(omx) * pow(ln(1 + x), 2) * pow(NC, -1) * CF
                + (-1) * ln(omx) * pow(ln(1 + x), 2) * pow(NC, -1) * x * CF
            ...
            res += (
                ...
                + (-1) * 2 * ln(omx) * Li2(-x) * pow(NC, -1) * CF
                + 2 * ln(omx) * Li2(-x) * pow(NC, -1) * x * CF
                + (-1) * ln(omx) * Li2(x) * CF
                + (-1) * ln(omx) * Li2(x) * x * CF
                + ln(opx) * pow(NC, -1) * pow(pi, 2) * CF * pow(opx, -1)
                + (-1) * 1.0 / 2.0 * ln(opx) * pow(NC, -1) * pow(pi, 2) * CF
                + 1.0 / 2.0 * ln(opx) * pow(NC, -1) * x * pow(pi, 2) * CF
                + (-1) * 4 * Li3(1.0 / 2.0 - 1.0 / 2.0 * x) * pow(NC, -1) * CF * pow(opx, -1)
                + 2 * Li3(1.0 / 2.0 - 1.0 / 2.0 * x) * pow(NC, -1) * CF
                + (-1) * 2 * Li3(1.0 / 2.0 - 1.0 / 2.0 * x) * pow(NC, -1) * x * CF
                + (-1) * 4 * Li3(1.0 / 2.0 + 1.0 / 2.0 * x) * pow(NC, -1) * CF * pow(opx, -1)
                + 2 * Li3(1.0 / 2.0 + 1.0 / 2.0 * x) * pow(NC, -1) * CF
                + (-1) * 2 * Li3(1.0 / 2.0 + 1.0 / 2.0 * x) * pow(NC, -1) * x * CF
                + 4 * Li3(1 - x) * pow(NC, -1) * CF * pow(opx, -1)
                + (-1) * 2 * Li3(1 - x) * pow(NC, -1) * CF
                + 2 * Li3(1 - x) * pow(NC, -1) * x * CF
                + (-1) * Li3(1 - x) * CF
                + (-1) * Li3(1 - x) * x * CF
                + (-1) * 4 * Li3(1 / (1 + x) - 1 / (1 + x) * x) * pow(NC, -1) * CF * pow(opx, -1)
                + 2 * Li3(1 / (1 + x) - 1 / (1 + x) * x) * pow(NC, -1) * CF
                + (-1) * 2 * Li3(1 / (1 + x) - 1 / (1 + x) * x) * pow(NC, -1) * x * CF
        ...
        if "010" == order:
            res += (
                2 * LMUF * pow(NC, -1) * CF
                + (-1) * 1.0 / 3.0 * LMUF * pow(NC, -1) * pow(pi, 2) * CF * pow(opx, -1)
                + 1.0 / 6.0 * LMUF * pow(NC, -1) * pow(pi, 2) * CF
                + (-1) * 2 * LMUF * pow(NC, -1) * x * CF
                + (-1) * 1.0 / 6.0 * LMUF * pow(NC, -1) * x * pow(pi, 2) * CF
            ...
            res += (
                ...
                + (-1) * 4 * ln(x) * ln(1 + x) * LMUF * pow(NC, -1) * CF * pow(opx, -1)
                + 2 * ln(x) * ln(1 + x) * LMUF * pow(NC, -1) * CF
                + (-1) * 2 * ln(x) * ln(1 + x) * LMUF * pow(NC, -1) * x * CF
                + pow(ln(x), 2) * LMUF * pow(NC, -1) * CF * pow(opx, -1)
                + (-1) * 1.0 / 2.0 * pow(ln(x), 2) * LMUF * pow(NC, -1) * CF
                + 1.0 / 2.0 * pow(ln(x), 2) * LMUF * pow(NC, -1) * x * CF
                + pow(ln(x), 2) * LMUF * CF
                + pow(ln(x), 2) * LMUF * x * CF
                + 0
            )
            res += (-1) * 2.0 / 3.0 * ln(omx) * LMUF * pow(x, -1) * CF + (-1) * 1.0 / 2.0 * ln(omx) * LMUF * CF + 1.0 / 2.0 * ln(omx) * LMUF * x * CF + 2.0 / 3.0 * ln(omx) * LMUF * pow(x, 2) * CF + 0
            res += (-1) * 4 * Li2(-x) * LMUF * pow(NC, -1) * CF * pow(opx, -1) + 2 * Li2(-x) * LMUF * pow(NC, -1) * CF + (-1) * 2 * Li2(-x) * LMUF * pow(NC, -1) * x * CF + Li2(x) * LMUF * CF + Li2(x) * LMUF * x * CF + 0
        if "020" == order:
            res += 1.0 / 3.0 * pow(LMUF, 2) * pow(x, -1) * CF + 1.0 / 4.0 * pow(LMUF, 2) * CF + (-1) * 1.0 / 4.0 * pow(LMUF, 2) * x * CF + (-1) * 1.0 / 3.0 * pow(LMUF, 2) * pow(x, 2) * CF + 0
            res += 1.0 / 2.0 * ln(x) * pow(LMUF, 2) * CF + 1.0 / 2.0 * ln(x) * pow(LMUF, 2) * x * CF + 0
        return res
    ...
    if cx == "R" and cz == "0":
        ...
        if "000" == order:
            res += (
                ...
                + (-1) * ln(x) * pow(NC, -1) * CF
                + (-1) * ln(x) * pow(NC, -1) * x * CF
                + ln(x) * CF
                + 3 * ln(x) * x * CF
                + 2 * ln(x) * pow(x, 2) * CF
                + 4 * ln(x) * ln(1 + x) * pow(NC, -1) * CF * pow(opx, -1)
                + (-1) * 2 * ln(x) * ln(1 + x) * pow(NC, -1) * CF
                + 2 * ln(x) * ln(1 + x) * pow(NC, -1) * x * CF
                + (-1) * pow(ln(x), 2) * pow(NC, -1) * CF * pow(opx, -1)
                + 1.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * CF
                + (-1) * 1.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * x * CF
                + (-1) * pow(ln(x), 2) * CF
                + (-1) * pow(ln(x), 2) * x * CF
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 8 * pow(NC, -1) * pow(z, -1) * pow(rln2, 2) * CF * pow(omx, -1)
                    + 16 * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 16 * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1)
                    + 12 * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(rln2, 2) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 12 * pow(NC, -1) * pow(z, -1) * sqrtxz1 * pow(rln2, 2) * CF * pow(omx, -1)
                    + 1.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(omx, -1)
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(omz, -1) * pow(opx, -1)
                    + 2.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 1.0 / 6.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF
                    + 2.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 16 * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 32 * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + 64 * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 64 * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 12 * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(omx, -1) * pow(opz, -1)
                    + 24 * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(omx, -1)
                    + 48 * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + (-1) * 48 * pow(NC, -1) * pow(sqrtxz1, -1) * pow(rln2, 2) * CF
                    + (-1) * 8 * pow(NC, -1) * CF
                    + 6 * pow(NC, -1) * pow(rln2, 2) * CF * pow(omx, -1)
                    + (-1) * 2 * pow(NC, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1)
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 8.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 1.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 1.0 / 2.0 * pow(NC, -1) * pow(pi, 2) * CF * pow(omx, -1)
                    + 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 1.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF * pow(opx, -1)
                    + 2.0 / 3.0 * pow(NC, -1) * pow(pi, 2) * CF
                    + (-1) * 16 * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 16 * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * 12 * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(omx, -1) * pow(opz, -1)
                    + 12 * pow(NC, -1) * z * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(omx, -1)
                    + 10 * pow(NC, -1) * z * CF
                    + (-1) * 6 * pow(NC, -1) * z * pow(rln2, 2) * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2.0 / 3.0 * pow(NC, -1) * z * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 7.0 / 2.0 * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 8 * pow(NC, -1) * x * pow(z, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + 8 * pow(NC, -1) * x * pow(z, -1) * pow(rln2, 2) * CF
                    + (-1) * 16 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + 16 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 12 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(rln2, 2) * CF * pow(opz, -1)
                    ...
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * sqrtxz1 * CF * pow(opz, -1)
                    + 2.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * sqrtxz1 * CF
                    + (-1) * 48 * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 32 * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 36 * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + 24 * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(rln2, 2) * CF
                    + 7 * pow(NC, -1) * x * CF
                    + (-1) * 8 * pow(NC, -1) * x * pow(rln2, 2) * CF
                    + (-1) * 2 * pow(NC, -1) * x * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 16 * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + 12 * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 12 * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * pow(rln2, 2) * CF
                    + (-1) * 19.0 / 2.0 * pow(NC, -1) * x * z * CF
                    + 8 * pow(NC, -1) * x * z * pow(rln2, 2) * CF
                    + 2.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF
                    + 64 * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 64 * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF
                    + 48 * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + (-1) * 48 * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * pow(rln2, 2) * CF
                    + 8.0 / 3.0 * pow(NC, -1) * pow(x, 2) * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8.0 / 3.0 * pow(NC, -1) * pow(x, 2) * pow(pi, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 1.0 / 3.0 * pow(x, -2) * pow(pi, 2) * CF * pow(opx, -1)
                    + 1.0 / 3.0 * pow(x, -2) * pow(pi, 2) * CF
                    + 2.0 / 3.0 * pow(x, -2) * z * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 2.0 / 3.0 * pow(x, -2) * z * pow(pi, 2) * CF
                    + (-1) * 4.0 / 3.0 * pow(x, -2) * pow(z, 2) * pow(pi, 2) * CF * pow(opx, -1)
                    + 4.0 / 3.0 * pow(x, -2) * pow(z, 2) * pow(pi, 2) * CF
                    + 13.0 / 9.0 * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 26.0 / 9.0 * pow(x, -1) * CF
                    + (-1) * 1.0 / 3.0 * pow(x, -1) * pow(pi, 2) * CF
                    + 2.0 / 3.0 * pow(x, -1) * z * pow(pi, 2) * CF
                    + (-1) * 4.0 / 3.0 * pow(x, -1) * pow(z, 2) * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 71.0 / 36.0 * pow(z, -1) * CF
                    + 1.0 / 6.0 * pow(z, -1) * pow(pi, 2) * CF
                    + (-1) * 26.0 / 3.0 * CF
                    + (-1) * 6 * pow(rln2, 2) * CF * pow(omx, -1)
                    + (-1) * 6 * sqrtxz1 * rln2 * CF * pow(omx, -1)
                    + 5.0 / 6.0 * pow(pi, 2) * CF * pow(omx, -1)
                    + 2.0 / 3.0 * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 1.0 / 6.0 * pow(pi, 2) * CF
                    + 157.0 / 12.0 * z * CF
                    + (-1) * 4 * z * pow(rln2, 2) * CF * pow(omx, -1)
                    + 8 * z * pow(rln2, 2) * CF
                    + (-1) * 5.0 / 3.0 * z * pow(pi, 2) * CF * pow(omx, -1)
                    + (-1) * 4.0 / 3.0 * z * pow(pi, 2) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2.0 / 3.0 * z * pow(pi, 2) * CF
                    + 43.0 / 18.0 * pow(z, 2) * CF
                    + (-1) * 16 * pow(z, 2) * pow(rln2, 2) * CF * pow(omx, -1)
                    ...
                    + 4 * x * pow(rln2, 2) * CF
                    + 4 * x * sqrtxz1 * rln2 * CF
                    + (-1) * 5.0 / 6.0 * x * pow(pi, 2) * CF
                    + (-1) * 119.0 / 12.0 * x * z * CF
                    + 1.0 / 3.0 * x * z * pow(pi, 2) * CF
                    + (-1) * 77.0 / 18.0 * x * pow(z, 2) * CF
                    + 16 * x * pow(z, 2) * pow(rln2, 2) * CF
                    + (-1) * 4.0 / 3.0 * x * pow(z, 2) * pow(pi, 2) * CF
                    + (-1) * 22.0 / 9.0 * pow(x, 2) * pow(z, -1) * CF
                    + 44.0 / 9.0 * pow(x, 2) * CF
                    + 8 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3 * CF
                    + (-1) * 3 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(x, -1) * z * sqrtxz3 * CF
                    + 3 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * sqrtxz3 * CF
                    + 23 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(z, 2) * sqrtxz3 * CF
                    + (-1) * 3 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * x * z * sqrtxz3 * CF
                    + (-1) * 8 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3 * CF
                    + 3 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(x, -1) * z * sqrtxz3 * CF
                    + (-1) * 3 * ArcTan(sqrtxz3) * ln(sqrtxz3) * sqrtxz3 * CF
                    + (-1) * 23 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(z, 2) * sqrtxz3 * CF
                    + 3 * ArcTan(sqrtxz3) * ln(sqrtxz3) * x * z * sqrtxz3 * CF
                    + 0
                )
                tmp += (
                    +(-1) * 4 * InvTanInt(-sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3 * CF
                    ...
                    + (-1) * 8 * InvTanInt(z * sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3 * CF
                    + 3 * InvTanInt(z * sqrtxz3) * pow(x, -1) * z * sqrtxz3 * CF
                    + (-1) * 3 * InvTanInt(z * sqrtxz3) * sqrtxz3 * CF
                    + (-1) * 23 * InvTanInt(z * sqrtxz3) * pow(z, 2) * sqrtxz3 * CF
                    ...
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 6 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * rln2 * CF * pow(omx, -1)
                    + 2 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + 6 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * rln2 * CF * pow(omx, -1)
                    + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + 48 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 48 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * rln2 * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * rln2 * CF
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    ...
                    + (-1) * 12 * ln(1 + sqrtxz1 - z) * z * rln2 * CF
                    + 24 * ln(1 + sqrtxz1 - z) * pow(z, 2) * rln2 * CF * pow(omx, -1)
                    + (-1) * 6 * ln(1 + sqrtxz1 - z) * x * rln2 * CF
                    + (-1) * 4 * ln(1 + sqrtxz1 - z) * x * sqrtxz1 * CF
                    + 4 * ln(1 + sqrtxz1 - z) * x * z * rln2 * CF
                    + (-1) * 24 * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * rln2 * CF
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +16 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 12 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 16 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + 6 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 6 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * CF
                    + 0
                )
                tmp += (
                    +8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 16 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * 32 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + 6 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * rln2 * CF * pow(omx, -1)
                    + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                    + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + 24 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * rln2 * CF
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * rln2 * CF
                    + (-1) * 32 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    ...
                    + (-1) * 4 * ln(1 + sqrtxz1 + z) * z * rln2 * CF
                    + 8 * ln(1 + sqrtxz1 + z) * pow(z, 2) * rln2 * CF * pow(omx, -1)
                    + (-1) * 2 * ln(1 + sqrtxz1 + z) * x * rln2 * CF
                    + (-1) * 4 * ln(1 + sqrtxz1 + z) * x * z * rln2 * CF
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(1 + sqrtxz1 + z) * x * pow(z, 2) * rln2 * CF
                    + pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 4 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 3 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 4 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 8 * ln(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + 8 * ln(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + 8 * ln(x) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * pow(NC, -1) * pow(x, -2) * CF
                    + 8 * ln(x) * pow(NC, -1) * pow(x, -2) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * pow(NC, -1) * pow(x, -2) * z * CF
                    + (-1) * 8 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 1.0 / 2.0 * ln(x) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * CF * pow(omx, -1)
                    + 4 * ln(x) * CF * pow(opx, -1)
                    + (-1) * 7.0 / 2.0 * ln(x) * CF
                    + (-1) * 5 * ln(x) * rln2 * CF * pow(omx, -1)
                    + (-1) * 2 * ln(x) * rln2 * CF
                    + (-1) * 3 * ln(x) * sqrtxz1 * CF * pow(omx, -1)
                    ...
                    + (-1) * 16 * ln(x) * pow(z, 2) * rln2 * CF * pow(omx, -1)
                    + 11.0 / 3.0 * ln(x) * x * pow(z, -1) * CF
                    + (-1) * ln(x) * x * CF * pow(xmz, -1)
                    + (-1) * 17.0 / 2.0 * ln(x) * x * CF
                    + 4 * ln(x) * x * rln2 * CF
                    + 2 * ln(x) * x * sqrtxz1 * CF
                    + 13.0 / 2.0 * ln(x) * x * z * CF
                    + (-1) * 4 * ln(x) * x * z * rln2 * CF
                    + (-1) * 8.0 / 3.0 * ln(x) * x * pow(z, 2) * CF
                    + 16 * ln(x) * x * pow(z, 2) * rln2 * CF
                    + 2 * ln(x) * pow(x, 2) * pow(z, -1) * CF
                    + 2 * ln(x) * pow(x, 2) * CF * pow(xmz, -1)
                    + (-1) * 5.0 / 2.0 * ln(x) * pow(x, 2) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * pow(x, 3) * pow(poly2, -1) * CF
                    + (-1) * 2 * ln(x) * pow(x, 3) * CF * pow(xmz, -1)
                    + 1.0 / 2.0 * ln(x) * pow(x, 4) * pow(poly2, -1) * CF
                    + 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(sqrtxz2, -1) * CF
                    + (-1) * ln(x) * ln(1 - sqrtxz2 + x) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 3.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * x * pow(sqrtxz2, -1) * CF
                    + 4 * ln(x) * ln(1 - sqrtxz2 + x) * x * z * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(x) * ln(1 - sqrtxz2 + x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 4.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 1.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(sqrtxz2, -1) * CF
                    + ln(x) * ln(1 + sqrtxz2 + x) * z * pow(sqrtxz2, -1) * CF
                    + 1.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz2 + x) * x * z * pow(sqrtxz2, -1) * CF
                    + 4 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 1.0 / 4.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 16 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 12 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 16 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 3 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * CF * pow(omx, -1)
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 3 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 12 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * CF
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * CF
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -2) * pow(z, 2) * CF
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x) * pow(NC, -1) * CF * pow(opx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x) * z * CF
                    + 8 * ln(x) * ln(1 + x) * pow(z, 2) * CF * pow(opx, -1)
                    + 6 * ln(x) * ln(1 + x) * x * CF
                    + (-1) * 12 * ln(x) * ln(1 + x) * x * z * CF
                    + 8 * ln(x) * ln(1 + x) * x * pow(z, 2) * CF
                    + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * CF * pow(opx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * CF
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(x, -2) * pow(z, 2) * CF
                    ...
                    + (-1) * 2 * ln(x) * ln(z + x) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 2 * ln(x) * ln(z + x) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * ln(x) * ln(z + x) * pow(NC, -1) * CF * pow(omx, -1)
                    + 2 * ln(x) * ln(z + x) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 2 * ln(x) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 2 * ln(x) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(z + x) * x * pow(z, 2) * CF
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 1.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 12 * pow(ln(x), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +12 * pow(ln(x), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 2 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + pow(ln(x), 2) * pow(NC, -1) * CF * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + pow(ln(x), 2) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + pow(ln(x), 2) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 7.0 / 2.0 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 9 * pow(ln(x), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + pow(ln(x), 2) * pow(NC, -1) * x * CF
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 12 * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 6 * pow(ln(x), 2) * pow(x, -2) * pow(z, 2) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 2 * pow(ln(x), 2) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * pow(ln(x), 2) * x * pow(z, -1) * CF
                    + (-1) * pow(ln(x), 2) * x * CF
                    + 6 * pow(ln(x), 2) * x * z * CF
                    + (-1) * 4 * pow(ln(x), 2) * x * pow(z, 2) * CF
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * CF
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * z * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -2) * z * CF
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +2 * ln(x) * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 8 * ln(x) * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * CF
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 6 * ln(x) * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + ln(x) * ln(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(z) * pow(x, -2) * pow(z, 2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * ln(x) * ln(z) * pow(z, 2) * CF * pow(opx, -1)
                    + ln(x) * ln(z) * x * pow(z, -1) * CF
                    + 2 * ln(x) * ln(z) * x * CF
                    + 2 * ln(x) * ln(z) * x * z * CF
                    + 4 * ln(x) * ln(z) * x * pow(z, 2) * CF
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +4 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * CF
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 3 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                    ...
                    + (-1) * 8 * ln(x) * ln(omx) * pow(x, -2) * pow(z, 2) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 8 * ln(x) * ln(opx) * pow(x, -2) * pow(z, 2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 8 * ln(x) * ln(opx) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(opx) * x * CF
                    + 4 * ln(x) * ln(opx) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(opx) * x * pow(z, 2) * CF
                    + 12 * ln(z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 12 * ln(z) * pow(NC, -1) * pow(z, -1) * rln2 * CF * pow(omx, -1)
                    + 8 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 8 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +16 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 16 * ln(z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1)
                    + (-1) * 8 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 16 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 32 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 32 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + 64 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 64 * ln(z) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF
                    + ln(z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * ln(z) * pow(NC, -1) * CF * pow(omz, -1)
                    + (-1) * ln(z) * pow(NC, -1) * CF
                    + 9 * ln(z) * pow(NC, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * ln(z) * pow(NC, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 8 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 16 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 16 * ln(z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + ln(z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 2 * ln(z) * pow(NC, -1) * z * CF
                    + (-1) * 9 * ln(z) * pow(NC, -1) * z * rln2 * CF * pow(omx, -1)
                    + (-1) * 12 * ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF * pow(opz, -1)
                    + 12 * ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                    + (-1) * 8 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 24 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 48 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 32 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + ln(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + ln(z) * pow(NC, -1) * x * CF
                    + (-1) * 12 * ln(z) * pow(NC, -1) * x * rln2 * CF
                    + 8 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 16 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 2 * ln(z) * pow(NC, -1) * x * z * CF
                    + 12 * ln(z) * pow(NC, -1) * x * z * rln2 * CF
                    + 32 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 64 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 64 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF
                    + 2.0 / 3.0 * ln(z) * pow(x, -1) * pow(z, -1) * CF
                    + 1.0 / 2.0 * ln(z) * pow(x, -1) * pow(poly2, -1) * CF
                    + 2.0 / 3.0 * ln(z) * pow(x, -1) * CF * pow(omz, -1)
                    + (-1) * 11.0 / 6.0 * ln(z) * pow(x, -1) * CF
                    + 1.0 / 6.0 * ln(z) * pow(z, -1) * CF
                    + 1.0 / 2.0 * ln(z) * pow(poly2, -1) * CF
                    + 3 * ln(z) * CF * pow(omx, -1)
                    + (-1) * ln(z) * CF * pow(omz, -1)
                    + (-1) * 7 * ln(z) * CF
                    + (-1) * 7 * ln(z) * rln2 * CF * pow(omx, -1)
                    + 2 * ln(z) * rln2 * CF
                    + (-1) * 3 * ln(z) * sqrtxz1 * CF * pow(omx, -1)
                    + 3 * ln(z) * z * CF * pow(omx, -1)
                    + 5 * ln(z) * z * CF
                    + (-1) * 10 * ln(z) * z * rln2 * CF * pow(omx, -1)
                    + 8 * ln(z) * z * rln2 * CF
                    + (-1) * 2.0 / 3.0 * ln(z) * pow(z, 2) * CF
                    + (-1) * 16 * ln(z) * pow(z, 2) * rln2 * CF * pow(omx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 1.0 / 6.0 * ln(z) * pow(x, 2) * CF
                    + (-1) * 1.0 / 2.0 * ln(z) * pow(x, 3) * pow(poly2, -1) * CF
                    + 2 * ln(z) * pow(x, 3) * CF * pow(xmz, -1)
                    + (-1) * 1.0 / 2.0 * ln(z) * pow(x, 4) * pow(poly2, -1) * CF
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 32 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 3 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * CF * pow(omx, -1)
                    + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 3 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 24 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * CF
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * CF
                    + (-1) * 32 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * CF
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * CF
                    + (-1) * 32 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 + z) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(z) * ln(1 + z) * pow(NC, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 2 * ln(z) * ln(1 + z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * CF
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z * CF * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * z * CF
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    ...
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -2) * pow(z, 2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * ln(z) * ln(1 + x * pow(z, -1)) * x * CF
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * x * z * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * x * pow(z, 2) * CF
                    + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * CF
                    ...
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(x, -2) * pow(z, 2) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 2 * ln(z) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 2 * ln(z) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 2 * ln(z) * ln(z + x) * pow(NC, -1) * x * CF
                ...
                tmp += (
                    ...
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 5 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 5 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 5 * pow(ln(z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 10 * pow(ln(z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 20 * pow(ln(z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 20 * pow(ln(z), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + pow(ln(z), 2) * pow(NC, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 1.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * CF * pow(omx, -1)
                    + pow(ln(z), 2) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 5 * pow(ln(z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 5 * pow(ln(z), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 1.0 / 2.0 * pow(ln(z), 2) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + pow(ln(z), 2) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 3 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 5 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +5 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 15 * pow(ln(z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 10 * pow(ln(z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * pow(ln(z), 2) * pow(NC, -1) * x * CF
                    + 5 * pow(ln(z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 5 * pow(ln(z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 3 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF
                    + 20 * pow(ln(z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 20 * pow(ln(z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 2 * pow(ln(z), 2) * pow(x, -2) * pow(z, 2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * pow(ln(z), 2) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 3 * pow(ln(z), 2) * x * CF
                    + 2 * pow(ln(z), 2) * x * z * CF
                    + (-1) * 4 * pow(ln(z), 2) * x * pow(z, 2) * CF
                    + (-1) * ln(z) * ln(omx) * CF
                    + (-1) * ln(z) * ln(omx) * x * CF
                    + (-1) * 2 * ln(z) * ln(omx) * x * z * CF
                    + 4 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * ln(z) * ln(omz) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 4 * ln(z) * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +8 * ln(z) * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 16 * ln(z) * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * ln(z) * ln(omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * ln(z) * ln(omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 4 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 12 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * ln(z) * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * ln(z) * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 16 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * ln(z) * ln(omz) * CF * pow(omx, -1)
                    + 2 * ln(z) * ln(omz) * z * CF * pow(omx, -1)
                    + 2 * ln(z) * ln(omz) * x * CF
                    + (-1) * 4 * ln(z) * ln(omz) * x * z * CF
                    ...
                    + (-1) * 8 * ln(omz) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(omx, -1)
                    + (-1) * 8 * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +16 * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + 32 * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 32 * ln(omz) * pow(NC, -1) * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 8 * ln(omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * ln(omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * rln2 * CF * pow(omx, -1)
                    + (-1) * 8 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + 8 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 24 * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 16 * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + 8 * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + 32 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 32 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF
                    ...
                    + (-1) * 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 32 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 24 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 32 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 8 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 16 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 12 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 4 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 4 * pow(ln(omz), 2) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 4 * pow(ln(omz), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * pow(ln(omz), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 16 * pow(ln(omz), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * pow(ln(omz), 2) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * pow(ln(omz), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * pow(ln(omz), 2) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 4 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 12 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * pow(ln(omz), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * pow(ln(omz), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 16 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * z * pow(sqrtxz2, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                ...
                tmp += (
                    +(-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + 3 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 3 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 12 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 0
                )
                tmp += (
                    ...
                    + 16 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 3 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    ...
                    + 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * CF
                    + 16 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(sqrtxz2, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(sqrtxz2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * z * pow(sqrtxz2, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 1.0 / 4.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 3 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * CF * pow(omx, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 0
                )
                tmp += (
                    +4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 12 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * CF
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + 0
                )
                tmp += (
                    ...
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 3 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 12 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 2 * Li2(1 - x * pow(z, -1)) * x * CF
                    + 4 * Li2(1 - x * pow(z, -1)) * x * z * CF
                    + 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 16 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 32 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 0
                )
                tmp += (
                    +(-1) * 24 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1) * pow(opz, -1)
                    + (-1) * 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 16 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + 32 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 0
                )
                tmp += (
                    +8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * Li2(-z) * pow(NC, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 2 * Li2(-z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * Li2(-z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                    ...
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(x, -2) * pow(z, 2) * CF
                    ...
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * x * z * CF
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 4 * Li2(-x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + 4 * Li2(-x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * Li2(-x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    ...
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    ...
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 4 * Li2(-x) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * Li2(-x) * pow(NC, -1) * CF
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    ...
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +2 * Li2(-x * z) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -2) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * Li2(-x * z) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 2 * Li2(-x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * x * CF
                    ...
                    + (-1) * 4 * Li2(-x * z) * pow(x, -2) * pow(z, 2) * CF
                    + Li2(-x * z) * pow(x, -1) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(z, -1) * sqrtxz1 * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    ...
                    + (-1) * 16 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1) * pow(opz, -1)
                    + 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * z * pow(sqrtxz1, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 12 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 4 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 16 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 4 * Li2(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * pow(x, -2) * pow(z, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * Li2(x) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    ...
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + Li2(x) * pow(NC, -1) * pow(z, -1) * CF
                    + 4 * Li2(x) * pow(NC, -1) * CF * pow(omx, -1)
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 2 * Li2(x) * pow(NC, -1) * CF
                    + (-1) * 2 * Li2(x) * pow(NC, -1) * z * CF * pow(omx, -1)
                    + 4 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 3 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * x * CF * pow(omz, -1)
            ...
            if "001" == order:
                tmp += 1.0 / 3.0 * LMUA * pow(z, -1) * CF + 1.0 / 2.0 * LMUA * CF + (-1) * 3.0 / 2.0 * LMUA * z * CF + 2.0 / 3.0 * LMUA * pow(z, 2) * CF + 1.0 / 3.0 * LMUA * x * pow(z, -1) * CF + 3.0 / 2.0 * LMUA * x * CF + (-1) * 1.0 / 2.0 * LMUA * x * z * CF + (-1) * 4.0 / 3.0 * LMUA * x * pow(z, 2) * CF + 0
                tmp += ln(z) * LMUA * CF + ln(z) * LMUA * x * CF + 2 * ln(z) * LMUA * x * z * CF + 0
            if "010" == order:
                tmp += (-1) * 2.0 / 3.0 * LMUF * pow(x, -1) * pow(z, -1) * CF + 4.0 / 3.0 * LMUF * pow(x, -1) * CF + (-1) * 1.0 / 2.0 * LMUF * pow(z, -1) * CF + LMUF * CF + 1.0 / 2.0 * LMUF * x * pow(z, -1) * CF + (-1) * LMUF * x * CF + 2.0 / 3.0 * LMUF * pow(x, 2) * pow(z, -1) * CF + (-1) * 4.0 / 3.0 * LMUF * pow(x, 2) * CF + 0
                tmp += (-1) * ln(x) * LMUF * pow(z, -1) * CF + 2 * ln(x) * LMUF * CF + (-1) * ln(x) * LMUF * x * pow(z, -1) * CF + 2 * ln(x) * LMUF * x * CF + 0
            res += tmp

        return res


def c2tq2qb_eq(x, z, rsl, order, f=C2Tq2qbEq_DR0123_scheme):
    if rsl == "ll":
