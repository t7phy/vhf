        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    ...
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * pow(x, -1) * z * pow(pi, 2)
                    + 2 * pow(NC, -1)
                    + (-1) * 2 * pow(NC, -1) * z
                    + 4.0 / 3.0 * pow(NC, -1) * z * pow(pi, 2) * pow(opx, -1)
                    + (-1) * 2.0 / 3.0 * pow(NC, -1) * z * pow(pi, 2)
                    + (-1) * 8 * pow(NC, -1) * x * pow(z, -1)
                    + 14 * pow(NC, -1) * x
                    + (-1) * 8 * pow(NC, -1) * x * pow(rln2, 2)
                    + (-1) * 1.0 / 3.0 * pow(NC, -1) * x * pow(pi, 2)
                    + (-1) * 6 * pow(NC, -1) * x * z
                    ...
                    + (-1) * 16 * pow(NC, -1) * pow(x, 2)
                    + 8 * pow(NC, -1) * pow(x, 2) * pow(rln2, 2)
                    + 8 * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 8 * pow(NC, -1) * pow(x, 2) * z * pow(rln2, 2)
                    + 2.0 / 3.0 * pow(NC, -1) * pow(x, 2) * z * pow(pi, 2)
                    + 3.0 / 8.0 * NC * pow(x, -1) * pow(z, -1)
                    + (-1) * 3.0 / 8.0 * NC * pow(x, -1)
                    + 2.0 / 3.0 * NC * pow(x, -1) * pow(pi, 2) * pow(opx, -1)
                    + (-1) * 2.0 / 3.0 * NC * pow(x, -1) * pow(pi, 2)
                    + (-1) * 2.0 / 3.0 * NC * pow(x, -1) * z * pow(pi, 2) * pow(opx, -1)
                    + 2.0 / 3.0 * NC * pow(x, -1) * z * pow(pi, 2)
                    + 3.0 / 8.0 * NC * pow(z, -2)
                    + (-1) * 7.0 / 4.0 * NC * pow(z, -1)
                    + (-1) * 5.0 / 4.0 * NC
                    + 4.0 / 3.0 * NC * pow(pi, 2) * pow(opx, -1)
                    + (-1) * 2.0 / 3.0 * NC * pow(pi, 2)
                    + 21.0 / 8.0 * NC * z
                    + (-1) * 4.0 / 3.0 * NC * z * pow(pi, 2) * pow(opx, -1)
                    + 2.0 / 3.0 * NC * z * pow(pi, 2)
                    + (-1) * 3.0 / 8.0 * NC * x * pow(z, -2)
                    + (-1) * 25.0 / 4.0 * NC * x * pow(z, -1)
                    + (-1) * 8 * NC * x * pow(z, -1) * sqrtxz1 * rln2
                    + 5.0 / 4.0 * NC * x
                    + 2.0 / 3.0 * NC * x * pow(pi, 2) * pow(opx, -1)
                    + 1.0 / 3.0 * NC * x * pow(pi, 2)
                    + 43.0 / 8.0 * NC * x * z
                    + (-1) * 8 * NC * x * z * pow(rln2, 2)
                    + (-1) * 2.0 / 3.0 * NC * x * z * pow(pi, 2) * pow(opx, -1)
                ...
                tmp += (
                    +(-1) * 2.0 / 3.0 * NC * pow(x, 2) * z * pow(pi, 2)
                    + ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(NC, -1) * pow(x, -1) * z * sqrtxz3
                    + (-1) * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(NC, -1) * sqrtxz3
                    + 3 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                    + (-1) * 15 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                    + (-1) * 3.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                    + 1.0 / 4.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                    + (-1) * 7.0 / 4.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(x, -1) * z * sqrtxz3
                    + (-1) * 3.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(z, -2) * sqrtxz3
                    + (-1) * 7.0 / 2.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * sqrtxz3
                    + (-1) * 19.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(z, 2) * sqrtxz3
                    + (-1) * 15.0 / 4.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * x * pow(z, -1) * sqrtxz3
                    + 105.0 / 4.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * x * z * sqrtxz3
                    + (-1) * 35.0 / 8.0 * ArcTan(z * sqrtxz3) * ln(z * sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                    + 0
                )
                tmp += (
                    +(-1) * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * pow(x, -1) * z * sqrtxz3
                    + ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * sqrtxz3
                    + (-1) * 3 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                    + 15 * ArcTan(sqrtxz3) * ln(sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                    + 3.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                    + (-1) * 1.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                    ...
                    + (-1) * 105.0 / 4.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * x * z * sqrtxz3
                    + 35.0 / 8.0 * ArcTan(sqrtxz3) * ln(sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                    + (-1) * 1.0 / 2.0 * InvTanInt(-sqrtxz3) * pow(NC, -1) * pow(x, -1) * z * sqrtxz3
                    + 1.0 / 2.0 * InvTanInt(-sqrtxz3) * pow(NC, -1) * sqrtxz3
                    + (-1) * 3.0 / 2.0 * InvTanInt(-sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                    + 15.0 / 2.0 * InvTanInt(-sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                    + 3.0 / 16.0 * InvTanInt(-sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                    + (-1) * 1.0 / 8.0 * InvTanInt(-sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                    ...
                    + (-1) * 105.0 / 8.0 * InvTanInt(-sqrtxz3) * NC * x * z * sqrtxz3
                    + 0
                )
                tmp += (
                    +35.0 / 16.0 * InvTanInt(-sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                    + (-1) * InvTanInt(z * sqrtxz3) * pow(NC, -1) * pow(x, -1) * z * sqrtxz3
                    + InvTanInt(z * sqrtxz3) * pow(NC, -1) * sqrtxz3
                    + (-1) * 3 * InvTanInt(z * sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                    + 15 * InvTanInt(z * sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                    + 3.0 / 8.0 * InvTanInt(z * sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                    + (-1) * 1.0 / 4.0 * InvTanInt(z * sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                    ...
                    + (-1) * 105.0 / 4.0 * InvTanInt(z * sqrtxz3) * NC * x * z * sqrtxz3
                    + 35.0 / 8.0 * InvTanInt(z * sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                    + 1.0 / 2.0 * InvTanInt(sqrtxz3) * pow(NC, -1) * pow(x, -1) * z * sqrtxz3
                    + (-1) * 1.0 / 2.0 * InvTanInt(sqrtxz3) * pow(NC, -1) * sqrtxz3
                    + 3.0 / 2.0 * InvTanInt(sqrtxz3) * pow(NC, -1) * pow(z, 2) * sqrtxz3
                    + (-1) * 15.0 / 2.0 * InvTanInt(sqrtxz3) * pow(NC, -1) * x * z * sqrtxz3
                    + (-1) * 3.0 / 16.0 * InvTanInt(sqrtxz3) * NC * pow(x, -2) * sqrtxz3
                    + 1.0 / 8.0 * InvTanInt(sqrtxz3) * NC * pow(x, -1) * pow(z, -1) * sqrtxz3
                    + (-1) * 7.0 / 8.0 * InvTanInt(sqrtxz3) * NC * pow(x, -1) * z * sqrtxz3
                    + (-1) * 3.0 / 16.0 * InvTanInt(sqrtxz3) * NC * pow(z, -2) * sqrtxz3
                    + (-1) * 7.0 / 4.0 * InvTanInt(sqrtxz3) * NC * sqrtxz3
                    + (-1) * 19.0 / 16.0 * InvTanInt(sqrtxz3) * NC * pow(z, 2) * sqrtxz3
                    + (-1) * 15.0 / 8.0 * InvTanInt(sqrtxz3) * NC * x * pow(z, -1) * sqrtxz3
                    + 105.0 / 8.0 * InvTanInt(sqrtxz3) * NC * x * z * sqrtxz3
                    + (-1) * 35.0 / 16.0 * InvTanInt(sqrtxz3) * NC * pow(x, 2) * sqrtxz3
                    + 12 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * rln2
                    + 0
                )
                tmp += (
                    +(-1) * 12 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * rln2
                    + (-1) * 12 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * rln2
                    + 12 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z * rln2
                    + 8 * ln(1 + sqrtxz1 - z) * NC * x * pow(z, -1) * sqrtxz1
                    + (-1) * 4 * ln(1 + sqrtxz1 - z) * NC * x * rln2
                    + 12 * ln(1 + sqrtxz1 - z) * NC * x * z * rln2
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * pow(z, -1) * sqrtxz1
                    + 4 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * rln2
                    + (-1) * 12 * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * z * rln2
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * pow(ln(1 + sqrtxz1 - z), 2) * NC * x
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * NC * x * z
                    + (-1) * 4 * pow(ln(1 + sqrtxz1 - z), 2) * NC * pow(x, 2)
                    ...
                    + (-1) * 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * NC * x
                    + (-1) * 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * NC * x * z
                    + 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2)
                    + 4 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * z
                    + 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * rln2
                    + (-1) * 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * rln2
                    + (-1) * 4 * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * rln2
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * z
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2)
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * ln(x) * ln(1 + sqrtxz1 + z) * NC * x * z
                    + (-1) * 4 * ln(x) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * z
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * z
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * NC * z * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * z
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * x * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * x
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * x * z * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * x * z
                    + (-1) * 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2) * z
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * z * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * z
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * NC * pow(x, -1) * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * z) * NC * pow(x, -1)
                    + 2 * ln(x) * ln(1 + x * z) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * NC * pow(x, -1) * z
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * NC * pow(opx, -1)
                    + 2 * ln(x) * ln(1 + x * z) * NC
                    + 4 * ln(x) * ln(1 + x * z) * NC * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * NC * z
                    + (-1) * 2 * ln(x) * ln(1 + x * z) * NC * x * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * NC * x
                    + 2 * ln(x) * ln(1 + x * z) * NC * x * z * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * z) * NC * pow(x, 2) * z
                    + (-1) * 2 * ln(x) * ln(z + x) * pow(NC, -1) * x * z
                    + 2 * ln(x) * ln(z + x) * pow(NC, -1) * pow(x, 2) * z
                    + 2 * ln(x) * ln(z + x) * NC * x
                    + 2 * ln(x) * ln(z + x) * NC * x * z
                    + (-1) * 2 * ln(x) * ln(z + x) * NC * pow(x, 2)
                    + (-1) * 2 * ln(x) * ln(z + x) * NC * pow(x, 2) * z
                    + (-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * z
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * z * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * pow(NC, -1) * z
                    + pow(ln(x), 2) * pow(NC, -1) * x
                    + 0
                )
                tmp += (
                    +(-1) * 3 * pow(ln(x), 2) * pow(NC, -1) * x * z * pow(opx, -1)
                    + (-1) * pow(ln(x), 2) * pow(NC, -1) * x * z
                    + pow(ln(x), 2) * pow(NC, -1) * pow(x, 2)
                    + (-1) * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 3 * pow(ln(x), 2) * NC * pow(x, -1) * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * NC * pow(x, -1)
                    + 3 * pow(ln(x), 2) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 3 * pow(ln(x), 2) * NC * pow(x, -1) * z
                    + (-1) * 6 * pow(ln(x), 2) * NC * pow(opx, -1)
                    + 3 * pow(ln(x), 2) * NC
                    + 6 * pow(ln(x), 2) * NC * z * pow(opx, -1)
                    + (-1) * 3 * pow(ln(x), 2) * NC * z
                    + (-1) * 3 * pow(ln(x), 2) * NC * x * pow(opx, -1)
                    + (-1) * pow(ln(x), 2) * NC * x
                    + 3 * pow(ln(x), 2) * NC * x * z * pow(opx, -1)
                    + pow(ln(x), 2) * NC * x * z
                    + (-1) * pow(ln(x), 2) * NC * pow(x, 2)
                    + pow(ln(x), 2) * NC * pow(x, 2) * z
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * z
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * z
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * x
                    + 2 * ln(x) * ln(z) * pow(NC, -1) * x * z * pow(opx, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * x * z
                    + (-1) * 2 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * z
                    + 2 * ln(x) * ln(z) * NC * pow(x, -1) * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * NC * pow(x, -1)
                    + (-1) * 2 * ln(x) * ln(z) * NC * pow(x, -1) * z * pow(opx, -1)
                    + 2 * ln(x) * ln(z) * NC * pow(x, -1) * z
                    + 4 * ln(x) * ln(z) * NC * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(z) * NC
                    + (-1) * 4 * ln(x) * ln(z) * NC * z * pow(opx, -1)
                    + 2 * ln(x) * ln(z) * NC * z
                    + 2 * ln(x) * ln(z) * NC * x * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(z) * NC * x
                    + (-1) * 2 * ln(x) * ln(z) * NC * x * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(z) * NC * x * z
                    + 2 * ln(x) * ln(z) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(z) * NC * pow(x, 2) * z
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * z * pow(opx, -1)
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * z
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * x
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * x * z * pow(opx, -1)
                    + 2 * ln(x) * ln(omx) * pow(NC, -1) * x * z
                    + 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 2 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 4 * ln(x) * ln(omx) * NC * pow(x, -1) * pow(opx, -1)
                    + 4 * ln(x) * ln(omx) * NC * pow(x, -1)
                    + 4 * ln(x) * ln(omx) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * NC * pow(x, -1) * z
                    + (-1) * 8 * ln(x) * ln(omx) * NC * pow(opx, -1)
                    + 4 * ln(x) * ln(omx) * NC
                    + 8 * ln(x) * ln(omx) * NC * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * NC * z
                    + (-1) * 4 * ln(x) * ln(omx) * NC * x * pow(opx, -1)
                    + 2 * ln(x) * ln(omx) * NC * x
                    + 4 * ln(x) * ln(omx) * NC * x * z * pow(opx, -1)
                    + (-1) * 2 * ln(x) * ln(omx) * NC * x * z
                    + (-1) * 2 * ln(x) * ln(omx) * NC * pow(x, 2)
                    + 2 * ln(x) * ln(omx) * NC * pow(x, 2) * z
                    + (-1) * 2 * ln(x) * ln(omz) * pow(NC, -1) * x
                    + 2 * ln(x) * ln(omz) * pow(NC, -1) * x * z
                    + 2 * ln(x) * ln(omz) * NC * x
                    + (-1) * 2 * ln(x) * ln(omz) * NC * x * z
                    + 4 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * z
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(opx) * pow(NC, -1) * z
                    ...
                    + (-1) * 4 * ln(x) * ln(opx) * NC * pow(x, -1)
                    + (-1) * 4 * ln(x) * ln(opx) * NC * pow(x, -1) * z * pow(opx, -1)
                    + 4 * ln(x) * ln(opx) * NC * pow(x, -1) * z
                    + 8 * ln(x) * ln(opx) * NC * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(opx) * NC
                    + (-1) * 8 * ln(x) * ln(opx) * NC * z * pow(opx, -1)
                    + 4 * ln(x) * ln(opx) * NC * z
                ...
                tmp += (
                    +4 * ln(x) * ln(opx) * NC * x
                    + (-1) * 4 * ln(x) * ln(opx) * NC * x * z * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(opx) * NC * x * z
                    + 4 * ln(x) * ln(opx) * NC * pow(x, 2)
                    + (-1) * 4 * ln(x) * ln(opx) * NC * pow(x, 2) * z
                    + 1.0 / 2.0 * ln(z) * pow(NC, -1)
                    + 1.0 / 2.0 * ln(z) * pow(NC, -1) * z
                    + (-1) * 8 * ln(z) * pow(NC, -1) * x * pow(z, -1)
                    + (-1) * 9.0 / 2.0 * ln(z) * pow(NC, -1) * x
                    + (-1) * 8 * ln(z) * pow(NC, -1) * x * rln2
                    + (-1) * 1.0 / 2.0 * ln(z) * pow(NC, -1) * x * z
                    + 8 * ln(z) * pow(NC, -1) * x * z * rln2
                    + 8 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + 4 * ln(z) * pow(NC, -1) * pow(x, 2)
                    + 8 * ln(z) * pow(NC, -1) * pow(x, 2) * rln2
                    + (-1) * 8 * ln(z) * pow(NC, -1) * pow(x, 2) * z * rln2
                    + 3.0 / 16.0 * ln(z) * NC * pow(x, -1) * pow(z, -1)
                    + 3.0 / 16.0 * ln(z) * NC * pow(x, -1)
                    + (-1) * 3.0 / 16.0 * ln(z) * NC * pow(z, -2)
                    + (-1) * 1.0 / 8.0 * ln(z) * NC * pow(z, -1)
                    + (-1) * 17.0 / 8.0 * ln(z) * NC
                    + (-1) * 3.0 / 16.0 * ln(z) * NC * z
                    + 3.0 / 16.0 * ln(z) * NC * x * pow(z, -2)
                    + 49.0 / 8.0 * ln(z) * NC * x * pow(z, -1)
                    + (-1) * 4 * ln(z) * NC * x * pow(z, -1) * sqrtxz1
                    + 1.0 / 8.0 * ln(z) * NC * x
                    + (-1) * 4 * ln(z) * NC * x * rln2
                    + 3.0 / 16.0 * ln(z) * NC * x * z
                    + (-1) * 8 * ln(z) * NC * x * z * rln2
                    + (-1) * 99.0 / 16.0 * ln(z) * NC * pow(x, 2) * pow(z, -1)
                    ...
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2)
                    + 4 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * ln(z) * ln(1 + sqrtxz1 - z) * NC * x * z
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 - z) * NC * pow(x, 2) * z
                    + 4 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x
                    + 0
                )
                tmp += (
                    ...
                    + 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * x * z
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2)
                    + (-1) * 4 * ln(z) * ln(1 + sqrtxz1 + z) * NC * pow(x, 2) * z
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z
                    ...
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, -1) * z
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * NC * z * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * z
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * x * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * x
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * x * z * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * x * z
                    + 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2)
                    + (-1) * 2 * ln(z) * ln(1 + x * pow(z, -1)) * NC * pow(x, 2) * z
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * z * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * z
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * z * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * NC * pow(x, -1) * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * z) * NC * pow(x, -1)
                    + 2 * ln(z) * ln(1 + x * z) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * NC * pow(x, -1) * z
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * NC * pow(opx, -1)
                    + 2 * ln(z) * ln(1 + x * z) * NC
                    + 4 * ln(z) * ln(1 + x * z) * NC * z * pow(opx, -1)
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * NC * z
                    + (-1) * 2 * ln(z) * ln(1 + x * z) * NC * x * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * NC * x
                    + 2 * ln(z) * ln(1 + x * z) * NC * x * z * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * z) * NC * pow(x, 2) * z
                    + 2 * ln(z) * ln(z + x) * pow(NC, -1) * x * z
                    + (-1) * 2 * ln(z) * ln(z + x) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 2 * ln(z) * ln(z + x) * NC * x
                    + (-1) * 2 * ln(z) * ln(z + x) * NC * x * z
                    + 2 * ln(z) * ln(z + x) * NC * pow(x, 2)
                    + 2 * ln(z) * ln(z + x) * NC * pow(x, 2) * z
                    + pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * z
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * z * pow(opx, -1)
                    + (-1) * pow(ln(z), 2) * pow(NC, -1) * z
                    + (-1) * 4 * pow(ln(z), 2) * pow(NC, -1) * x
                    ...
                    + (-1) * pow(ln(z), 2) * NC * pow(x, -1)
                    + (-1) * pow(ln(z), 2) * NC * pow(x, -1) * z * pow(opx, -1)
                    + pow(ln(z), 2) * NC * pow(x, -1) * z
                    + 2 * pow(ln(z), 2) * NC * pow(opx, -1)
                    + (-1) * pow(ln(z), 2) * NC
                    + (-1) * 2 * pow(ln(z), 2) * NC * z * pow(opx, -1)
                    + pow(ln(z), 2) * NC * z
                ...
                tmp += (
                    +4 * pow(ln(z), 2) * NC * x
                    + (-1) * pow(ln(z), 2) * NC * x * z * pow(opx, -1)
                    + (-1) * 2 * pow(ln(z), 2) * NC * pow(x, 2)
                    + (-1) * 2 * pow(ln(z), 2) * NC * pow(x, 2) * z
                    + (-1) * 4 * ln(z) * ln(omx) * pow(NC, -1) * x
                    + 4 * ln(z) * ln(omx) * pow(NC, -1) * pow(x, 2)
                    + 4 * ln(z) * ln(omx) * NC * x
                    + (-1) * 4 * ln(z) * ln(omx) * NC * pow(x, 2)
                    + (-1) * ln(omx) * pow(NC, -1)
                    + ln(omx) * pow(NC, -1) * z
                    ...
                    + (-1) * 4 * ln(omx) * pow(NC, -1) * pow(x, 2) * z
                    + ln(omx) * NC
                    + (-1) * ln(omx) * NC * z
                    + 4 * ln(omx) * NC * x * pow(z, -1)
                    + (-1) * ln(omx) * NC * x
                    + (-1) * 3 * ln(omx) * NC * x * z
                    + (-1) * 4 * ln(omx) * NC * pow(x, 2) * pow(z, -1)
                    ...
                    + (-1) * 4 * ln(omz) * pow(NC, -1) * pow(x, 2) * z
                    + ln(omz) * NC
                    + (-1) * ln(omz) * NC * z
                    + 4 * ln(omz) * NC * x * pow(z, -1)
                    + (-1) * ln(omz) * NC * x
                    + (-1) * 3 * ln(omz) * NC * x * z
                    + (-1) * 4 * ln(omz) * NC * pow(x, 2) * pow(z, -1)
                    + 4 * ln(omz) * NC * pow(x, 2) * z
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * NC * x
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * NC * pow(x, 2)
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2)
                    + 0
                )
                tmp += (
                    +4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * NC * x * z
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * NC * pow(x, 2) * z
                    ...
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * NC * x * z
                    + 4 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * NC * pow(x, 2) * z
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * z * pow(opx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * z
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * z * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * z
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * NC * pow(x, -1) * pow(opx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * NC * pow(x, -1)
                    + 2 * Li2(-x * pow(z, -1)) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * NC * pow(x, -1) * z
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * NC * pow(opx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * NC
                    + 4 * Li2(-x * pow(z, -1)) * NC * z * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * NC * z
                    + (-1) * 2 * Li2(-x * pow(z, -1)) * NC * x * pow(opx, -1)
                    + 2 * Li2(-x * pow(z, -1)) * NC * x * z * pow(opx, -1)
                    + 4 * Li2(-x * pow(z, -1)) * NC * x * z
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * NC * pow(x, 2)
                    + 4 * Li2(-x) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 4 * Li2(-x) * pow(NC, -1) * pow(x, -1) * z
                    + 8 * Li2(-x) * pow(NC, -1) * z * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * Li2(-x) * pow(NC, -1) * z
                    + 4 * Li2(-x) * pow(NC, -1) * x * z * pow(opx, -1)
                    + 4 * Li2(-x) * pow(NC, -1) * x * z
                    + 4 * Li2(-x) * pow(NC, -1) * pow(x, 2) * z
                    + 4 * Li2(-x) * NC * pow(x, -1) * pow(opx, -1)
                    + (-1) * 4 * Li2(-x) * NC * pow(x, -1)
                    + (-1) * 4 * Li2(-x) * NC * pow(x, -1) * z * pow(opx, -1)
                    + 4 * Li2(-x) * NC * pow(x, -1) * z
                    + 8 * Li2(-x) * NC * pow(opx, -1)
                    + (-1) * 4 * Li2(-x) * NC
                    + (-1) * 8 * Li2(-x) * NC * z * pow(opx, -1)
                    + 4 * Li2(-x) * NC * z
                    + 4 * Li2(-x) * NC * x * pow(opx, -1)
                    + 4 * Li2(-x) * NC * x
                    + (-1) * 4 * Li2(-x) * NC * x * z * pow(opx, -1)
                    + (-1) * 4 * Li2(-x) * NC * x * z
                    + 4 * Li2(-x) * NC * pow(x, 2)
                    + (-1) * 4 * Li2(-x) * NC * pow(x, 2) * z
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 2 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * z
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * z * pow(opx, -1)
                    + 2 * Li2(-x * z) * pow(NC, -1) * z
                    + (-1) * 2 * Li2(-x * z) * pow(NC, -1) * x * z * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 2 * Li2(-x * z) * NC * pow(x, -1) * pow(opx, -1)
                    + 2 * Li2(-x * z) * NC * pow(x, -1)
                    + 2 * Li2(-x * z) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * z) * NC * pow(x, -1) * z
                    + (-1) * 4 * Li2(-x * z) * NC * pow(opx, -1)
                    + 2 * Li2(-x * z) * NC
                    + 4 * Li2(-x * z) * NC * z * pow(opx, -1)
                    + (-1) * 2 * Li2(-x * z) * NC * z
                    + (-1) * 2 * Li2(-x * z) * NC * x * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * z) * NC * x
                    + 2 * Li2(-x * z) * NC * x * z * pow(opx, -1)
                    + 4 * Li2(-x * z) * NC * pow(x, 2) * z
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * pow(x, -1) * z * pow(opx, -1)
                    + 4 * Li2(x) * pow(NC, -1) * pow(x, -1) * z
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * z * pow(opx, -1)
                    + 4 * Li2(x) * pow(NC, -1) * z
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * x * z * pow(opx, -1)
                    + 2 * Li2(x) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 2 * Li2(x) * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 4 * Li2(x) * NC * pow(x, -1) * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +4 * Li2(x) * NC * pow(x, -1)
                    + 4 * Li2(x) * NC * pow(x, -1) * z * pow(opx, -1)
                    + (-1) * 4 * Li2(x) * NC * pow(x, -1) * z
                    + (-1) * 8 * Li2(x) * NC * pow(opx, -1)
                    + 4 * Li2(x) * NC
                    + 8 * Li2(x) * NC * z * pow(opx, -1)
                    + (-1) * 4 * Li2(x) * NC * z
                    + (-1) * 4 * Li2(x) * NC * x * pow(opx, -1)
                    + 4 * Li2(x) * NC * x * z * pow(opx, -1)
                    + (-1) * 2 * Li2(x) * NC * pow(x, 2)
                    + 2 * Li2(x) * NC * pow(x, 2) * z
                    + 4 * Li2(z) * pow(NC, -1) * x
                    + (-1) * 4 * Li2(z) * pow(NC, -1) * pow(x, 2)
                    + (-1) * 4 * Li2(z) * NC * x
                    + 4 * Li2(z) * NC * pow(x, 2)
                    + 0
                )
            if "001" == order:
                tmp += (
                    ...
                    + (-1) * 2 * LMUA * pow(NC, -1) * x
                    + (-1) * 2 * LMUA * pow(NC, -1) * x * z
                    + (-1) * 4 * LMUA * pow(NC, -1) * pow(x, 2) * pow(z, -1)
                    + 2 * LMUA * pow(NC, -1) * pow(x, 2)
                    + 2 * LMUA * pow(NC, -1) * pow(x, 2) * z
                    + (-1) * 4 * LMUA * NC * x * pow(z, -1)
                    + 2 * LMUA * NC * x
                    + 2 * LMUA * NC * x * z
                    + 4 * LMUA * NC * pow(x, 2) * pow(z, -1)
                    + (-1) * 2 * LMUA * NC * pow(x, 2)
                    + (-1) * 2 * LMUA * NC * pow(x, 2) * z
                    + 0
                )
...
def C2Lg2gEq(x, z, rsl, order, f=C2Lg2gEq_DR0123_scheme):
    if rsl == "ll":
