...
def C2Lq2qbEq_DR0123_scheme(inx: float, inz: float, cx: str, cz: str, order: str, ndecimals=ndecimals, LMUR=LMUR, LMUF=LMUF, LMUA=LMUA):
    ...
    if cx == "R" and cz == "R":
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if "000" == order:
                tmp += (
                    +(-1) * 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(omz, -1) * pow(opx, -1)
                    + 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(omz, -1)
                    + 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(z, -1) * pow(pi, 2) * CF
                    + 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * pow(pi, 2) * CF
                    + 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * z * pow(pi, 2) * CF * pow(opx, -1)
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * pow(x, -1) * z * pow(pi, 2) * CF
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * pow(z, -1) * pow(pi, 2) * CF * pow(omz, -1) * pow(opx, -1)
                    ...
                    + (-1) * 16 * pow(NC, -1) * x * pow(z, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + 16 * pow(NC, -1) * x * pow(z, -1) * pow(rln2, 2) * CF
                    + (-1) * 32 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + 32 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 24 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(rln2, 2) * CF * pow(opz, -1)
                    + 24 * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * pow(rln2, 2) * CF
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF * pow(omz, -1)
                    + 4.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF
                    + (-1) * 4.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * sqrtxz1 * CF * pow(opz, -1)
                    + 4.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * sqrtxz1 * CF
                    + (-1) * 96 * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 64 * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 72 * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(rln2, 2) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +48 * pow(NC, -1) * x * pow(sqrtxz1, -1) * pow(rln2, 2) * CF
                    + 12 * pow(NC, -1) * x * CF
                    + (-1) * 16 * pow(NC, -1) * x * pow(rln2, 2) * CF
                    + (-1) * 4 * pow(NC, -1) * x * pow(pi, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 8.0 / 3.0 * x * pow(z, 2) * pow(pi, 2) * CF
                    + 88.0 / 9.0 * pow(x, 2) * CF
                ...
                tmp += (
                    ...
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                    + 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + 96 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 96 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * rln2 * CF
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 32 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * rln2 * CF
                    + (-1) * 128 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 128 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 128 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +128 * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 8 * ln(1 + sqrtxz1 - z) * x * sqrtxz1 * CF
                    + 8 * ln(1 + sqrtxz1 - z) * x * z * rln2 * CF
                    + (-1) * 48 * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * rln2 * CF
                    + (-1) * 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * pow(ln(1 + sqrtxz1 - z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * pow(ln(1 + sqrtxz1 - z), 2) * x * z * CF
                    + 16 * pow(ln(1 + sqrtxz1 - z), 2) * x * pow(z, 2) * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 48 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * CF
                    + 0
                )
                tmp += (
                    +16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 64 * ln(1 + sqrtxz1 - z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 8 * ln(1 + sqrtxz1 + z) * x * z * rln2 * CF
                    + (-1) * 16 * ln(1 + sqrtxz1 + z) * x * pow(z, 2) * rln2 * CF
                    + 0
                )
                tmp += (
                    +(-1) * 2 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 2 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 6 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 2 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 8 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * pow(ln(1 - 2 * z + pow(z, 2) + 4 * x * z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 16 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + 16 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + 16 * ln(x) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * pow(NC, -1) * pow(x, -1) * CF
                    + 16 * ln(x) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * pow(NC, -1) * pow(x, -1) * z * CF
                    + (-1) * 16 * ln(x) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 16 * ln(x) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 16 * ln(x) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * pow(NC, -1) * CF
                    + 16 * ln(x) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 8 * ln(x) * pow(NC, -1) * z * CF
                    + (-1) * 16 * ln(x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + 16 * ln(x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF * pow(opz, -1)
                    + 8 * ln(x) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                    + (-1) * 16 * ln(x) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 16 * ln(x) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 48 * ln(x) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(x) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 16 * ln(x) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * pow(NC, -1) * x * CF
                    + (-1) * 8 * ln(x) * pow(NC, -1) * x * rln2 * CF
                    + 16 * ln(x) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(x) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 8 * ln(x) * pow(NC, -1) * x * z * CF
                    + 8 * ln(x) * pow(NC, -1) * x * z * rln2 * CF
                    + 64 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 64 * ln(x) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * ln(x) * pow(x, -1) * pow(poly2, -1) * CF
                    + ln(x) * pow(x, -1) * CF
                    + 16 * ln(x) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * pow(x, -1) * z * CF
                    + (-1) * 32 * ln(x) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 32 * ln(x) * pow(x, -1) * pow(z, 2) * CF
                    + ln(x) * pow(poly2, -1) * CF
                    + (-1) * 2 * ln(x) * CF
                    + 16 * ln(x) * z * CF * pow(opx, -1)
                    + 11 * ln(x) * z * CF
                    + (-1) * 32 * ln(x) * pow(z, 2) * CF * pow(opx, -1)
                    + 2 * ln(x) * x * pow(poly2, -1) * CF
                    + (-1) * 14 * ln(x) * x * CF
                    + 4 * ln(x) * x * sqrtxz1 * CF
                    + 11 * ln(x) * x * z * CF
                    + (-1) * 8 * ln(x) * x * z * rln2 * CF
                    + (-1) * 4 * ln(x) * x * pow(z, 2) * CF
                    + 32 * ln(x) * x * pow(z, 2) * rln2 * CF
                    + (-1) * 2 * ln(x) * pow(x, 2) * pow(poly2, -1) * CF
                    + 4 * ln(x) * pow(x, 2) * CF * pow(xmz, -1)
                    + (-1) * 5 * ln(x) * pow(x, 2) * CF
                    + (-1) * ln(x) * pow(x, 3) * pow(poly2, -1) * CF
                    + (-1) * 4 * ln(x) * pow(x, 3) * CF * pow(xmz, -1)
                    + ln(x) * pow(x, 4) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 0
                )
                tmp += (
                    +1.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * ln(x) * ln(1 - sqrtxz2 + x) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 8 * ln(x) * ln(1 - sqrtxz2 + x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 2 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 - sqrtxz2 + x) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + ln(x) * ln(1 + sqrtxz2 + x) * pow(sqrtxz2, -1) * CF
                    + (-1) * 2 * ln(x) * ln(1 + sqrtxz2 + x) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz2 + x) * x * z * pow(sqrtxz2, -1) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz2 + x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 1.0 / 2.0 * ln(x) * ln(1 + sqrtxz2 + x) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(x) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz1 - z) * x * z * CF
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 24 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * CF
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * CF
                    + (-1) * 32 * ln(x) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * z * CF
                    + 8 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * z * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(1 + x * pow(z, -1)) * pow(z, 2) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(x) * ln(1 + x * pow(z, -1)) * x * z * CF
                    + 8 * ln(x) * ln(1 + x * pow(z, -1)) * x * pow(z, 2) * CF
                    + (-1) * 8 * ln(x) * ln(1 + x) * pow(NC, -1) * x * z * CF
                    + 8 * ln(x) * ln(1 + x) * x * CF
                    + (-1) * 24 * ln(x) * ln(1 + x) * x * z * CF
                    + 16 * ln(x) * ln(1 + x) * x * pow(z, 2) * CF
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(x) * ln(1 + x * z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(1 + x * z) * pow(x, -1) * z * CF
                    + 8 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(1 + x * z) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 4 * ln(x) * ln(1 + x * z) * z * CF * pow(opx, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 4 * ln(x) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 4 * ln(x) * ln(z + x) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(z + x) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * ln(x) * ln(z + x) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(z + x) * x * pow(z, 2) * CF
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 18 * pow(ln(x), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 12 * pow(ln(x), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + 2 * pow(ln(x), 2) * pow(NC, -1) * x * CF
                    + (-1) * 6 * pow(ln(x), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 6 * pow(ln(x), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 24 * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 24 * pow(ln(x), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 6 * pow(ln(x), 2) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 6 * pow(ln(x), 2) * pow(x, -1) * z * CF
                    + 12 * pow(ln(x), 2) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 12 * pow(ln(x), 2) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 6 * pow(ln(x), 2) * z * CF * pow(opx, -1)
                    + 12 * pow(ln(x), 2) * pow(z, 2) * CF * pow(opx, -1)
                    + 12 * pow(ln(x), 2) * x * z * CF
                    + (-1) * 8 * pow(ln(x), 2) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * CF
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * pow(x, -1) * z * CF
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * CF * pow(opx, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 8 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 12 * ln(x) * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(x) * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 4 * ln(x) * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 8 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF
                    + (-1) * 16 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(x) * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 4 * ln(x) * ln(z) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 4 * ln(x) * ln(z) * pow(x, -1) * z * CF
                    + (-1) * 8 * ln(x) * ln(z) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(z) * pow(x, -1) * pow(z, 2) * CF
                    + 4 * ln(x) * ln(z) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(z) * pow(z, 2) * CF * pow(opx, -1)
                    + 2 * ln(x) * ln(z) * x * CF
                    + 4 * ln(x) * ln(z) * x * z * CF
                    + 8 * ln(x) * ln(z) * x * pow(z, 2) * CF
                    + 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 8 * ln(x) * ln(omx) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * ln(x) * ln(omx) * pow(NC, -1) * x * CF
                    + 4 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF
                    + (-1) * 8 * ln(x) * ln(omx) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(omx) * pow(x, -1) * z * CF
                    + 16 * ln(x) * ln(omx) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * ln(omx) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 8 * ln(x) * ln(omx) * z * CF * pow(opx, -1)
                    + 16 * ln(x) * ln(omx) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(omx) * x * z * CF
                    + 16 * ln(x) * ln(omx) * x * pow(z, 2) * CF
                    + (-1) * 8 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * ln(x) * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(x) * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * ln(x) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(x) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 4 * ln(x) * ln(omz) * x * CF
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * CF
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(x, -1) * z * CF
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(x) * ln(opx) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    ...
                    + (-1) * 8 * ln(x) * ln(opx) * pow(x, -1) * z * CF
                    + (-1) * 16 * ln(x) * ln(opx) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 16 * ln(x) * ln(opx) * pow(x, -1) * pow(z, 2) * CF
                    + 8 * ln(x) * ln(opx) * z * CF * pow(opx, -1)
                    + (-1) * 16 * ln(x) * ln(opx) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * ln(x) * ln(opx) * x * z * CF
                    + (-1) * 16 * ln(x) * ln(opx) * x * pow(z, 2) * CF
                    + 4 * ln(z) * pow(NC, -1) * z * CF
                    + (-1) * 24 * ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF * pow(opz, -1)
                    + 24 * ln(z) * pow(NC, -1) * x * pow(z, -1) * rln2 * CF
                    + (-1) * 16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 16 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 32 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + 32 * ln(z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 48 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 96 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 64 * ln(z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 24 * ln(z) * pow(NC, -1) * x * rln2 * CF
                    + 16 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 0
                )
                tmp += (
                    +32 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 32 * ln(z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * 4 * ln(z) * pow(NC, -1) * x * z * CF
                    + 24 * ln(z) * pow(NC, -1) * x * z * rln2 * CF
                    + 64 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 64 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 128 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 128 * ln(z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF
                    + (-1) * ln(z) * pow(x, -1) * pow(poly2, -1) * CF
                    + 7.0 / 3.0 * ln(z) * pow(x, -1) * CF
                    + (-1) * ln(z) * pow(poly2, -1) * CF
                    + (-1) * 10 * ln(z) * CF
                    + 7 * ln(z) * z * CF
                    ...
                    + (-1) * 4 * ln(z) * pow(x, 2) * CF * pow(xmz, -1)
                    + (-1) * 1.0 / 3.0 * ln(z) * pow(x, 2) * CF
                    + (-1) * ln(z) * pow(x, 3) * pow(poly2, -1) * CF
                    + 4 * ln(z) * pow(x, 3) * CF * pow(xmz, -1)
                    + (-1) * ln(z) * pow(x, 4) * pow(poly2, -1) * CF
                    ...
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 48 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * CF
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +16 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * CF
                    + (-1) * 64 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 64 * ln(z) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 - z) * x * pow(z, 2) * CF
                    + 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 48 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * x * z * CF
                    + (-1) * 64 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 64 * ln(z) * ln(1 + sqrtxz1 + z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(z) * ln(1 + sqrtxz1 + z) * x * z * CF
                    + (-1) * 16 * ln(z) * ln(1 + sqrtxz1 + z) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    ...
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    ...
                    + (-1) * 4 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * z * CF
                    + (-1) * 8 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * ln(z) * ln(1 + x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * z * CF * pow(opx, -1)
                    + (-1) * 8 * ln(z) * ln(1 + x * pow(z, -1)) * pow(z, 2) * CF * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * pow(z, -1)) * x * z * CF
                    + (-1) * 8 * ln(z) * ln(1 + x * pow(z, -1)) * x * pow(z, 2) * CF
                    + 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(z) * ln(1 + x * z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * ln(z) * ln(1 + x * z) * pow(x, -1) * z * CF
                    + 8 * ln(z) * ln(1 + x * z) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * ln(z) * ln(1 + x * z) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 4 * ln(z) * ln(1 + x * z) * z * CF * pow(opx, -1)
                    + 8 * ln(z) * ln(1 + x * z) * pow(z, 2) * CF * pow(opx, -1)
                    + 16 * ln(z) * ln(1 + x * z) * x * pow(z, 2) * CF
                    + (-1) * 4 * ln(z) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 4 * ln(z) * ln(z + x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 4 * ln(z) * ln(z + x) * pow(NC, -1) * x * CF
                    + 4 * ln(z) * ln(z + x) * pow(NC, -1) * x * z * CF
                    + 4 * ln(z) * ln(z + x) * x * z * CF
                    + 8 * ln(z) * ln(z + x) * x * pow(z, 2) * CF
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * CF
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * pow(x, -1) * z * CF
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * CF * pow(opx, -1)
                    + 2 * pow(ln(z), 2) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 6 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 10 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 10 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 30 * pow(ln(z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 20 * pow(ln(z), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 2 * pow(ln(z), 2) * pow(NC, -1) * x * CF
                    + 10 * pow(ln(z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 10 * pow(ln(z), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 6 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF
                    + 40 * pow(ln(z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 40 * pow(ln(z), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 2 * pow(ln(z), 2) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 2 * pow(ln(z), 2) * pow(x, -1) * z * CF
                    + (-1) * 4 * pow(ln(z), 2) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 4 * pow(ln(z), 2) * pow(x, -1) * pow(z, 2) * CF
                    + 2 * pow(ln(z), 2) * z * CF * pow(opx, -1)
                    + (-1) * 4 * pow(ln(z), 2) * pow(z, 2) * CF * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * pow(ln(z), 2) * x * CF
                    + 4 * pow(ln(z), 2) * x * z * CF
                    + (-1) * 8 * pow(ln(z), 2) * x * pow(z, 2) * CF
                    + (-1) * 2 * ln(z) * ln(omx) * x * CF
                    + (-1) * 4 * ln(z) * ln(omx) * x * z * CF
                    + (-1) * 8 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * ln(z) * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * ln(z) * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(z) * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 4 * ln(z) * ln(omz) * x * CF
                    + (-1) * 8 * ln(z) * ln(omz) * x * z * CF
                    ...
                    + (-1) * 16 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF * pow(opz, -1)
                    + 16 * ln(omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * rln2 * CF
                    + (-1) * 48 * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + 32 * ln(omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * rln2 * CF
                    + 16 * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 16 * ln(omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * rln2 * CF
                    + 64 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF * pow(opz, -1)
                    + (-1) * 64 * ln(omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * rln2 * CF
                ...
                tmp += (
                    ...
                    + (-1) * 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 48 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 64 * ln(omz) * ln(1 + sqrtxz1 - z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 8 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 24 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 32 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * ln(omz) * ln(1 - 2 * z + pow(z, 2) + 4 * x * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 0
                )
                tmp += (
                    +(-1) * 24 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * pow(ln(omz), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * pow(ln(omz), 2) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * pow(ln(omz), 2) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) - 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * z * pow(sqrtxz2, -1) * CF
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(x, -1) + 1.0 / 2.0 * pow(x, -1) * sqrtxz2) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 0
                )
                tmp += (
                    +(-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * CF
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    ...
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 0
                )
                tmp += (
                    ...
                    + 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * x * z * CF
                    + 32 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 32 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * pow(z, -1) - 1.0 / 2.0 * pow(z, -1) * sqrtxz1) * x * z * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(sqrtxz2, -1) * CF
                    + (-1) * 2 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * z * pow(sqrtxz2, -1) * CF
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 5) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + 1.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, -1) * pow(sqrtxz2, -1) * CF
                    + (-1) * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 8 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * x * pow(z, 2) * pow(sqrtxz2, -1) * CF
                    + Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * pow(sqrtxz2, -1) * CF
                    + (-1) * 2 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 2) * z * pow(sqrtxz2, -1) * CF
                    + (-1) * 3.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 3) * pow(sqrtxz2, -1) * pow(poly2, -1) * CF
                    + (-1) * 1.0 / 2.0 * Li2(1.0 / 2.0 + 1.0 / 2.0 * sqrtxz2 - 1.0 / 2.0 * x) * pow(x, 3) * pow(sqrtxz2, -1) * CF
                    ...
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 24 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * x * z * CF
                    + (-1) * 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 - 1.0 / 2.0 * z) * x * pow(z, 2) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + 24 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * CF
                    + (-1) * 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 8 * Li2(1.0 / 2.0 - 1.0 / 2.0 * sqrtxz1 + 1.0 / 2.0 * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 0
                )
                tmp += (
                    ...
                    + (-1) * 4 * Li2(1 - x * pow(z, -1)) * x * CF
                    + 8 * Li2(1 - x * pow(z, -1)) * x * z * CF
                    + (-1) * 16 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 16 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 48 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 16 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 64 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 64 * Li2(pow(sqrtxz1, -1) * omz) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + (-1) * 16 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 16 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 48 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 32 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF
                    + 16 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + (-1) * 16 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 64 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 64 * Li2(-sqrtxz1 * pow(omz, -1)) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + 4 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 8 * Li2(-x * pow(z, -1)) * pow(NC, -1) * x * z * CF
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * Li2(-x * pow(z, -1)) * pow(x, -1) * z * CF
                    + 8 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x * pow(z, -1)) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 4 * Li2(-x * pow(z, -1)) * z * CF * pow(opx, -1)
                    + 8 * Li2(-x * pow(z, -1)) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x * pow(z, -1)) * x * z * CF
                    + (-1) * 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * CF
                    + 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x) * pow(NC, -1) * pow(x, -1) * z * CF
                    + (-1) * 8 * Li2(-x) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 8 * Li2(-x) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 8 * Li2(-x) * pow(NC, -1) * CF * pow(opx, -1)
                    + 8 * Li2(-x) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + 8 * Li2(-x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + 8 * Li2(-x) * pow(NC, -1) * x * CF
                    + 8 * Li2(-x) * pow(x, -1) * z * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x) * pow(x, -1) * z * CF
                    + (-1) * 16 * Li2(-x) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + 16 * Li2(-x) * pow(x, -1) * pow(z, 2) * CF
                    + 8 * Li2(-x) * z * CF * pow(opx, -1)
                    + (-1) * 16 * Li2(-x) * pow(z, 2) * CF * pow(opx, -1)
                    + 8 * Li2(-x) * x * CF
                    + (-1) * 16 * Li2(-x) * x * z * CF
                    + 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * Li2(-x * z) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 4 * Li2(-x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 4 * Li2(-x * z) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 4 * Li2(-x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(-x * z) * pow(NC, -1) * x * pow(z, -1) * CF * pow(opz, -1)
                    + (-1) * 8 * Li2(-x * z) * pow(NC, -1) * x * CF
                    + (-1) * 4 * Li2(-x * z) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 4 * Li2(-x * z) * pow(x, -1) * z * CF
                    + 8 * Li2(-x * z) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(-x * z) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 4 * Li2(-x * z) * z * CF * pow(opx, -1)
                    + 8 * Li2(-x * z) * pow(z, 2) * CF * pow(opx, -1)
                    + 16 * Li2(-x * z) * x * pow(z, 2) * CF
                    + (-1) * 8 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF * pow(opz, -1)
                    + 8 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(z, -1) * sqrtxz1 * CF
                    + (-1) * 24 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    ...
                    + (-1) * 8 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * x * z * pow(sqrtxz1, -1) * CF
                    + 32 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF * pow(opz, -1)
                    + 0
                )
                tmp += (
                    +(-1) * 32 * Li2(-1 / (1 + sqrtxz1 - z) + 1 / (1 + sqrtxz1 - z) * sqrtxz1 + 1 / (1 + sqrtxz1 - z) * z) * pow(NC, -1) * pow(x, 2) * pow(sqrtxz1, -1) * CF
                    + 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * pow(z, -1) * CF
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * CF * pow(opx, -1)
                    + 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * CF
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 8 * Li2(x) * pow(NC, -1) * pow(x, -1) * z * CF
                    + 8 * Li2(x) * pow(NC, -1) * pow(z, -1) * CF * pow(omz, -1) * pow(opx, -1)
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * pow(z, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * CF * pow(opx, -1)
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * z * CF * pow(opx, -1)
                    + 8 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * CF * pow(omz, -1)
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * x * pow(z, -1) * CF
                    + (-1) * 8 * Li2(x) * pow(NC, -1) * x * CF * pow(omz, -1)
                    + (-1) * 4 * Li2(x) * pow(NC, -1) * x * CF
                    + 4 * Li2(x) * pow(NC, -1) * x * z * CF
                    + (-1) * 8 * Li2(x) * pow(x, -1) * z * CF * pow(opx, -1)
                    + 8 * Li2(x) * pow(x, -1) * z * CF
                    + 16 * Li2(x) * pow(x, -1) * pow(z, 2) * CF * pow(opx, -1)
                    + (-1) * 16 * Li2(x) * pow(x, -1) * pow(z, 2) * CF
                    + (-1) * 8 * Li2(x) * z * CF * pow(opx, -1)
            ...
            if "010" == order:
                tmp += (-1) * 4.0 / 3.0 * LMUF * pow(x, -1) * CF + 4 * LMUF * CF + (-1) * 8.0 / 3.0 * LMUF * pow(x, 2) * CF + 0
...
def c2lq2qb_eq(x, z, rsl, order, f=C2Lq2qbEq_DR0123_scheme):
    if rsl == "ll":
