...
pub fn RG_RG_000(x: f64, z: f64, NF: f64) -> f64 {
    ...
    if z != x && z != 1. - x {
        let tmp: f64 = 5. / 72. * pow(z, -1) * pow(NQCD, -1) + (- 5. / 72. * pow(z, -1) * NQCD) + (- 1. / 3. * pow(NQCD, -1)) + 1. / 3. * NQCD + (- 37. / 24. * z * pow(NQCD, -1)) + 37. / 24. * z * NQCD + 65. / 36. * pow(z, 2) * pow(NQCD, -1) + (- 65. / 36. * pow(z, 2) * NQCD) + (- 19. / 72. * x * pow(z, -1) * pow(NQCD, -1)) + 19. / 72. * x * pow(z, -1) * NQCD + (- 5. / 6. * x * pow(NQCD, -1)) + 5. / 6. * x * NQCD + 47. / 24. * x * z * pow(NQCD, -1) + (- 47. / 24. * x * z * NQCD) + (- 31. / 36. * x * pow(z, 2) * pow(NQCD, -1)) + 31. / 36. * x * pow(z, 2) * NQCD + 1. / 12. * pow(pi, 2) * pow(NQCD, -1) + (- 1. / 12. * pow(pi, 2) * NQCD) + 1. / 6. * pow(pi, 2) * z * pow(NQCD, -1) + (- 1. / 6. * pow(pi, 2) * z * NQCD) + 1. / 12. * pow(pi, 2) * x * pow(NQCD, -1) + (- 1. / 12. * pow(pi, 2) * x * NQCD) + 1. / 6. * ln(1.0 - z) * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(1.0 - z) * pow(z, -1) * NQCD) + 3. / 4. * ln(1.0 - z) * pow(NQCD, -1) + (- 3. / 4. * ln(1.0 - z) * NQCD) + (- 1. / 4. * ln(1.0 - z) * z * pow(NQCD, -1)) + 1. / 4. * ln(1.0 - z) * z * NQCD + (- 2. / 3. * ln(1.0 - z) * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(1.0 - z) * pow(z, 2) * NQCD + 1. / 6. * ln(1.0 - z) * x * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(1.0 - z) * x * pow(z, -1) * NQCD) + 1. / 4. * ln(1.0 - z) * x * pow(NQCD, -1) + (- 1. / 4. * ln(1.0 - z) * x * NQCD) + (- 3. / 4. * ln(1.0 - z) * x * z * pow(NQCD, -1)) + 3. / 4. * ln(1.0 - z) * x * z * NQCD + 1. / 3. * ln(1.0 - z) * x * pow(z, 2) * pow(NQCD, -1) + (- 1. / 3. * ln(1.0 - z) * x * pow(z, 2) * NQCD) + 1. / 6. * ln(1.0 - x) * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(1.0 - x) * pow(z, -1) * NQCD) + 3. / 4. * ln(1.0 - x) * pow(NQCD, -1) + (- 3. / 4. * ln(1.0 - x) * NQCD) + (- 1. / 4. * ln(1.0 - x) * z * pow(NQCD, -1)) + 1. / 4. * ln(1.0 - x) * z * NQCD + (- 2. / 3. * ln(1.0 - x) * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(1.0 - x) * pow(z, 2) * NQCD + 1. / 6. * ln(1.0 - x) * x * pow(z, -1) * pow(NQCD, -1) + (-1. / 6. * ln(1.0 - x) * x * pow(z, -1) * NQCD) + 1. / 4. * ln(1.0 - x) * x * pow(NQCD, -1) + (- 1. / 4. * ln(1.0 - x) * x * NQCD) + (- 3. / 4. * ln(1.0 - x) * x * z * pow(NQCD, -1)) + 3. / 4. * ln(1.0 - x) * x * z * NQCD + 1. / 3. * ln(1.0 - x) * x * pow(z, 2) * pow(NQCD, -1) + (- 1. / 3. * ln(1.0 - x) * x * pow(z, 2) * NQCD) + (- 1. / 3. * ln(x) * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * ln(x) * pow(z, -1) * NQCD + (- 3. / 2. * ln(x) * pow(NQCD, -1)) + 3. / 2. * ln(x) * NQCD + 1. / 2. * ln(x) * z * pow(NQCD, -1) + (- 1. / 2. * ln(x) * z * NQCD) + 4. / 3. * ln(x) * pow(z, 2) * pow(NQCD, -1) + (- 4. / 3. * ln(x) * pow(z, 2) * NQCD) + (- 1. / 3. * ln(x) * x * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * ln(x) * x * pow(z, -1) * NQCD + (- 1. / 2. * ln(x) * x * pow(NQCD, -1)) + 1. / 2. * ln(x) * x * NQCD + 3. / 2. * ln(x) * x * z * pow(NQCD, -1) + (- 3. / 2. * ln(x) * x * z * NQCD) + (- 2. / 3. * ln(x) * x * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(x) * x * pow(z, 2) * NQCD + (- ln(x) * ln(z) * pow(NQCD, -1)) + ln(x) * ln(z) * NQCD + (- 2.0 * ln(x) * ln(z) * z * pow(NQCD, -1)) + 2.0 * ln(x) * ln(z) * z * NQCD + (- ln(x) * ln(z) * x * pow(NQCD, -1)) + ln(x) * ln(z) * x * NQCD + 1. / 6. * ln(z) * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(z) * pow(z, -1) * NQCD) + 5. / 4. * ln(z) * pow(NQCD, -1) + (- 5. / 4. * ln(z) * NQCD) + (- 3. / 4. * ln(z) * z * pow(NQCD, -1)) + 3. / 4. * ln(z) * z * NQCD + (- 2. / 3. * ln(z) * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(z) * pow(z, 2) * NQCD + 1. / 6. * ln(z) * x * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(z) * x * pow(z, -1) * NQCD) + (- 1. / 4. * ln(z) * x * pow(NQCD, -1)) + 1. / 4. * ln(z) * x * NQCD + (- 3. / 4. * ln(z) * x * z * pow(NQCD, -1)) + 3. / 4. * ln(z) * x * z * NQCD + 1. / 3. * ln(z) * x * pow(z, 2) * pow(NQCD, -1) + (- 1. / 3. * ln(z) * x * pow(z, 2) * NQCD) + 1. / 2. * ln(z) * ln(1.0 - x) * pow(NQCD, -1) + (- 1. / 2. * ln(z) * ln(1.0 - x) * NQCD) + ln(z) * ln(1.0 - x) * z * pow(NQCD, -1) + (- ln(z) * ln(1.0 - x) * z * NQCD) + 1. / 2. * ln(z) * ln(1.0 - x) * x * pow(NQCD, -1) + (- 1. / 2. * ln(z) * ln(1.0 - x) * x * NQCD) + 1. / 2. * pow(ln(z), 2) * pow(NQCD, -1) + (- 1. / 2. * pow(ln(z), 2) * NQCD) + pow(ln(z), 2) * z * pow(NQCD, -1) + (- pow(ln(z), 2) * z * NQCD) + 1. / 2. * pow(ln(z), 2) * x * pow(NQCD, -1) + (- 1. / 2. * pow(ln(z), 2) * x * NQCD) + (- 1. / 2. * Li2(z) * pow(NQCD, -1)) + 1. / 2. * Li2(z) * NQCD + (- Li2(z) * z * pow(NQCD, -1)) + Li2(z) * z * NQCD + (- 1. / 2. * Li2(z) * x * pow(NQCD, -1)) + 1. / 2. * Li2(z) * x * NQCD + 2. / 3. / (1.0 - x) * ln(x) * pow(z, -1) * pow(NQCD, -1) + (- 2. / 3. / (1.0 - x) * ln(x) * pow(z, -1) * NQCD) + 5. / 4. / (1.0 - x) * ln(x) * pow(NQCD, -1) + (- 5. / 4. / (1.0 - x) * ln(x) * NQCD) + (- 5. / 4. / (1.0 - x) * ln(x) * z * pow(NQCD, -1)) + 5. / 4. / (1.0 - x) * ln(x) * z * NQCD + (- 2. / 3. / (1.0 - x) * ln(x) * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. / (1.0 - x) * ln(x) * pow(z, 2) * NQCD + 3. / 2. / (1.0 - x) * ln(x) * ln(z) * pow(NQCD, -1) + (- 3. / 2. / (1.0 - x) * ln(x) * ln(z) * NQCD) + 3. / 2. / (1.0 - x) * ln(x) * ln(z) * z * pow(NQCD, -1) + (- 3. / 2. / (1.0 - x) * ln(x) * ln(z) * z * NQCD);
        res += tmp;
    }
...
pub fn RG_RG_001(x: f64, z: f64, NF: f64) -> f64 {
    ...
    if z != x && z != 1. - x {
        let tmp: f64 = (- 1. / 3. * lmua * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * lmua * pow(z, -1) * NQCD + (- 3. / 2. * lmua * pow(NQCD, -1)) + 3. / 2. * lmua * NQCD + 1. / 2. * lmua * z * pow(NQCD, -1) + (- 1. / 2. * lmua * z * NQCD) + 4. / 3. * lmua * pow(z, 2) * pow(NQCD, -1) + (- 4. / 3. * lmua * pow(z, 2) * NQCD) + (- 1. / 3. * lmua * x * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * lmua * x * pow(z, -1) * NQCD + (- 1. / 2. * lmua * x * pow(NQCD, -1)) + 1. / 2. * lmua * x * NQCD + 3. / 2. * lmua * x * z * pow(NQCD, -1) + (- 3. / 2. * lmua * x * z * NQCD) + (- 2. / 3. * lmua * x * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * lmua * x * pow(z, 2) * NQCD + (- ln(z) * lmua * pow(NQCD, -1)) + ln(z) * lmua * NQCD + (- 2.0 * ln(z) * lmua * z * pow(NQCD, -1)) + 2.0 * ln(z) * lmua * z * NQCD + (- ln(z) * lmua * x * pow(NQCD, -1)) + ln(z) * lmua * x * NQCD;
        res += tmp;
    }
