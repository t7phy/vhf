...
fn RG_RG_000(x: f64, z: f64, NF: f64) -> f64 {
    ...
    if z != x && z != 1. - x {
        let tmp: f64 = (-6.0) + 6.0 * (1.0 / (NQCD * NQCD)) + (- 6.0 * z * (1.0 / (NQCD * NQCD))) + 6.0 * z + (- 6.0 * x * (1.0 / (NQCD * NQCD))) + 6.0 * x + 6.0 * x * z * (1.0 / (NQCD * NQCD)) + (- 6.0 * x * z) + (- 1. / 3. * (pi * pi) * x * (1.0 / (NQCD * NQCD))) + 1. / 3. * (pi * pi) * x + 1. / 3. * (pi * pi) * x * z * (1.0 / (NQCD * NQCD)) + (- 1. / 3. * (pi * pi) * x * z) + (- 2.0 * ln(x)) + 2.0 * ln(x) * (1.0 / (NQCD * NQCD)) + (- 2.0 * ln(x) * z * (1.0 / (NQCD * NQCD))) + 2.0 * ln(x) * z + 2.0 * ln(x) * x * (1.0 / (NQCD * NQCD)) + (- 2.0 * ln(x) * x) + (- 2.0 * ln(x) * x * z * (1.0 / (NQCD * NQCD))) + 2.0 * ln(x) * x * z + 2.0 * ln(x) * ln(1.0 - x) * x * (1.0 / (NQCD * NQCD)) + (- 2.0 * ln(x) * ln(1.0 - x) * x) + (- 2.0 * ln(x) * ln(1.0 - x) * x * z * (1.0 / (NQCD * NQCD))) + 2.0 * ln(x) * ln(1.0 - x) * x * z + (- pow(ln(x), 2) * x * (1.0 / (NQCD * NQCD))) + pow(ln(x), 2) * x + pow(ln(x), 2) * x * z * (1.0 / (NQCD * NQCD)) + (- pow(ln(x), 2) * x * z) + 2.0 * Li2(x) * x * (1.0 / (NQCD * NQCD)) + (- 2.0 * Li2(x) * x) + (- 2.0 * Li2(x) * x * z * (1.0 / (NQCD * NQCD))) + 2.0 * Li2(x) * x * z;
        res += tmp;
    }
