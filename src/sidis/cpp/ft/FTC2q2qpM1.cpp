...
double RG_RG_000(double x, double z, double NF) {
    ...
    if (z != x && z != 1. - x) {
        double tmp = 0.0;
        tmp = 5. / 72. * pow(z, -1) * pow(NQCD, -1) + (- 5. / 72. * pow(z, -1) * NQCD) + 1. / 6. * pow(NQCD, -1) + (- 1. / 6. * NQCD) + 23. / 24. * z * pow(NQCD, -1) + (- 23. / 24. * z * NQCD) + (- 43. / 36. * pow(z, 2) * pow(NQCD, -1)) + 43. / 36. * pow(z, 2) * NQCD + (- 19. / 72. * x * pow(z, -1) * pow(NQCD, -1)) + 19. / 72. * x * pow(z, -1) * NQCD + (- 4. / 3. * x * pow(NQCD, -1)) + 4. / 3. * x * NQCD + (- 13. / 24. * x * z * pow(NQCD, -1)) + 13. / 24. * x * z * NQCD + 77. / 36. * x * pow(z, 2) * pow(NQCD, -1) + (- 77. / 36. * x * pow(z, 2) * NQCD) + 1. / 12. * pow(pi, 2) * pow(NQCD, -1) + (- 1. / 12. * pow(pi, 2) * NQCD) + 1. / 12. * pow(pi, 2) * x * pow(NQCD, -1) + (- 1. / 12. * pow(pi, 2) * x * NQCD) + 1. / 6. * pow(pi, 2) * x * z * pow(NQCD, -1) + (- 1. / 6. * pow(pi, 2) * x * z * NQCD) + 1. / 6. * ln(1 - z) * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(1 - z) * pow(z, -1) * NQCD) + 1. / 4. * ln(1 - z) * pow(NQCD, -1) + (- 1. / 4. * ln(1 - z) * NQCD) + (- 3. / 4. * ln(1 - z) * z * pow(NQCD, -1)) + 3. / 4. * ln(1 - z) * z * NQCD + 1. / 3. * ln(1 - z) * pow(z, 2) * pow(NQCD, -1) + (- 1. / 3. * ln(1 - z) * pow(z, 2) * NQCD) + 1. / 6. * ln(1 - z) * x * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(1 - z) * x * pow(z, -1) * NQCD) + 3. / 4. * ln(1 - z) * x * pow(NQCD, -1) + (- 3. / 4. * ln(1 - z) * x * NQCD) + (- 1. / 4. * ln(1 - z) * x * z * pow(NQCD, -1)) + 1. / 4. * ln(1 - z) * x * z * NQCD + (- 2. / 3. * ln(1 - z) * x * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(1 - z) * x * pow(z, 2) * NQCD + 1. / 6. * ln(1 - x) * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(1 - x) * pow(z, -1) * NQCD) + 1. / 4. * ln(1 - x) * pow(NQCD, -1) + (- 1. / 4. * ln(1 - x) * NQCD) + (- 3. / 4. * ln(1 - x) * z * pow(NQCD, -1)) + 3. / 4. * ln(1 - x) * z * NQCD + 1. / 3. * ln(1 - x) * pow(z, 2) * pow(NQCD, -1) + (- 1. / 3. * ln(1 - x) * pow(z, 2) * NQCD) + 1. / 6. * ln(1 - x) * x * pow(z, -1) * pow(NQCD, -1) +  + (-1. / 6. * ln(1 - x) * x * pow(z, -1) * NQCD) + 3. / 4. * ln(1 - x) * x * pow(NQCD, -1) + (- 3. / 4. * ln(1 - x) * x * NQCD) + (- 1. / 4. * ln(1 - x) * x * z * pow(NQCD, -1)) + 1. / 4. * ln(1 - x) * x * z * NQCD + (- 2. / 3. * ln(1 - x) * x * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(1 - x) * x * pow(z, 2) * NQCD + (- 1. / 3. * ln(x) * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * ln(x) * pow(z, -1) * NQCD + (- 1. / 2. * ln(x) * pow(NQCD, -1)) + 1. / 2. * ln(x) * NQCD + 3. / 2. * ln(x) * z * pow(NQCD, -1) + (- 3. / 2. * ln(x) * z * NQCD) + (- 2. / 3. * ln(x) * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(x) * pow(z, 2) * NQCD + (- 1. / 3. * ln(x) * x * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * ln(x) * x * pow(z, -1) * NQCD + (- 3. / 2. * ln(x) * x * pow(NQCD, -1)) + 3. / 2. * ln(x) * x * NQCD + 1. / 2. * ln(x) * x * z * pow(NQCD, -1) + (- 1. / 2. * ln(x) * x * z * NQCD) + 4. / 3. * ln(x) * x * pow(z, 2) * pow(NQCD, -1) + (- 4. / 3. * ln(x) * x * pow(z, 2) * NQCD) + (- ln(x) * ln(z) * pow(NQCD, -1)) +  + ln(x) * ln(z) * NQCD + (- ln(x) * ln(z) * x * pow(NQCD, -1)) + ln(x) * ln(z) * x * NQCD + (- 2 * ln(x) * ln(z) * x * z * pow(NQCD, -1)) + 2 * ln(x) * ln(z) * x * z * NQCD + 1. / 6. * ln(z) * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(z) * pow(z, -1) * NQCD) + 3. / 4. * ln(z) * pow(NQCD, -1) + (- 3. / 4. * ln(z) * NQCD) + 1. / 4. * ln(z) * z * pow(NQCD, -1) + (- 1. / 4. * ln(z) * z * NQCD) + 1. / 3. * ln(z) * pow(z, 2) * pow(NQCD, -1) + (- 1. / 3. * ln(z) * pow(z, 2) * NQCD) + 1. / 6. * ln(z) * x * pow(z, -1) * pow(NQCD, -1) + (- 1. / 6. * ln(z) * x * pow(z, -1) * NQCD) + 1. / 4. * ln(z) * x * pow(NQCD, -1) + (- 1. / 4. * ln(z) * x * NQCD) + (- 7. / 4. * ln(z) * x * z * pow(NQCD, -1)) + 7. / 4. * ln(z) * x * z * NQCD + (- 2. / 3. * ln(z) * x * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * ln(z) * x * pow(z, 2) * NQCD + 1. / 2. * ln(z) * ln(1 - x) * pow(NQCD, -1) + (- 1. / 2. * ln(z) * ln(1 - x) * NQCD) + 1. / 2. * ln(z) * ln(1 - x) * x * pow(NQCD, -1) + (- 1. / 2. * ln(z) * ln(1 - x) * x * NQCD) + ln(z) * ln(1 - x) * x * z * pow(NQCD, -1) + (- ln(z) * ln(1 - x) * x * z * NQCD) + 1. / 2. * pow(ln(z), 2) * pow(NQCD, -1) + (- 1. / 2. * pow(ln(z), 2) * NQCD) + 1. / 2. * pow(ln(z), 2) * x * pow(NQCD, -1) + (- 1. / 2. * pow(ln(z), 2) * x * NQCD) + pow(ln(z), 2) * x * z * pow(NQCD, -1) + (- pow(ln(z), 2) * x * z * NQCD) + (- 1. / 2. * Li2(z) * pow(NQCD, -1)) + 1. / 2. * Li2(z) * NQCD + (- 1. / 2. * Li2(z) * x * pow(NQCD, -1)) + 1. / 2. * Li2(z) * x * NQCD + (- Li2(z) * x * z * pow(NQCD, -1)) + Li2(z) * x * z * NQCD + 2. / 3. / (1 - x) * ln(x) * pow(z, -1) * pow(NQCD, -1) +  + (-2. / 3. / (1 - x) * ln(x) * pow(z, -1) * NQCD) + 5. / 4. / (1 - x) * ln(x) * pow(NQCD, -1) + (- 5. / 4. / (1 - x) * ln(x) * NQCD) + (- 5. / 4. / (1 - x) * ln(x) * z * pow(NQCD, -1)) + 5. / 4. / (1 - x) * ln(x) * z * NQCD + (- 2. / 3. / (1 - x) * ln(x) * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. / (1 - x) * ln(x) * pow(z, 2) * NQCD + 3. / 2. / (1 - x) * ln(x) * ln(z) * pow(NQCD, -1) + (- 3. / 2. / (1 - x) * ln(x) * ln(z) * NQCD) + 3. / 2. / (1 - x) * ln(x) * ln(z) * z * pow(NQCD, -1) + (- 3. / 2. / (1 - x) * ln(x) * ln(z) * z * NQCD);
        res += tmp;
    }
...
double RG_RG_001(double x, double z, double NF) {
    ...
    if (z != x && z != 1. - x) {
        double tmp = 0.0;
        tmp = (- 1. / 3. * lmua * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * lmua * pow(z, -1) * NQCD + (- 1. / 2. * lmua * pow(NQCD, -1)) + 1. / 2. * lmua * NQCD + 3. / 2. * lmua * z * pow(NQCD, -1) + (- 3. / 2. * lmua * z * NQCD) + (- 2. / 3. * lmua * pow(z, 2) * pow(NQCD, -1)) + 2. / 3. * lmua * pow(z, 2) * NQCD + (- 1. / 3. * lmua * x * pow(z, -1) * pow(NQCD, -1)) + 1. / 3. * lmua * x * pow(z, -1) * NQCD + (- 3. / 2. * lmua * x * pow(NQCD, -1)) + 3. / 2. * lmua * x * NQCD + 1. / 2. * lmua * x * z * pow(NQCD, -1) + (- 1. / 2. * lmua * x * z * NQCD) + 4. / 3. * lmua * x * pow(z, 2) * pow(NQCD, -1) + (- 4. / 3. * lmua * x * pow(z, 2) * NQCD) + (- ln(z) * lmua * pow(NQCD, -1)) + ln(z) * lmua * NQCD + (- ln(z) * lmua * x * pow(NQCD, -1)) + ln(z) * lmua * x * NQCD + (- 2 * ln(z) * lmua * x * z * pow(NQCD, -1)) + 2 * ln(z) * lmua * x * z * NQCD;
        res += tmp;
    }
