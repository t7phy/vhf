...
fn DL_DL_000(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (-2.0 * pow(NQCD, -1)) + 2.0 * NQCD;
    return res;
}

fn DL_DL_001(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (- 3. / 4. * lmua * pow(NQCD, -1)) + 3. / 4. * lmua * NQCD;
    return res;
}

fn DL_DL_010(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (- 3. / 4. * lmuf * pow(NQCD, -1)) + 3. / 4. * lmuf * NQCD;
    return res;
}

fn DL_D0_001(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (-lmua * pow(NQCD, -1)) + lmua * NQCD;
    return res;
}

fn DL_D1_000(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = 1. / 2. * pow(NQCD, -1) + (- 1. / 2. * NQCD);
    return res;
}

fn D0_DL_010(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (-lmuf * pow(NQCD, -1)) + lmuf * NQCD;
    return res;
}
...
fn DL_RG_000(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = 1. / 4. * pow(NQCD, -1) + (- 1. / 4. * NQCD) + (- 1. / 4. * z * pow(NQCD, -1)) + 1. / 4. * z * NQCD + (- 1. / 4. * ln(1.0 - z) * pow(NQCD, -1)) + 1. / 4. * ln(1.0 - z) * NQCD + (- 1. / 4. * ln(1.0 - z) * z * pow(NQCD, -1)) + 1. / 4. * ln(1.0 - z) * z * NQCD + (- 1. / 4. * ln(z) * pow(NQCD, -1)) + 1. / 4. * ln(z) * NQCD + (- 1. / 4. * ln(z) * z * pow(NQCD, -1)) + 1. / 4. * ln(z) * z * NQCD + 1. / 2. / (1.0 - z) * ln(z) * pow(NQCD, -1) + (- 1. / 2. / (1.0 - z) * ln(z) * NQCD);
    return res;
}

fn DL_RG_001(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = 1. / 2. * lmua * pow(NQCD, -1) + (- 1. / 2. * lmua * NQCD) + 1. / 2. * lmua * z * pow(NQCD, -1) + (- 1. / 2. * lmua * z * NQCD);
    return res;
}

fn D0_RG_000(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (-1. / 4. * pow(NQCD, -1)) + 1. / 4. * NQCD + (- 1. / 4. * z * pow(NQCD, -1)) + 1. / 4. * z * NQCD;
    return res;
}

fn RG_DL_000(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = 1. / 4. * pow(NQCD, -1) + (- 1. / 4. * NQCD) + (- 1. / 4. * x * pow(NQCD, -1)) + 1. / 4. * x * NQCD + (- 1. / 4. * ln(1.0 - x) * pow(NQCD, -1)) + 1. / 4. * ln(1.0 - x) * NQCD + (- 1. / 4. * ln(1.0 - x) * x * pow(NQCD, -1)) + 1. / 4. * ln(1.0 - x) * x * NQCD + 1. / 4. * ln(x) * pow(NQCD, -1) + (- 1. / 4. * ln(x) * NQCD) + 1. / 4. * ln(x) * x * pow(NQCD, -1) + (- 1. / 4. * ln(x) * x * NQCD) + (- 1. / 2. / (1.0 - x) * ln(x) * pow(NQCD, -1)) + 1. / 2. / (1.0 - x) * ln(x) * NQCD;
    return res;
}

fn RG_DL_010(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = 1. / 2. * lmuf * pow(NQCD, -1) + (- 1. / 2. * lmuf * NQCD) + 1. / 2. * lmuf * x * pow(NQCD, -1) + (- 1. / 2. * lmuf * x * NQCD);
    return res;
}

fn RG_D0_000(x: f64, z: f64, NF: f64) -> f64 {
    let res: f64 = (-1. / 4. * pow(NQCD, -1)) + 1. / 4. * NQCD + (- 1. / 4. * x * pow(NQCD, -1)) + 1. / 4. * x * NQCD;
    return res;
}
...
fn RG_RG_000(x: f64, z: f64, NF: f64) -> f64 {
    ...
    if z != x && z != 1. - x {
        let tmp: f64 = 1. / 2. * pow(NQCD, -1) + (- 1. / 2. * NQCD) + 1. / 2. * x * z * pow(NQCD, -1) + (- 1. / 2. * x * z * NQCD);
        res += tmp;
    }
