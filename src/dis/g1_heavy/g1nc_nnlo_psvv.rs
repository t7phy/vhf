...
use crate::dis::f2_heavy::fh_grids::cq1_x2g1_vv_bulk::cq1_x2g1_vv_bulk_spline as grid;
use crate::dis::f2_heavy::fh_grids::cq1_x2g1_vv_bulk::{CQ1_X2G1_VV_BULK_X, CQ1_X2G1_VV_BULK_Y};
use crate::dis::f2_heavy::cgbar1_h1;
use crate::dis::g1_heavy::cq1t_x2g1_vv;
...
pub fn r_00(x: f64, Q2: f64, pid: f64) -> f64 {
    ...
    let lneta = eta.ln();
    let lnxi = xi.ln();
    let lneta_min = CQ1_X2G1_VV_BULK_X[0];
    let lnxi_max = CQ1_X2G1_VV_BULK_Y[CQ1_X2G1_VV_BULK_Y.len() - 1];
