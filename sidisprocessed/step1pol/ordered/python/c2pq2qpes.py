...
def C2Pq2qpEs(inx, inz, cx, cz, Q, muR, muF, muA, orders: list, ndecimals):
    res = 0.0
        ...
        if round(z, ndecimals) != round(x, ndecimals) and round(z, ndecimals) != round(1.0 - x, ndecimals):
            ...
            if ("000" in orders) or ("all" in orders):
                ...
                tmp += (
                    ...
                    + (-1) * 1.0 / 2.0 * ln(x) * pow(x, 3) * CF * pow(poly2, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 1.0 / 2.0 * ln(z) * x * CF * pow(poly2, -1)
                    + ln(z) * x * CF * pow(xmz, -1)
                    + 3.0 / 2.0 * ln(z) * x * CF
                    + (-1) * 2 * ln(z) * x * CF * rln2
