    ...
    if cx == "R" and cz == "D":
        ...
        if (order == "000") or (order == "all"):
            ...
            res += (
                ...
                + (-1) * 7.0 / 8.0 * Li2(x) * NC
                + (-1) * 1.0 / 2.0 * Li2(x) * x * pow(NC, -1)
                + (-1) * 3.0 / 2.0 * Li2(x) * x * NC
                + 0
            )
        if (order == "100") or (order == "all"):
            ...
            res += (
                ...
                + 11.0 / 6.0 * LMUR * NC
                + 1.0 / 3.0 * x * LMUR * NF
                + (-1) * 11.0 / 6.0 * x * LMUR * NC
                + (-1) * 1.0 / 6.0 * ln(x) * LMUR * NF
                + 11.0 / 12.0 * ln(x) * LMUR * NC
                + 1.0 / 3.0 * ln(x) * x * LMUR * NF
                + (-1) * 11.0 / 6.0 * ln(x) * x * LMUR * NC
                + 1.0 / 6.0 * ln(omx) * LMUR * NF
                + (-1) * 11.0 / 12.0 * ln(omx) * LMUR * NC
                + (-1) * 1.0 / 3.0 * ln(omx) * x * LMUR * NF
        ...
        if (order == "010") or (order == "all"):
            ...
            res += (
                ...
                + (-1) * 1.0 / 2.0 * pow(ln(omx), 2) * LMUF * pow(NC, -1)
                + pow(ln(omx), 2) * LMUF * NC
                + pow(ln(omx), 2) * x * LMUF * pow(NC, -1)
                + (-1) * 2 * pow(ln(omx), 2) * x * LMUF * NC
                + Li2(-x) * LMUF * NC
                + 2 * Li2(-x) * x * LMUF * NC
                + 1.0 / 4.0 * Li2(x) * LMUF * pow(NC, -1)
                + 7.0 / 4.0 * Li2(x) * LMUF * NC
                + 0
            )
            res += (-1) * 1.0 / 2.0 * Li2(x) * x * LMUF * pow(NC, -1) + 5.0 / 2.0 * Li2(x) * x * LMUF * NC + 0
        ...
        if (order == "020") or (order == "all"):
            ...
            res += (
                (-1) * 3.0 / 16.0 * pow(LMUF, 2) * pow(NC, -1)
                + 1.0 / 6.0 * pow(LMUF, 2) * NF
                + 109.0 / 48.0 * pow(LMUF, 2) * NC
                + (-1) * 1.0 / 3.0 * x * pow(LMUF, 2) * NF
                + (-1) * 7.0 / 6.0 * x * pow(LMUF, 2) * NC
                + (-1) * 1.0 / 8.0 * ln(x) * pow(LMUF, 2) * pow(NC, -1)
                ...
                + (-1) * 3.0 / 4.0 * ln(omx) * pow(LMUF, 2) * NC
                + (-1) * 1.0 / 2.0 * ln(omx) * x * pow(LMUF, 2) * pow(NC, -1)
        ...
        if (order == "001") or (order == "all"):
            ...
            res += (
                ...
                + (-1) * 3.0 / 4.0 * LMUA * NC
                + (-1) * 3.0 / 4.0 * x * LMUA * pow(NC, -1)
                + 3.0 / 4.0 * x * LMUA * NC
                + 1.0 / 12.0 * pow(pi, 2) * LMUA * pow(NC, -1)
                + (-1) * 1.0 / 12.0 * pow(pi, 2) * LMUA * NC
                + (-1) * 1.0 / 6.0 * pow(pi, 2) * x * LMUA * pow(NC, -1)
                + 1.0 / 6.0 * pow(pi, 2) * x * LMUA * NC
                + 3.0 / 8.0 * ln(x) * LMUA * pow(NC, -1)
                + (-1) * 3.0 / 8.0 * ln(x) * LMUA * NC
                + (-1) * 3.0 / 4.0 * ln(x) * x * LMUA * pow(NC, -1)
                + 3.0 / 4.0 * ln(x) * x * LMUA * NC
                + (-1) * 3.0 / 8.0 * ln(omx) * LMUA * pow(NC, -1)
                + 3.0 / 8.0 * ln(omx) * LMUA * NC
                + 3.0 / 4.0 * ln(omx) * x * LMUA * pow(NC, -1)
                + (-1) * 3.0 / 4.0 * ln(omx) * x * LMUA * NC
                + 0
            )
    ...
    if cx == "R" and cz == "0":
        ...
        if (order == "000") or (order == "all"):
            ...
            res += (
                ...
                + (-1) * pow(ln(omx), 2) * NC
                + (-1) * pow(ln(omx), 2) * x * pow(NC, -1)
                + 2 * pow(ln(omx), 2) * x * NC
                + (-1) * Li2(-x) * NC
                + (-1) * 2 * Li2(-x) * x * NC
                + (-1) * 1.0 / 4.0 * Li2(x) * pow(NC, -1)
                + (-1) * 7.0 / 4.0 * Li2(x) * NC
                + 1.0 / 2.0 * Li2(x) * x * pow(NC, -1)
                + (-1) * 5.0 / 2.0 * Li2(x) * x * NC
                + 0
            )
        if (order == "100") or (order == "all"):
    ...
    if cx == "R" and cz == "R":
        ...
        if z != x and z != 1.0 - x:
            ...
            if (order == "000") or (order == "all"):
                ...
                tmp += 4 * Li2(z) * x * pow(NC, -1) + Li2(z) * x * NC * pow(omz, -1) + (-1) * 4 * Li2(z) * x * NC + (-1) * Li2(z) * pow(x, 2) * pow(z, -1) * pow(NC, -1) + Li2(z) * pow(x, 2) * pow(NC, -1) * pow(omz, -1) + 0
            if (order == "100") or (order == "all"):
            ...
            if (order == "010") or (order == "all"):
                ...
                tmp += (
                    ...
                    + (-1) * 1.0 / 2.0 * ln(x) * x * z * LMUF * NC
                    + (-1) * 1.0 / 2.0 * ln(z) * LMUF * pow(NC, -1) * pow(omz, -1)
                    + 1.0 / 4.0 * ln(z) * LMUF * pow(NC, -1)
                    + 1.0 / 2.0 * ln(z) * LMUF * NC * pow(omz, -1)
                    + (-1) * 1.0 / 4.0 * ln(z) * LMUF * NC
                    + 1.0 / 4.0 * ln(z) * z * LMUF * pow(NC, -1)
                    + (-1) * 1.0 / 4.0 * ln(z) * z * LMUF * NC
                    + ln(z) * x * LMUF * pow(NC, -1) * pow(omz, -1)
                    + (-1) * 1.0 / 2.0 * ln(z) * x * LMUF * pow(NC, -1)
                    + (-1) * ln(z) * x * LMUF * NC * pow(omz, -1)
                    + 1.0 / 2.0 * ln(z) * x * LMUF * NC
                    + (-1) * 1.0 / 2.0 * ln(z) * x * z * LMUF * pow(NC, -1)
                ...
                tmp += (
                    ...
                    + (-1) * 1.0 / 4.0 * ln(omz) * LMUF * NC
                    + 1.0 / 4.0 * ln(omz) * z * LMUF * pow(NC, -1)
                    + (-1) * 1.0 / 4.0 * ln(omz) * z * LMUF * NC
                    + (-1) * 1.0 / 2.0 * ln(omz) * x * LMUF * pow(NC, -1)
                    + 1.0 / 2.0 * ln(omz) * x * LMUF * NC
                    + (-1) * 1.0 / 2.0 * ln(omz) * x * z * LMUF * pow(NC, -1)
            ...
            if (order == "001") or (order == "all"):
                ...
                tmp += (
                    (-1) * 1.0 / 4.0 * LMUA * pow(NC, -1)
                    + 1.0 / 4.0 * LMUA * NC
                    + (-1) * 3.0 / 8.0 * z * LMUA * pow(NC, -1)
                    + 3.0 / 8.0 * z * LMUA * NC
                    + 1.0 / 4.0 * x * z * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 4.0 * x * z * LMUA * NC
                    + (-1) * 1.0 / 4.0 * ln(x) * LMUA * pow(NC, -1)
                    + 1.0 / 4.0 * ln(x) * LMUA * NC
                    + (-1) * 1.0 / 4.0 * ln(x) * z * LMUA * pow(NC, -1)
                    + 1.0 / 4.0 * ln(x) * z * LMUA * NC
                    + 1.0 / 2.0 * ln(x) * x * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 2.0 * ln(x) * x * LMUA * NC
                    + 1.0 / 2.0 * ln(x) * x * z * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 2.0 * ln(x) * x * z * LMUA * NC
                    + 1.0 / 2.0 * ln(z) * LMUA * pow(NC, -1) * pow(omz, -1)
                    + (-1) * 3.0 / 4.0 * ln(z) * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 2.0 * ln(z) * LMUA * NC * pow(omz, -1)
                    + 3.0 / 4.0 * ln(z) * LMUA * NC
                    + (-1) * 1.0 / 4.0 * ln(z) * z * LMUA * pow(NC, -1)
                    + 1.0 / 4.0 * ln(z) * z * LMUA * NC
                    + 0
                )
                tmp += (
                    (-1) * ln(z) * x * LMUA * pow(NC, -1) * pow(omz, -1)
                    + 3.0 / 2.0 * ln(z) * x * LMUA * pow(NC, -1)
                    + ln(z) * x * LMUA * NC * pow(omz, -1)
                    + (-1) * 3.0 / 2.0 * ln(z) * x * LMUA * NC
                    + 1.0 / 2.0 * ln(z) * x * z * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 2.0 * ln(z) * x * z * LMUA * NC
                    + 1.0 / 4.0 * ln(omx) * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 4.0 * ln(omx) * LMUA * NC
                    + 1.0 / 4.0 * ln(omx) * z * LMUA * pow(NC, -1)
                    + (-1) * 1.0 / 4.0 * ln(omx) * z * LMUA * NC
                    + (-1) * 1.0 / 2.0 * ln(omx) * x * LMUA * pow(NC, -1)
                    + 1.0 / 2.0 * ln(omx) * x * LMUA * NC
                    + (-1) * 1.0 / 2.0 * ln(omx) * x * z * LMUA * pow(NC, -1)
                ...
                tmp += ln(omz) * x * pow(z, -1) * LMUA * pow(NC, -1) + (-1) * ln(omz) * x * pow(z, -1) * LMUA * NC + (-1) * 5.0 / 2.0 * ln(omz) * x * LMUA * pow(NC, -1) + 5.0 / 2.0 * ln(omz) * x * LMUA * NC + (-1) * 1.0 / 2.0 * ln(omz) * x * z * LMUA * pow(NC, -1) + 1.0 / 2.0 * ln(omz) * x * z * LMUA * NC + 0
            if (order == "011") or (order == "all"):

                tmp += (-1) * 1.0 / 4.0 * LMUA * LMUF * pow(NC, -1) + 1.0 / 4.0 * LMUA * LMUF * NC + (-1) * 1.0 / 4.0 * z * LMUA * LMUF * pow(NC, -1) + 1.0 / 4.0 * z * LMUA * LMUF * NC + 1.0 / 2.0 * x * LMUA * LMUF * pow(NC, -1) + (-1) * 1.0 / 2.0 * x * LMUA * LMUF * NC + 1.0 / 2.0 * x * z * LMUA * LMUF * pow(NC, -1) + (-1) * 1.0 / 2.0 * x * z * LMUA * LMUF * NC + 0
