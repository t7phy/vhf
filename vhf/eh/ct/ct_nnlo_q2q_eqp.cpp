...
double ct_nnlo_q2q_eqp(double x, double z, double Q, int rsl, int orders) {
    ...
    if (rsl == 77) {
        ...
        if (std::abs(v) <= tiny && u >= 2 - tiny) {
            ...
            double pt0 = ct_nnlo_q2q_eqp(x0, z0, Q, rsl, orders);
            double pt1 = ct_nnlo_q2q_eqp(x1, z1, Q, rsl, orders);
            double pt2 = ct_nnlo_q2q_eqp(x2, z2, Q, rsl, orders);
