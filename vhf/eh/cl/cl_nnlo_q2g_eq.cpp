...
double cl_nnlo_q2g_eq(double x, double z, double Q, int rsl, int orders) {
    ...
    if (rsl == 77) {
        ...
        if (std::abs(v) <= tiny && u >= 2 - tiny) {
            ...
            double pt0 = cl_nnlo_q2g_eq(x0, z0, Q, rsl, orders);
            double pt1 = cl_nnlo_q2g_eq(x1, z1, Q, rsl, orders);
            double pt2 = cl_nnlo_q2g_eq(x2, z2, Q, rsl, orders);
            ...
            if (z < 1. - x && z < x) {
                result += 8.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF - 6 * pow(NC, -1) * x * pow(pi, 2) * CF + 10.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF - 24 * ln(x) * pow(NC, -1) * x * CF + 24 * ln(x) * pow(NC, -1) * x * z * CF - 14 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 40 * pow(ln(x), 2) * pow(NC, -1) * x * CF - 26 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF + 12 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF - 44 * ln(x) * ln(z) * pow(NC, -1) * x * CF + 32 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF + 24 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF - 64 * ln(x) * ln(omx) * pow(NC, -1) * x * CF + 40 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF + 24 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF - 68 * ln(x) * ln(omz) * pow(NC, -1) * x * CF + 44 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF + 4 * ln(x) * ln(xmz) * pow(NC, -1) * x * CF - 4 * ln(x) * ln(xmz) * pow(NC, -1) * x * z * CF - 4 * ln(x) * ln(omxmz) * pow(NC, -1) * x * pow(z, -1) * CF + 12 * ln(x) * ln(omxmz) * pow(NC, -1) * x * CF - 8 * ln(x) * ln(omxmz) * pow(NC, -1) * x * z * CF + 12 * ln(z) * pow(NC, -1) * x * CF - 12 * ln(z) * pow(NC, -1) * x * z * CF - 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 12 * pow(ln(z), 2) * pow(NC, -1) * x * CF - 10 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF - 8 * ln(z) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF + 24 * ln(z) * ln(omx) * pow(NC, -1) * x * CF - 16 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF - 8 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 32 * ln(z) * ln(omz) * pow(NC, -1) * x * CF - 24 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF - 4 * ln(z) * ln(xmz) * pow(NC, -1) * x * CF + 4 * ln(z) * ln(xmz) * pow(NC, -1) * x * z * CF + 12 * ln(omx) * pow(NC, -1) * x * CF - 12 * ln(omx) * pow(NC, -1) * x * z * CF - 8 * pow(ln(omx), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 18 * pow(ln(omx), 2) * pow(NC, -1) * x * CF - 10 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF - 20 * ln(omx) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 52 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF - 32 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF + 16 * ln(omz) * pow(NC, -1) * x * CF - 16 * ln(omz) * pow(NC, -1) * x * z * CF - 10 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 26 * pow(ln(omz), 2) * pow(NC, -1) * x * CF - 16 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF + 4 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * pow(z, -1) * CF - 12 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * CF + 8 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * z * CF - 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * CF + 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF - 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * CF + 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF + 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * pow(z, -1) * CF - 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * CF - 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * CF + 8 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * CF - 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * z * CF - 4 * Li2(z) * pow(NC, -1) * x * pow(z, -1) * CF + 8 * Li2(z) * pow(NC, -1) * x * CF - 4 * Li2(z) * pow(NC, -1) * x * z * CF;
            }
            if (z > 1. - x && z < x) {
                result += 8.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF - 6 * pow(NC, -1) * x * pow(pi, 2) * CF + 10.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF - 24 * ln(x) * pow(NC, -1) * x * CF + 24 * ln(x) * pow(NC, -1) * x * z * CF - 4 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * pow(z, -1) * CF + 12 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * CF - 8 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * z * CF - 12 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 38 * pow(ln(x), 2) * pow(NC, -1) * x * CF - 26 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF + 16 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF - 56 * ln(x) * ln(z) * pow(NC, -1) * x * CF + 40 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF + 20 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF - 52 * ln(x) * ln(omx) * pow(NC, -1) * x * CF + 32 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF + 20 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF - 64 * ln(x) * ln(omz) * pow(NC, -1) * x * CF + 44 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF + 4 * ln(x) * ln(xmz) * pow(NC, -1) * x * CF - 4 * ln(x) * ln(xmz) * pow(NC, -1) * x * z * CF + 12 * ln(z) * pow(NC, -1) * x * CF - 12 * ln(z) * pow(NC, -1) * x * z * CF - 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 12 * pow(ln(z), 2) * pow(NC, -1) * x * CF - 10 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF - 8 * ln(z) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF + 24 * ln(z) * ln(omx) * pow(NC, -1) * x * CF - 16 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF - 12 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 44 * ln(z) * ln(omz) * pow(NC, -1) * x * CF - 32 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF - 4 * ln(z) * ln(xmz) * pow(NC, -1) * x * CF + 4 * ln(z) * ln(xmz) * pow(NC, -1) * x * z * CF + 12 * ln(omx) * pow(NC, -1) * x * CF - 12 * ln(omx) * pow(NC, -1) * x * z * CF - 8 * pow(ln(omx), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 18 * pow(ln(omx), 2) * pow(NC, -1) * x * CF - 10 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF - 16 * ln(omx) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 40 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF - 24 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF + 16 * ln(omz) * pow(NC, -1) * x * CF - 16 * ln(omz) * pow(NC, -1) * x * z * CF + 4 * ln(omz) * ln(-omxmz) * pow(NC, -1) * x * pow(z, -1) * CF - 12 * ln(omz) * ln(-omxmz) * pow(NC, -1) * x * CF + 8 * ln(omz) * ln(-omxmz) * pow(NC, -1) * x * z * CF - 8 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 24 * pow(ln(omz), 2) * pow(NC, -1) * x * CF - 16 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF + 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * pow(z, -1) * CF - 8 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * CF + 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * z * CF - 4 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x * pow(z, -1) * CF + 4 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x * CF - 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * CF + 4 * Li2(omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF + 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * CF - 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF - 4 * Li2(z) * pow(NC, -1) * x * pow(z, -1) * CF + 8 * Li2(z) * pow(NC, -1) * x * CF - 4 * Li2(z) * pow(NC, -1) * x * z * CF;
            }
            if (z < 1. - x && z > x) {
                result += 8.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF - 26.0 / 3.0 * pow(NC, -1) * x * pow(pi, 2) * CF + 6 * pow(NC, -1) * x * z * pow(pi, 2) * CF - 24 * ln(x) * pow(NC, -1) * x * CF + 24 * ln(x) * pow(NC, -1) * x * z * CF + 4 * ln(x) * ln(-xmz) * pow(NC, -1) * x * CF - 4 * ln(x) * ln(-xmz) * pow(NC, -1) * x * z * CF - 14 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 42 * pow(ln(x), 2) * pow(NC, -1) * x * CF - 28 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF + 12 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF - 48 * ln(x) * ln(z) * pow(NC, -1) * x * CF + 36 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF + 24 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF - 60 * ln(x) * ln(omx) * pow(NC, -1) * x * CF + 36 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF + 24 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF - 72 * ln(x) * ln(omz) * pow(NC, -1) * x * CF + 48 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF - 4 * ln(x) * ln(omxmz) * pow(NC, -1) * x * pow(z, -1) * CF + 12 * ln(x) * ln(omxmz) * pow(NC, -1) * x * CF - 8 * ln(x) * ln(omxmz) * pow(NC, -1) * x * z * CF + 12 * ln(z) * pow(NC, -1) * x * CF - 12 * ln(z) * pow(NC, -1) * x * z * CF - 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * CF + 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * z * CF - 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 14 * pow(ln(z), 2) * pow(NC, -1) * x * CF - 12 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF - 8 * ln(z) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF + 20 * ln(z) * ln(omx) * pow(NC, -1) * x * CF - 12 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF - 8 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 36 * ln(z) * ln(omz) * pow(NC, -1) * x * CF - 28 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF + 12 * ln(omx) * pow(NC, -1) * x * CF - 12 * ln(omx) * pow(NC, -1) * x * z * CF - 8 * pow(ln(omx), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 22 * pow(ln(omx), 2) * pow(NC, -1) * x * CF - 14 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF - 20 * ln(omx) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 44 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF - 24 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF + 16 * ln(omz) * pow(NC, -1) * x * CF - 16 * ln(omz) * pow(NC, -1) * x * z * CF - 10 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 30 * pow(ln(omz), 2) * pow(NC, -1) * x * CF - 20 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF + 4 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * pow(z, -1) * CF - 12 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * CF + 8 * ln(omz) * ln(omxmz) * pow(NC, -1) * x * z * CF + 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * CF - 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF + 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * pow(z, -1) * CF - 4 * Li2(z * pow(omx, -1)) * pow(NC, -1) * x * CF + 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * CF - 4 * Li2(x * pow(z, -1) * omx * pow(omz, -1)) * pow(NC, -1) * x * z * CF - 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * pow(z, -1) * CF + 8 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * CF - 4 * Li2(x * z * pow(omx, -1) * pow(omz, -1)) * pow(NC, -1) * x * z * CF - 4 * Li2(z) * pow(NC, -1) * x * pow(z, -1) * CF + 8 * Li2(z) * pow(NC, -1) * x * CF - 4 * Li2(z) * pow(NC, -1) * x * z * CF;
            }
            if (z > 1. - x && z > x) {
                result += 8.0 / 3.0 * pow(NC, -1) * x * pow(z, -1) * pow(pi, 2) * CF - 6 * pow(NC, -1) * x * pow(pi, 2) * CF + 10.0 / 3.0 * pow(NC, -1) * x * z * pow(pi, 2) * CF - 24 * ln(x) * pow(NC, -1) * x * CF + 24 * ln(x) * pow(NC, -1) * x * z * CF - 4 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * pow(z, -1) * CF + 12 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * CF - 8 * ln(x) * ln(-omxmz) * pow(NC, -1) * x * z * CF + 4 * ln(x) * ln(-xmz) * pow(NC, -1) * x * CF - 4 * ln(x) * ln(-xmz) * pow(NC, -1) * x * z * CF - 12 * pow(ln(x), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 36 * pow(ln(x), 2) * pow(NC, -1) * x * CF - 24 * pow(ln(x), 2) * pow(NC, -1) * x * z * CF + 16 * ln(x) * ln(z) * pow(NC, -1) * x * pow(z, -1) * CF - 52 * ln(x) * ln(z) * pow(NC, -1) * x * CF + 36 * ln(x) * ln(z) * pow(NC, -1) * x * z * CF + 20 * ln(x) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF - 56 * ln(x) * ln(omx) * pow(NC, -1) * x * CF + 36 * ln(x) * ln(omx) * pow(NC, -1) * x * z * CF + 20 * ln(x) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF - 60 * ln(x) * ln(omz) * pow(NC, -1) * x * CF + 40 * ln(x) * ln(omz) * pow(NC, -1) * x * z * CF + 12 * ln(z) * pow(NC, -1) * x * CF - 12 * ln(z) * pow(NC, -1) * x * z * CF - 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * CF + 4 * ln(z) * ln(-xmz) * pow(NC, -1) * x * z * CF - 2 * pow(ln(z), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 10 * pow(ln(z), 2) * pow(NC, -1) * x * CF - 8 * pow(ln(z), 2) * pow(NC, -1) * x * z * CF - 8 * ln(z) * ln(omx) * pow(NC, -1) * x * pow(z, -1) * CF + 28 * ln(z) * ln(omx) * pow(NC, -1) * x * CF - 20 * ln(z) * ln(omx) * pow(NC, -1) * x * z * CF - 12 * ln(z) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 40 * ln(z) * ln(omz) * pow(NC, -1) * x * CF - 28 * ln(z) * ln(omz) * pow(NC, -1) * x * z * CF + 12 * ln(omx) * pow(NC, -1) * x * CF - 12 * ln(omx) * pow(NC, -1) * x * z * CF - 8 * pow(ln(omx), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 18 * pow(ln(omx), 2) * pow(NC, -1) * x * CF - 10 * pow(ln(omx), 2) * pow(NC, -1) * x * z * CF - 16 * ln(omx) * ln(omz) * pow(NC, -1) * x * pow(z, -1) * CF + 40 * ln(omx) * ln(omz) * pow(NC, -1) * x * CF - 24 * ln(omx) * ln(omz) * pow(NC, -1) * x * z * CF + 16 * ln(omz) * pow(NC, -1) * x * CF - 16 * ln(omz) * pow(NC, -1) * x * z * CF + 4 * ln(omz) * ln(-omxmz) * pow(NC, -1) * x * pow(z, -1) * CF - 12 * ln(omz) * ln(-omxmz) * pow(NC, -1) * x * CF + 8 * ln(omz) * ln(-omxmz) * pow(NC, -1) * x * z * CF - 8 * pow(ln(omz), 2) * pow(NC, -1) * x * pow(z, -1) * CF + 24 * pow(ln(omz), 2) * pow(NC, -1) * x * CF - 16 * pow(ln(omz), 2) * pow(NC, -1) * x * z * CF + 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * pow(z, -1) * CF - 8 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * CF + 4 * Li2(pow(x, -1) * pow(z, -1) * omx * omz) * pow(NC, -1) * x * z * CF - 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * CF + 4 * Li2(pow(x, -1) * z * pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF - 4 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x * pow(z, -1) * CF + 4 * Li2(pow(z, -1) * omx) * pow(NC, -1) * x * CF + 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * CF - 4 * Li2(pow(omx, -1) * omz) * pow(NC, -1) * x * z * CF - 4 * Li2(z) * pow(NC, -1) * x * pow(z, -1) * CF + 8 * Li2(z) * pow(NC, -1) * x * CF - 4 * Li2(z) * pow(NC, -1) * x * z * CF;
            }
            if (z > x) {
