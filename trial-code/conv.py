...
# def integrand_reg(z, x, basis_functions, j, reg_func, *reg_args):
#     intgrd = reg_func(z, *reg_args) * point_interpolator(x/z, basis_functions, j)/z
#     return intgrd

# def integrand_sing(z, x, basis_functions, j, interpolator_at_x, sing_func, *sing_args):
#     intgrd = sing_func(z, *sing_args) * (point_interpolator(x/z, basis_functions, j)/z - interpolator_at_x[j])
#     return intgrd

# def integrator(x, mode_log, basis_functions, integration_func, *func_args):
#     res, err = [], []
...
#             r, e = integrate.quad(integration_func, z_min, z_max, args=(x, basis_functions, i, integration_func, *func_args), epsabs=eps_integration_abs)
#             res.append(r)
#             err.append(e)
#         else:
#             z_min = min_xmin * (1 + eps_integration_border)
#             z_max = max_xmax * (1 - eps_integration_border)
#             r, e = integrate.quad(integration_func, z_min, z_max, args=(x, basis_functions, i, point_interpolator(x, basis_functions, i), integration_func, *func_args), epsabs=eps_integration_abs)
#             res.append(r)
#             err.append(e)
#     return res, err
...
def convolution(x, mode_log, basis_functions, reg_func, sing_func=None, loc_func=None, *func_args):
    interpolator_at_x = interpolator(x, basis_functions, mode_log)
